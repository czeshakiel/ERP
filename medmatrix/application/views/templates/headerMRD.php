	...
	<div class="sidebar px-4 py-4 py-md-5 me-0">
		<div class="d-flex flex-column h-100">
			...
			<ul class="menu-list flex-grow-1 mt-3">
				...
				<li><a class="m-link" href="<?=base_url();?>search_patient_record"><i class="icofont-user"></i> <span>Patient Records</span></a></li>
				<li><a class="m-link" href="<?=base_url();?>stock_request"><i class="icofont-ui-cart"></i> <span>Stock Requisition</span></a></li>
				<li  class="collapsed">
					<a class="m-link"  data-bs-toggle="collapse" data-bs-target="#project-Components" href="#">
						<i class="icofont-file-text"></i><span>Reports</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
					<!-- Menu: Sub menu ul -->
					<ul class="sub-menu collapse" id="project-Components">
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateAdmissionRecords"><span>>> Daily/Monthly Admission</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateAdmissionList"><span>>> Admission List</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateDailyDischarged"><span>>> Daily Discharged</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateBabyList"><span>>> List of Baby</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateExpiredList"><span>>> Expired Patient</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateCourseWardCompliance"><span>>> CF4 Compliance Summary Report</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateCF4Patient"><span>>> Patient Lists</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateDiseases"><span>>> Top 10 Diseases</span></a></li>
					</ul>
				</li>
				<li  class="collapsed">
					<a class="m-link"  data-bs-toggle="collapse" data-bs-target="#Certifications" href="#">
						<i class="icofont-ui-folder"></i><span>Other Transactions</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
					<!-- Menu: Sub menu ul -->
					<ul class="sub-menu collapse" id="Certifications">
						<li>
							<a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#documents">><span>>> Certifications</span></a>
						</li>
						<li>
							<a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#Photocopy">><span>>> Photocopy</span></a>
						</li>
						<li>
							<a class="ms-link" href="<?=base_url();?>patient_merging">><span>>> Patient Merging</span></a>
						</li>
					</ul>
				</li>
			</ul>
