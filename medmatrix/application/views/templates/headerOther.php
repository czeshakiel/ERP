	...
	<div class="sidebar px-4 py-4 py-md-5 me-0">
		<div class="d-flex flex-column h-100">
			...
			<ul class="menu-list flex-grow-1 mt-3">
				<!-- <li><a class="m-link" href="../<?=mb_strtolower($this->session->dept);?>/"><i class="icofont-home"></i> <span>Home</span></a></li>				 -->
				<?php
				if($this->session->dept=="BILLING" || $this->session->dept=="ACCOUNTING" || strpos($this->session->dept,'NS') !== false || strpos($this->session->dept,'PHARMACY') !== false || strpos($this->session->dept,'CASHIER') !== false || $this->session->dept=="RT" || $this->session->dept=="PT" || $this->session->dept=="OR"){
				?>
				<li><a class="m-link" href="<?=base_url();?>return_dept/<?=$this->session->dept;?>"><i class="icofont-home"></i> <span>Home</span></a></li>				
				<?php
			}else{
			?>
<li><a class="m-link" href="<?=base_url();?>"><i class="icofont-home"></i> <span>Home</span></a></li>				
			...
			?>
		<?php if($this->session->dept!="ACCOUNTING"){ ?>		
<li><a class="m-link" href="<?=base_url();?>stock_request"><i class="icofont-ui-cart"></i> <span>Stock Requisition</span></a></li>
<li><a class="m-link" href="<?=base_url();?>request_history"><i class="icofont-ui-cart"></i> <span>Request History</span></a></li>
<?php } ?>
				<?php
				if($this->session->dept=="BILLING"){
				?>
				<li><a class="m-link" href="<?=base_url();?>discharged_summary"><i class="icofont-ui-cart"></i> <span>Discharged Report (IPD)</span></a></li>
				<li><a class="m-link" href="<?=base_url();?>arpatient_list"><i class="icofont-ui-cart"></i> <span>AR Patient</span></a></li>
				<li><a class="m-link" href="<?=base_url();?>patient_refund"><i class="icofont-ui-cart"></i> <span>Post Refund</span></a></li>
				<li><a class="m-link" href="<?=base_url();?>report_settings"><i class="icofont-ui-file"></i> <span>Report Settings</span></a></li>
				<?php
			}
			?>			
			</ul>
