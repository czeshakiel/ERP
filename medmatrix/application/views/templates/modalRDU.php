		...
		<div class="modal fade" id="ManageGuaranteeLetter" tabindex="-1" aria-labelledby="exampleModalSmLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog modal-md modal-dialog-centered">
				<div class="modal-content">
					<?=form_open(base_url()."save_gl");?>
					<input type="hidden" name="id" id="gl_idno">
					<input type="hidden" name="patientidno" id="gl_patientidno">
					<div class="modal-header">
						<h5 class="modal-title h4" id="exampleModalSmLabel">Manage Guarantee Letter</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body">
						<div class="form-group mb-3">
							<label class="mb-2">GL ID</label>
							<input type="text" class="form-control" name="gl_id" required id="gl_id">
						</div>
						<div class="form-group mb-3">
							<label class="mb-2">Company</label>
							<input type="text" class="form-control" name="company" required id="gl_company">
						</div>
						<div class="form-group mb-3">
							<label class="mb-2">Amount</label>
							<input type="text" name="amount" class="form-control" required id="gl_amount">							
						</div>
						<div class="form-group mb-3">
							<label class="mb-2">Date Posted</label>
							<input type="date" name="datearray" class="form-control" value="<?=date('Y-m-d');?>" required id="gl_datearray">							
						</div>
					</div>
					<div class="modal-footer">
						&nbsp;<input type="submit" class="btn btn-secondary" name="submit">
		...
		<div class="modal fade" id="PatientDischarged" tabindex="-1" aria-labelledby="exampleModalSmLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog modal-md modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-footer">
						&nbsp;<input type="submit" class="btn btn-secondary" name="submit" onclick="return confirm('Do you wish to discharge this patient?');return false;">
					</div>
					<?=form_close();?>
				</div>
			</div>
		...
		<div class="modal fade" id="EditAdmissionTime" tabindex="-1" aria-labelledby="exampleModalSmLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-body">
						<input type="hidden" name="caseno" id="admit_caseno_time">						
						<div class="form-group mb-3">
		...
		<div class="modal fade" id="generateDailyInpatientHMO" tabindex="-1" aria-labelledby="exampleModalSmLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog modal-sm modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalSmLabel">RDU Daily Discharged</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<?=form_open(base_url()."daily_discharged_dialysis",array("target" => "_blank"));?>
					<div class="modal-body">
						<div class="form-group">
							<label>Select Date</label>
							<input type="date" name="rundate" class="form-control" value="<?=date('Y-m-d');?>">
		...
		<div class="modal fade" id="generateSummaryInpatientHMO" tabindex="-1" aria-labelledby="exampleModalSmLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog modal-sm modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalSmLabel">RDU Discharged Summary</h5>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<?=form_open(base_url()."daily_discharged_dialysis_summary",array("target" => "_blank"));?>
					<div class="modal-body">
						<div class="form-group">
							<label>Select Date</label>
							<input type="date" name="rundate" class="form-control" value="<?=date('Y-m-d');?>">
