					...
					<div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
						<div class="d-flex">
							...
							<div class="avatar-list avatar-list-stacked px-3">
								<img class="avatar rounded-circle" src="<?=base_url();?>design/images/xs/avatar2.jpg" alt="">
								...
								<img class="avatar rounded-circle" src="<?=base_url();?>design/images/xs/avatar4.jpg" alt="">
								<img class="avatar rounded-circle" src="<?=base_url();?>design/images/xs/avatar7.jpg" alt="">
								<img class="avatar rounded-circle" src="<?=base_url();?>design/images/xs/avatar8.jpg" alt="">
							...
							<div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
								<div class="card border-0 w280">
									...
									<div class="list-group m-2 ">
										...
										<a href="<?=base_url();?>logout" class="list-group-item list-group-item-action border-0 "><i class="icofont-logout fs-6 me-3"></i>Signout</a>
										<div><hr class="dropdown-divider border-dark"></div>
