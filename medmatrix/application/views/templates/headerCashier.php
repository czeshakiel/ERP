			...
			<ul class="menu-list flex-grow-1 mt-3">				
				...
				<li  class="collapsed">
					<a class="m-link"  data-bs-toggle="collapse" data-bs-target="#project-Components" href="#">
						<i class="icofont-money"></i><span>Collection</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
					<!-- Menu: Sub menu ul -->
					<ul class="sub-menu collapse" id="project-Components">
						<li><a class="ms-link" href="<?=base_url();?>daily_collection"><span>>> Daily Collection</span></a></li>
						<li><a class="ms-link" href="<?=base_url();?>professional_fee"><span>>> Professional Fee</span></a></li>						
						<li><a class="ms-link" href="<?=base_url();?>artrade_list"><span>>> AR Trade List</span></a></li>
					</ul>
				</li>
			</ul>
