			...
			<ul class="menu-list flex-grow-1 mt-3">
				...
				<li class="collapsed">
					...
					<ul class="sub-menu collapse" id="client-Components">
						...
						<li><a class="ms-link" href="<?=base_url();?>admission_patient_list"> <span>>> Patient List</span></a></li>
					</ul>
				</li>
				<li class="collapsed">
					...
					<ul class="sub-menu collapse" id="emp-Components">
						...
						<li><a class="ms-link" href="<?=base_url();?>room_status"> <span>>> Room Status</span></a></li>
						<li><a class="ms-link" href="<?=base_url();?>search_patient_record"> <span>>> Search Patient Records</span></a></li>
					</ul>
				</li>
			</ul>
