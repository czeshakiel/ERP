	...
	<div class="sidebar px-4 py-4 py-md-5 me-0">
		<div class="d-flex flex-column h-100">
			...
			<ul class="menu-list flex-grow-1 mt-3">
				...
				<li><a class="m-link" href="<?=base_url();?>patient_list_view"><i class="icofont-user"></i> <span>Patient List</span></a></li>
				<li><a class="m-link" href="<?=base_url();?>stock_request"><i class="icofont-ui-cart"></i> <span>Stock Requisition</span></a></li>
				<li><a class="m-link" href="<?=base_url();?>meal_monitoring"><i class="icofont-spoon-and-fork"></i> <span>Meal Monitoring</span></a></li>
				<li><a class="m-link" href="#" data-bs-target="#DietMasterList" data-bs-toggle="modal"><i class="icofont-file-text"></i> <span>Masterlist</span></a></li>
				<li><a class="m-link" href="#" data-bs-target="#MealMonitoring" data-bs-toggle="modal"><i class="icofont-file-text"></i> <span>Meal Monitoring Sheet</span></a></li>
				<li><a class="m-link" href="<?=base_url();?>pf_report"><i class="icofont-file-document"></i> <span>Prof. Fee Report</span></a></li>
			</ul>
