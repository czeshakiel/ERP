		...
		<div class="d-flex flex-column h-100">
			...
			<ul class="menu-list flex-grow-1 mt-3">
				...
				<li  class="collapsed">
					...
					<ul class="sub-menu collapse" id="project-Components">
						...
						<?php
							...
							if($department=="KONSULTA"){
								?>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#ARList"><span>>> AR List</span></a></li>
						<?php
							}else{								
 						?>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#OPDList"><span>>> OPD List</span></a></li>
						<?php
					}
							if($department=="ER" || $department=="OPD" || $department=="ADMISSION"){
						?>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#ARList"><span>>> AR List</span></a></li>
						...
						<?php
 						...
 						?>
 						<li><a class="ms-link" href="<?=base_url();?>dischargedlist"><span>>> Discharged List</span></a></li>
					</ul>
				</li>
				<li><a class="m-link" href="<?=base_url();?>stock_request"><i class="icofont-ui-cart"></i><span>Stock Request</span></a></li>
				<?php if($department=="OPD"){ ?> <li><a class="m-link" href="<?=base_url();?>search_archive"><i class="icofont-search-user"></i><span>Search Archive</span></a></li> <?php } ?>
				...
				<li class="collapsed">
					...
					if($department=="ER"){
				?>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateRODReports"> <span>>> ROD Reports</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateDailyAdmission"> <span>>> Daily Admission IPD</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateDailyAdmissionOPD"> <span>>> Daily Amission OPD</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateReferredSummary"> <span>>> Referred Summary</span></a></li>
						<li><a class="m-link" href="#" data-bs-toggle="modal" data-bs-target="#PriceList"><i class="icofont-money"></i> <span>Price List</span></a></li>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateOBReports"> <span>>> OB Reports</span></a></li>
						<?php } ?>
						<?php
							if($department=="OPD"){
?>
						<li><a class="ms-link" href="#" data-bs-toggle="modal" data-bs-target="#generateMinorSurgical"> <span>>> OPD Minor</span></a></li>
<?php
							}
							?>
					</ul>
