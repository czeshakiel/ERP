 ...
 ?>
  ...
  <div class="page">    
    ...
    if($balfour1beg > 0 || $balfour1 > 0){
        ...
        ?>
        <tr>
            <td>ACCOUNTS RECEIVABLE - OFFICE</td>
            <td align="right"><?=number_format($office1beg,2);?></td>
            <td align="right"><?=number_format($office1,2);?></td>
            <td align="right"><?=number_format($office1beg+$office,2);?></td>
        </tr>
        <?php
    }
