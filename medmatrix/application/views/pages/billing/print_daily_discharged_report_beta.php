...
//=============================================Credit Check=============================================================
    ...
    <div id="printThis">
    <h4 style="margin-left:90px;">DAILY DISCHARGED REPORT (DEBIT) - <?=$st;?> (<b><?=$dpt;?></b>)<br><?=$date1;?> 11:00 PM to <?=$date2;?> 11:00 PM</h4>
	<table width="100%" border="1" cellspacing="0" cellpadding="1" style="border-collapse: collapse; font-size: 11px;">
		<?php
		$coh=0;$dep=0;$disc=0;$arphic=0;$arpfphic=0;$al=0;$avega=0;$lovej=0;$chealth=0;$caritas=0;$coco=0;$flexi=0;$intel=0;$maxi=0;$mcl=0;$mcard=0;$pcare=0;$vcare=0;
	    ...
	    $coh1=0;$dep1=0;$disc1=0;$arphic1=0;$arpfphic1=0;$al1=0;$avega1=0;$lovej1=0;$chealth1=0;$caritas1=0;$coco1=0;$flexi1=0;$intel1=0;$maxi1=0;$mcl1=0;$mcard1=0;$pcare1=0;$pgicare1=0;
	    $vcare1=0;$dswd1=0;$lgumak1=0;$lgukid1=0;$pcso1=0;$pepsi1=0;$province1=0;$trade1=0;$tradepf1=0;$pcross1=0;$maip1=0;$insu1=0;$generali1=0;$insulife1=0;$emp1=0;$doc1=0;$eastwest1=0;$cotelco1=0;$tejada1=0;$santos1=0;$caoagdan1=0;$pinol1=0;$pcso3=0;$pcso4=0;$medoc=0;$medoc1=0;$guarantor="";$guarantor1="";$cotelco3=0;$sss=0;$sss1=0;$edc1=0;$edc4=0;
	    $balfour1=0;
	    $totalamount=0;
	    $credittotal=0;
        ...
        if($sql->num_rows()>0){
            ...
            $disc +=$result['amount'];
            //$discnorm += $result['amount'];
        }

        $check_disc=$this->General_model->db->query("SELECT * FROM admission WHERE caseno='$caseno' AND senior='Y'");
        if($check_disc->num_rows() > 0){
            $discsen=$disc;
        }else{
            $discnorm=$disc;
        }
...
echo "<tr>";
  ...
  echo "<td align='center' class='font11' width='6%'>DISC SEN</td>";
  echo "<td align='center' class='font11' width='6%'>DISC REG</td>";
  ...
  if($avega1>0){echo "<td align='center' class='font11' width='6%'>AVEGA</td>";}
    if($lovej1>0){echo "<td align='center' class='font11' width='6%'>LOVE JAN</td>";}
  ...
  if($vcare1>0){echo "<td align='center' class='font11' width='6%'>VALU CARE</td>";}
  ...
  if($edc1>0){echo "<td align='center' class='font11' width='6%'>EDC</td>";}
  ...
  $al2=0;$avega2=0;$lovej2=0;$chealth2=0;$caritas2=0;$coco2=0;$flexi2=0;$intel2=0;$maxi2=0;$mcl2=0;$mcard2=0;$pcare2=0;$pgicare2=0;$eastwest2=0;$medoc2=0;
        $vcare2=0;$dswd2=0;$lgumak2=0;$lgukid2=0;$pcso2=0;$pepsi2=0;$province2=0;$trade2=0;$tradepf2=0;$pcross2=0;$maip2=0;$insu2=0;$generali2=0;$insulife2=0;$emp2=0;$doc2=0;$cotelco2=0;$tejada2=0;$santos2=0;$caoagdan2=0;$pinol2=0;$balfour2=0;$sss2=0;$discsen2=0;$discnorm2=0;$edc2=0;
foreach($body as $item){
	    	$caseno=$item['caseno'];
	    	$patientname=$item['patientname'];
	    	$coh=$item['amount'];
...
$appfdep=$deposit;
        ...
        if($type != "WCOH"){
        	if($coh==0){
        		$totalamount=$coh+$dep+$disc+$arphic+$arpfphic+$al+$avega+$lovej+$chealth+$caritas+$coco+$flexi+$intel+$maxi+$mcl+$mcard+$pcare+$vcare+$pcross+$dswd+$lgumak+$lgukid+$pcso+$pepsi+$province+$trade+$tradepf+$maip+$insu+$generali+$insulife+$doc+$emp+$pgicare+$eastwest+$cotelco+$tejada+$santos+$caoagdan+$pinol+$cotelco4+$pcso3+$balfour+$sss+$edc;
                $dep1 += $dep;
                $disc1 += $disc;
                $discsen2 += $discsen;
                $discnorm2 += $discnorm;
    ...
    echo "<td align='right' class='font11' $color>".number_format($discsen,2)."</td>";
    echo "<td align='right' class='font11' $color>".number_format($discnorm,2)."</td>";
	...
	if($lovej1>0){echo "<td align='right' class='font11' $color>".number_format($lovej,2)."</td>";}
    ...
    if($edc1>0){echo "<td align='right' class='font11' $color>".number_format($edc,2)."</td>";}
    ...
    $credittotal += $totalamount;
        	...
        	$totalamount=$coh+$dep+$disc+$arphic+$arpfphic+$al+$avega+$lovej+$chealth+$caritas+$coco+$flexi+$intel+$maxi+$mcl+$mcard+$pcare+$vcare+$pcross+$dswd+$medoc+$lgumak+$lgukid+$pcso+$pepsi+$province+$trade+$tradepf+$maip+$insu+$generali+$insulife+$doc+$emp+$pgicare+$eastwest+$cotelco+$tejada+$santos+$caoagdan+$pinol+$cotelco4+$pcso3+$balfour+$sss+$edc;
                $dep1 += $dep;
                $disc1 += $disc;
                $discsen2 += $discsen;
                $discnorm2 += $discnorm;
...
echo "<td align='right' class='font11' style='font-weight:bold;' $color>".number_format($discsen2,2)."</td>";
echo "<td align='right' class='font11' style='font-weight:bold;' $color>".number_format($discnorm2,2)."</td>";
...
if($lovej1>0){echo "<td align='right' class='font11' style='font-weight:bold;' $color>".number_format($lovej2,2)."</td>";}
...
if($edc1>0){echo "<td align='right' class='font11' style='font-weight:bold;' $color>".number_format($edc2,2)."</td>";}
