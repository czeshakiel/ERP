	...
	<div class="container-xxl">
		...
		<div class="row align-item-center">
			<div class="col-md-12">
				...
				<input type="hidden" name="artype" value="<?=$artype;?>">
				<div class="card mb-3">
						...
						<div class="row g-3 align-items-center">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="birthdate" required value="<?=$inpatient['dateofbirth'];?>" id="adtmitbirthdate">
								</div>
							</div>
							<div class="col-md-1">
								<div class="form-group">
									<label class="form-label">Age</label>
									<input type="text" id="admitage" class="form-control" disabled style="text-align: center;" value="<?=$inpatient['age'];?>">
								</div>
							</div>
							<?php
							if($inpatient['sex']=="M"){
						...
						<div class="row g-3 align-items-center">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="zipcode" id="zipcode" value="<?=$inpatient['zipcode'];?>">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
