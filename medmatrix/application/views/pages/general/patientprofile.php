						...
						<table id="patient-table" class="table table-hover align-middle mb-0" style="width: 100%;">
							...
							if($this->session->dept=="ONCOLOGY"){
								if($list['room']=="ONCO"){
									...
									echo "<td>$x.</td>";
									echo "<td><b><a href='http://192.168.0.100:100/ERP/main/bridge.php?caseno=".$list['caseno']."&username=".$this->session->username."&nursename=".$this->session->fullname."&dept=".$this->session->dept."' target='_blank'>$list[caseno]</a></b></td>";
