					...
					<div class="card-header py-3 bg-transparent border-bottom-0">
						<table border="0" width="100%">
							<tr>
								...
								<td align="right"><a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#NewAdmissionQuotation"><i class="icofont-plus-circle"></i> New Quotation</a></td>
								<?=form_open(base_url()."search_quotation");?>
						...
						<table class="table table-hover align-middle mb-0 nowrap dataTable no-footer dtr-inline" style="width: 100%;">
							...
							foreach($inpatient as $list){
								...
								<td align="center" width="20%">
									<a href="#" class="btn btn-outline-success btn-sm readmitquotation" data-bs-toggle="modal" data-bs-target="#ReAdmissionQuotation" data-id="<?=$list['patientidno'];?>" title="Readmit"><i class="icofont-ambulance"></i></a>
								</td>
								<?php
								echo "</tr>";
								$x++;
