					...
					<div class="card-header py-3 bg-transparent border-bottom-0">
						<table border="0" width="100%">
							<tr>
								...
								<?=form_open(base_url()."search_arpatient_list");?>
						...
						<table class="table table-hover align-middle mb-0 nowrap dataTable no-footer dtr-inline" style="width: 100%;">
							...
							foreach($inpatient as $list){
								...
								<td align="center" width="20%">
									<a href="<?=base_url();?>patientprofile/<?=$list['patientidno'];?>" class="btn btn-success btn-sm text-white" title="View Profile"><i class="icofont-eye"></i></a>
								</td>
								<?php
								echo "</tr>";
								$x++;
