	...
	<div class="container-xxl">
		...
		<div class="row g-3">
			<div class="col-xl-12 col-lg-12 col-md-12">
				...
				<h6 class="fw-bold  py-3 mb-3">Diagnostic Charges</h6>
						...
						<table class="table" id="patient-table">
							...
							<tbody>
								...
								foreach($admission as $admit){
									echo "<tr>";
										echo "<td>$admit[productcode]</td>";
										echo "<td>$admit[productdesc]</td>";
										echo "<td>$admit[datearray] - $admit[invno]</td>";
										echo "<td>$admit[loginuser] - $admit[refno]</td>";
										?>
										<td><a href="<?=base_url();?>delete_charges/<?=$patientidno;?>/<?=$caseno;?>/<?=$admit['refno'];?>" class="btn btn-danger text-white" title="Delete Item" onclick="return confirm('Do you wish to delete this item?'); return false;"><i class="icofont-trash"></i></a></td>
										<?php										
									echo "</tr>";
								}
								?>
