...
<thead>
<tr>
<th class="text-center"  bgcolor="#6403D1"><font size="2">#</th>
<th class="text-center"  bgcolor="#6403D1" width="10%"><font size="2">ACTIONS</th>
<th class="text-center"  bgcolor="#6403D1" width="50%"><font size="2">DESCRIPTION</th>
<th class="text-center"  bgcolor="#6403D1" width="20%"><font size="2">STATUS</th>
<th class="text-center"  bgcolor="#6403D1"><font size="2">QTY</th>
<th class="text-center"  bgcolor="#6403D1"><font size="2">USER</th>
</tr>
</thead>
<tbody>
...
<?php
$i=0;
$sql = "SELECT * from `productreturn` where ($allcs) and `trantype`='return' order by `dateofret` desc";
...
<td style="font-size: 10px;">Desc: <b><?php echo $descss." ".$hmm; ?></b><br>Accttitle: <b><?php echo $prodtype ?></b></td>
<td style="font-size: 10px;">Status: <b>Returned item(s)</b><br>Date: <b><?php echo $datearray222 ?></b></td>
