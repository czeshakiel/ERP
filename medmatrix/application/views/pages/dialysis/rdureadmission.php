	...
	<div class="container-xxl">
		...
		<div class="row align-item-center">
			<div class="col-md-12">
				...
				<input type="hidden" name="admissiontype" value="RDU">
				<div class="card mb-3">
						...
						<div class="row g-3 align-items-center">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="date" class="form-control" name="birthdate" required  value="<?=$inpatient['dateofbirth'];?>">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
							...
							<?php
							if($inpatient['discounttype']=="NONE"){
								$none="checked";
								$senior="";
								$pwd="";
							}else if($inpatient['discounttype']=="SENIOR"){
								$none="";
								$senior="checked";
								$pwd="";
							}else{
				...
				<div class="card mb-3">
					<div class="card-header py-3 d-flex bg-transparent border-bottom-0 justify-content-center">
						<h6 class="mb-0 fw-bold "><input type="submit" name="submit" value="Submit Details" class="btn btn-primary btn-block" onclick="return confirm('Do you wish to submit details?');return false;"></h6>
					</div>
				</div>
				<?=form_close();?>
			</div>
