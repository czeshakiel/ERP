			...
			<div class="col-md-12">
						...
						<div class="row g-3 align-items-center">
							...
							<div class="col-md-1">
								<div class="form-group">
									...
									<br />
									<label class="fancy-radio">
										<input type="radio" name="membership" value="Yes" required data-parsley-errors-container="#error-radio">
										<span><i></i>Yes</span>
									</label>
									&nbsp;
									<label class="fancy-radio">
				...
				<div class="card mb-3">
					<div class="card-header py-3 d-flex bg-transparent border-bottom-0 justify-content-center">
						<h6 class="mb-0 fw-bold "><input type="submit" name="submit" value="Submit Details" class="btn btn-primary btn-block"></h6>
					</div>
				</div>
				<?=form_close();?>
			</div>
