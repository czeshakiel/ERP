					...
					<div class="card-header py-3 bg-transparent border-bottom-0">
						<table border="0" width="100%">
							<tr>
								...
								<?=form_open(base_url()."search_guarantee_letter");?>
					...
					<div class="card-body">
						<table class="table table-hover align-middle mb-0 nowrap dataTable no-footer dtr-inline" style="width: 100%;">
							...
							foreach($inpatient as $list){
								...
								if($stillin && ($department=="ADMISSION" || $department=="RDU")){
								...
								<td align="center" width="20%">
									<a href="<?=base_url();?>manage_guarantee_letter/<?=$list['patientidno'];?>" class="btn btn-primary btn-sm"><i class="icofont-book"></i> Manage GL</a>
								</td>
								<?php
								echo "</tr>";
								$x++;
