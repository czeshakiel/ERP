				...
				<div class="card mb-3">
					<div class="card-header py-3 bg-transparent border-bottom-0">
						<table border="0" width="100%">
							<tr>
								<td>List of Items</td>
								<td align="right"><a href="#" data-bs-toggle="modal" data-bs-target="#AddMedicine" class="btn btn-success btn-sm text-white"><i class="icofont-plus-square"></i> Add New</a></td>
							</tr>
						</table>
					</div>
					<div class="card-body">
						...
						<table id="employee-table" class="table table-hover align-middle mb-0" width="100%">
							...
							foreach($items AS $item){
								...
								echo "<td>".$desc."</td>";
								echo "<td width='20%'>".$generic."</td>";
								echo "<td align='center' width='5%'>".$item['lotno']."</td>";
								?>
								<td>
									<a href="#" data-bs-toggle="modal" data-bs-target="#ManageMedicine" data-id="<?=$item['code'];?>" title="Edit Description" class="btn btn-info btn-sm text-white manageMedicine">
										<i class="icofont-edit"></i>
										Edit
									</a>
									<a href="#" class="btn btn-warning btn-sm manageReorder" data-bs-toggle="modal" data-bs-target="#ManageReorder" data-id="<?=$item['code'];?>_<?=$desc;?>_<?=$dept;?>">Re-order Level</a>
								</td>
								<?php
								echo "</tr>";
								$x++;
