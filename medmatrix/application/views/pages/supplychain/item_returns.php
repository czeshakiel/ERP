				...
				<div class="card mb-3">
					<div class="card-header py-3 bg-transparent border-bottom-0">
						<table border="0" width="100%">
							<tr>
								<td><h4>Returned Items List</h4></td>
							</tr>
						</table>
					</div>
					<div class="card-body">
						...
						<table id="employee-table" class="table" width="100%">
							...
							foreach($pending as $pitem){
								...
								?>
								<td><a href="<?=base_url();?>print_return/<?=$pitem['invno']?>" class="btn btn-success btn-sm text-white" target="_blank"><i class="icofont-printer"></i> Print</a></td>
								<?php
								echo "</tr>";
							}
							?>
