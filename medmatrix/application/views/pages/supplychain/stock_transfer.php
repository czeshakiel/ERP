				...
				<div class="card mb-3">
					<div class="card-header py-3 bg-transparent border-bottom-0">
						<table border="0" width="100%">
							<tr>
								<td><h4>Pending Transfer List<small><a href="#" class="btn btn-success btn-sm text-white" style="float:right; margin-right:10px;" data-bs-toggle="modal" data-bs-target="#NewTransfer"><i class="icofont-plus-circle"></i> New Request</a></small></h4></td>
							</tr>
						</table>
					</div>
					<div class="card-body">
						<table id="employee-table" class="table table-hover align-middle mb-0" style="width: 100%;">
							...
							foreach($requests as $emp){
								...
								<td>
									...
									<input type="hidden" name="branch" value="<?=$transfer;?>">
									<input type="hidden" name="transdate" value="<?=$emp['datearray'];?>">
									<button type="submit" class="btn btn-warning text-white"><i class="icofont-gear-alt"></i> Manage</button>
									<?=form_close();?>
								</td>
								<?php
								echo "</tr>";
