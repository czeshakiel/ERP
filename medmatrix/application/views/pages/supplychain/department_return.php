					...
					<div class="card-body">
						...
						<table id="employee-table" class="table" width="100%">
							...
							foreach($items as $item){
								...
								echo "<td>$item[reqdate]</td>";
								echo "<td>$item[requser]</td>";
								?>
								<td align="center"><a href="<?=base_url();?>view_returns/<?=$item['reqno'];?>" class="btn btn-success btn-sm text-white"><i class="icofont-eye"></i> View</a> <a href="<?=base_url();?>cancel_return/<?=$item['reqno'];?>" class="btn btn-danger btn-sm text-white" onclick="return confirm('Do you wish to cancel this transaction?'); return false;"><i class="icofont-trash"></i> Cancel</a></td>
								<?php
								echo "</tr>";
							}
							?>
