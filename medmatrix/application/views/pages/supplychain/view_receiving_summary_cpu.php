<div>
<table width="100%" border="1" cellspacing="0" cellpadding="1" style="font-family:Arial;font-size:14px;border-collapse:collapse;">
<tr>
        <td align="center" width="5%">Date</td>
        <td align="center" width="7%">RRNo.</td>
        <td align="center" width="22%">Supplier</td>
        <td align="center" width="7%">P.O #</td>
        <td align="center" width="6%">Invoice</td>
        <td align="center" width="8%">Amount<br>AP Trade</td>
        <td align="center" width="7%">Input<br>Tax</td>
        <td align="center" width="7%">Pharma & Surg<br>Supplies</td>
        <td align="center" width="7%">Free Goods<br />(Supplies)</td>
        <td align="center" width="7%">Pharmacy<br>Medicines</td>
        <td align="center" width="7%">Free Goods<br />(Medicine)</td>
        <td align="center" width="6%">Handling<br>Fee</td>
...
?>
    <tr>
        ...
        <td align="left" width="8%"><?=$item['rrno'];?></td>
        ...
        <td align="right" width="5%"><?=number_format($supp,2);?></td>
        ...
        <td align="right" width="5%"><?=number_format($handfee,2);?></td>
