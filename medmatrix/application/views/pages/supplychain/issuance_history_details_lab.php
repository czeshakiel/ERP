<div>
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="1" style="border-collapse:collapse;font-size:10px;">
		...
		foreach($items AS $item){		
			...
			echo "<tr>";
				echo "<td colspan='9'><b>$description</b></td>";
			echo "</tr>";
			$x=1;
			$product=$this->Purchase_model->getIssuanceDetails($description);
			...
			echo "<tr>";
				echo "<td colspan='9'><b>GENERAL SUPPLIES</b></td>";
			echo "</tr>";
			$x=1;
			$product=$this->Purchase_model->getIssuanceDetails(0);
			foreach($product as $row){
			$tamount=0;
			$unitcost=0;			
			$desc=str_replace('ams-','',$row['description']);
