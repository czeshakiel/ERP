					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
								<h6 class="mb-0 fw-bold ">Masterfile Information</h6>
							</div>
							<div class="card-body">
								<div class="row g-2 row-deck">
									<div class="col-md-6 col-sm-6">
										<div class="card">
											<div class="card-body ">
												...
												<h6 class="mt-3 mb-0 fw-bold small-14">Total Employees</h6>
									...
									<div class="col-md-6 col-sm-6">
										<div class="card">
											<div class="card-body ">
												<i class="icofont-doctor-alt fs-1"></i>
									...
									<div class="col-md-6 col-sm-6">
										<div class="card">
											<div class="card-body ">
												...
												<h6 class="mt-3 mb-0 fw-bold small-14">Total Beds</h6>
									...
									<div class="col-md-6 col-sm-6">
										<div class="card">
											<div class="card-body ">
												...
												<h6 class="mt-3 mb-0 fw-bold small-14">Total HMO</h6>
