					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
								<h6 class="mb-0 fw-bold "><?=$this->session->dept;?> Information</h6>
							</div>
							<div class="card-body">
									...
									<div class="col-md-6 col-sm-6">
										<div class="card">
											<div class="card-body ">
												...
												<h6 class="mt-3 mb-0 fw-bold small-14">Active In-Patient</h6>
									...
									<div class="col-md-6 col-sm-6">
										<div class="card">
											<div class="card-body ">
												...
												<h6 class="mt-3 mb-0 fw-bold small-14">New Admission</h6>
									...
									<div class="col-md-6 col-sm-6">
										<div class="card">
											<div class="card-body ">
												...
												<h6 class="mt-3 mb-0 fw-bold small-14">May Go Home Status</h6>
									...
									<div class="col-md-6 col-sm-6">
										<div class="card">
											<div class="card-body ">
												...
												<h6 class="mt-3 mb-0 fw-bold small-14">Available Beds</h6>
