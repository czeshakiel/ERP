...
xmlhttp.open("GET","searchpatsr.php?view=sp&user='.$user.'&userunique='.$userunique.'&show='.$show.'&page='.$page.'&searchme="+document.searchme.searchme.value,true);
xmlhttp.send();
}
';
?>
    ...
    <tr>
      <td><div align='left' class='tabstyle'><table border='0' cellapdding='0' cellspacing='0'>
        <tr>
          ...
          <td class='b2'><a href='../philhealth/?ft&show=$show&page=0' style='text-decoration: none;'><div align='center' class='tab'>For Transmittal</div></a></td>
          <td width='2' bgcolor='#ece0cf' style='border-bottom: 2px solid #ece0cf;'></td>
          <td class='b2'><a href='../philhealth/?pl&show=$show&page=0' style='text-decoration: none;'><div align='center' class='tab'>Pending</div></a></td>
          <td width='2' bgcolor='#ece0cf' style='border-bottom: 2px solid #ece0cf;'></td>
          ...
          <td width='2' bgcolor='#ece0cf' style='border-bottom: 2px solid #ece0cf;'></td>
          <td class='b2'><a href='../philhealth/?sp&show=$show' style='text-decoration: none;'><div align='center' class='tabselect'>Search Patient</div></a></td>
          <td width='2' bgcolor='#ece0cf' style='border-bottom: 2px solid #ece0cf;'></td>
        </tr>
      </table></div></td>
    </tr>
        ...
        <tr>
          <td width='50%'><div align='left'><table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='5'></td>
              <form id='NextPage' name='NextPage' method='post' action='../philhealth/?view=sp&page=0'>
          ...
          <form name='searchme' onload='showResult();' method='post' action='../philhealth/?view=sp&show=$show&page=".($page)."'>
              ...
              <tr>
                <td><table border='0' width='100%' cellpadding='0' cellspacing='0' class='hoverTable'>
                  <tr>
                    ...
                    <td class='t2 b2 l1' width='150'><div align='center' class='arial s12 black bold'>Day/s Processed</div></td>
...
$a=$page;
$asql=mysqli_query($conn,"SELECT dt.`caseno`, dt.`datedischarged`, dt.`timedischarged`, dt.`datearray`, a.`patientidno`, a.`dateadmit`, a.`membership` FROM `dischargedtable` dt, `admission` a WHERE dt.`caseno`=a.`caseno` AND a.`membership`='phic-med' AND a.`caseno` NOT LIKE '%R-%' ORDER BY dt.`datearray`, dt.`patientname` LIMIT $page,$show");
...
if($eccount==0){
  ...
  if($ecstatus=="transmitted"){
    ...
    $strStart2=$datearray;
    $strEnd2=date("Y-m-d",strtotime($ectfetch['datetransmitted']));
    $from2=$strStart2;
    $to2=$strEnd2;
    $total2=strtotime($to2) - strtotime($from2);
    $days2=round($total2 / (60 * 60 * 24));
    $val2=$days2;
...
echo "
                  <tr>
                    ...
                    <td class='b1 l1'><div align='left' class='arial s14 black $warn'>&nbsp;$val&nbsp;</div></td>
                    ...
                    <td class='b1 l1'><div align='center' class='arial s14 black'>$val2</div></td>
                  ...
                  <script>
                    function bb$a() {
                      window.open('http://$ip/2022codes/eClaims/Porter.php?patientidno=$patientidno&caseno=$caseno&uname=$user', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=300,left=700,width=600,height=250');
                    }
                  </script>
";
}
...
$pagesql=mysqli_query($conn,"SELECT dt.`caseno`, dt.`datedischarged`, dt.`timedischarged`, dt.`datearray`, a.`patientidno`, a.`dateadmit`, a.`membership` FROM `dischargedtable` dt, `admission` a WHERE dt.`caseno`=a.`caseno` AND a.`membership`='phic-med' AND a.`caseno` NOT LIKE '%R-%' ORDER BY dt.`datearray`, dt.`patientname`");
...
echo "
                            <tr>
                              ...
                              <td width='2'></td>
                              <form name='ShortPage' method='post' action='../philhealth/?sp&show=$show'>
                              <td><div align='center'>
                              ...
                              <td width='2'></td>
                              <form id='NextPage' name='NextPage' method='post' action='../philhealth/?sp&show=$show&page=".($nxtpage)."'>
                              <td>
...
echo "
                            <tr>
                              <form id='NextPage' name='NextPage' method='post' action='../philhealth/?sp&show=$show&page=".($prevpage)."'>
                              <td>
