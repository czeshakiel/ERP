      ...
      <ul class='menu-list flex-grow-1 mt-3'>
        ...
        <li  class='collapsed'>
          ...
          <ul class='sub-menu collapse $x4' id='claimform'>
            <li><a class='ms-link' href='http://".$_SERVER['HTTP_HOST']."/2017codes/ClaimSignatureForm/ClaimSignatureForm.php?patientidno=$patientidno&caseno=$caseno' target='_blank'><span><i class='icofont-paperclip'></i> CSF</span></a></li>
            <li><a class='ms-link $bacc4a' href='../philhealth/?csfada&caseno=$caseno'><span><i class='icofont-paperclip'></i> CSF Add Data</span></a></li>
            <li><a class='ms-link' href='http://".$_SERVER['HTTP_HOST']."/CF2/cf2_front.php?caseno=$caseno&user=".$sun."' target='_blank'><span><i class='icofont-paperclip'></i> CF2 Front</span></a></li>
            <li><a class='ms-link' href='http://".$_SERVER['HTTP_HOST']."/CF2/before_cf2_back.php?caseno=$caseno' target='_blank'><span><i class='icofont-paperclip'></i> CF2 Back</span></a></li>
            <li><a class='ms-link' href='http://".$_SERVER['HTTP_HOST']."/CF2/ReloadCF2.php?caseno=$caseno' target='_blank'><span><i class='icofont-paperclip'></i> Reload CF2 Data</span></a></li>
          </ul>
        </li>
        <li  class='collapsed'>
        ...
        <li  class='collapsed'>
          <a class='m-link $aac7' href='http://".$_SERVER['HTTP_HOST']."/arv2022/philhealth/checkComplied.php?caseno=$caseno&msg=Complied' target='_blank' ";?> onclick="return confirm('Proceed to set as &quot;Document Compiled&quot;?');" <?php echo ">
            <span><i class='icofont-file-document fs-5'></i> Document Compiled</span>
          </a>
        </li>
        <li  class='collapsed'>
