...
$user=mysqli_real_escape_string($mycon1,$_POST['username']);
...
<div align='center'>
    <table border='0' cellpadding='0' cellspacing='0'>
      <tr>
        <td><div align='center' class='arial s16 blue bold'>Removing patient...</div></td>
      </tr>
</div>
";

mysqli_query($mycon1,"DELETE FROM `translist` WHERE `caseno`='$caseno'");

mysqli_query($mycon1,"UPDATE `dischargedtable` SET `count`='1' WHERE `caseno`='$caseno'");
