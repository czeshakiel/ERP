    ...
    <tr>
      <td><table border='0' width='100%' cellpadding='0' cellspacing='0' class='hoverTable'>
        <tr>
          ...
          <td class='t2 b2 l1' width='150'><div align='center' class='arial s12 black bold'>Date Trans.</div></td>
...
echo "
                    <td><button type='button' class='btn dis' title='Already Imported' disabled><i class='icofont-upload-alt'></i></i></button></td>
";
}
...
echo "
                        <tr>
                          ...
                          <td width='2'></td>
                          <td><div align='center'><form name='ShortPage' method='post' action='../philhealth/?sp&show=$show'>
                            <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                              <tr>
                          ...
                          <td width='2'></td>
                          <td>
                            <a href='../philhealth/?sp&show=$show&page=".($nxtpage)."'><input name='Submit5' type='submit' style='color: blue;border: 1px solid blue;font-weight: bold;' value='  &gt;  ' /></a>
                          </td>
                        </tr>
";
}
...
echo "
                        <tr>
                          <td>
                            <a href='../philhealth/?sp&show=$show&page=".($prevpage)."'><input name='Submit4' type='submit' style='color: blue;border: 1px solid blue;font-weight: bold;' value='  &lt;   ' /></a>
                          </td>
                          <td width='2'></td>
                          <td><div align='center'><form name='ShortPage' method='post' action='../philhealth/?sp&show=$show'>
                            <table border='0' width='100%' cellpadding='0' cellspacing='0'>
