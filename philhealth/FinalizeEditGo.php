...
$setclaimnumber=mysqli_real_escape_string($mycon1,$_POST['setclaimnumber']);
...
mysqli_query($mycon1,"UPDATE `translist` SET `claimnumber`='$setclaimnumber', `datetransmitted`='$dt', `status`='Finalized' WHERE `claimnumber`='$claimnumber'");
