    ...
    <tr>
      <td><div align='left' class='tabstyle'><table border='0' cellapdding='0' cellspacing='0'>
        <tr>
          ...
          <td width='2' bgcolor='#ece0cf' style='border-bottom: 2px solid #ece0cf;'></td>
          <td class='b2'><a href='../philhealth/?pl&show=$show&page=$page' style='text-decoration: none;'><div align='center' class='tabselect'>Pending</div></a></td>
          <td width='2' bgcolor='#ece0cf' style='border-bottom: 2px solid #ece0cf;'></td>
...
$a=0;
$asql=mysqli_query($conn,"SELECT `caseno`, `claimnumber`, `pin`, `membername`, `patientname`, `mtype`, `age`, `sex`, `dateadmitted`, `datedischarged`, `finaldiagnosis`, `roomandboard`, `labothers`, `meds`, `or`, `pf`, `datetransmitted`, `status`, `dateadded`, `user` FROM `translist` WHERE `status`='Pending' ORDER BY `datedischarged`");
...
echo "
              <tr>
                <td><div align='center'><input type='submit'"; ?> onclick="<?php echo "window.open('Finalize.php?caseno=$caseno&uname=$user', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=380,left=720,width=450,height=250');";?>" <?php echo " style='border: 2px solid #000000;width: 150px;height: 30px;border-radius: 4px;font-family: arial;font-size: 14px;font-weight: bold;text-align: center;padding: 3px 3px;background-color: #16C11E;color: #FFFFFF;' value='FINALIZED' /></div></td>
              </tr>
";
}
