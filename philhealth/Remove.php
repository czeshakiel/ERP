...
echo "
<div align='center'>
  <form name='Save' method='post' action='RemoveGo.php' class='form-container-Edit'>
    <table style='height:100%;width:100%; position: absolute; top: 0; bottom: 0; left: 0; right: 0;' border='0' cellpadding='0' cellspacing='0'>
      <tr>
        <td><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            <td colspan='3'><div align='center' class='arial s16 blue bold'>REMOVE &quot;<span style='color: #FF0000'>$name</span>&quot; FROM PENDING LIST?</div></td>
          </tr>
          <tr>
