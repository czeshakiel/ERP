...
$asql=mysqli_query($mycon1,"SELECT `claimnumber`, `datetransmitted` FROM `translist` WHERE `claimnumber`='$claimnumber'");
...
echo "
<div align='center'>
  <form name='Save' method='post' action='FinalizeEditGo.php' class='form-container-Edit'>
    <table border='0' cellpadding='0' cellspacing='0'>
      ...
      <tr>
        ...
        <td><input type='text' placeholder='Transmittal Number' name='setclaimnumber' value='$claimnumber' autocomplete='off' style='width: 250px;height: 40px;' required /></td>
      </tr>
      <tr>
