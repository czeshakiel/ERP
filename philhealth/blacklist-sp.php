...
.dis {background-color: #F5F5F5;color: #e9e9e7;border: 1px solid #F5F5F5;width: 25px;height: 25px;border-radius: 7px;font-family: arial;font-size: 12px;font-weight: bold;text-align: center;padding: 0px 0px;}
</style>
<script>
  function refundItem(){
...
xmlhttp.open("GET","blacklist-spsr.php?blksp&user='.$user.'&userunique='.$userunique.'&show='.$show.'&page='.$page.'&searchme="+document.searchme.searchme.value,true);
xmlhttp.send();
}
';
?>
                      ...
                      <tr>
                        <td width='50%'><div align='left'><table border='0' cellpadding='0' cellspacing='0'>
                          <tr>
                            ...
                            <td width='5'></td>
                            <form id='NextPage' name='NextPage' method='post' action='../philhealth/?blksp&page=0'>
                        ...
                        <td width='50%'><div align='right'>
                          <table border='0' cellpadding='0' cellspacing='0'>
                            <tr>
                              <form name='searchme' onload='showResult();' method='post' action='../philhealth/?blksp&show=$show&page=".($page)."'>
...
echo "
                                          <tr>
                                            ...
                                            <td width='2'></td>
                                            <form name='ShortPage' method='post' action='../philhealth/?blksp&show=$show'>
                                            <td><div align='center'>
                                            ...
                                            <td width='2'></td>
                                            <form id='NextPage' name='NextPage' method='post' action='../philhealth/?blksp&show=$show&page=".($nxtpage)."'>
                                            <td>
...
echo "
                                          <tr>
                                            <form id='NextPage' name='NextPage' method='post' action='../philhealth/?blksp&show=$show&page=".($prevpage)."'>
                                            <td>
