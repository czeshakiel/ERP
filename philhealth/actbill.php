            ...
            <div class='card mb-3'>
              <div class='card-header'>
                <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr>
                    <td><div align='left'><h5 class='fw-bold'><i class='icofont-money me-2'></i> Actual Bill</h5></div></td>
                  </tr>
                </table>
              </div>
...
if(!isset($_POST['proceeddocom'])){
  ...
  if($kaxdocom=="Actual Bill"){
    $kaxlabel="Proceed to set patient's billing account to &quot;w/ PhilHealth or HMO&quot;?";
    $docomact="";

  }
  else{
    $kaxlabel="Proceed to set patient's billing account to &quot;Actual Bill&quot;?";
    $docomact="Actual Bill";
  }
...
";
  ...
  if($docomact=="Actual Bill"){
    $kaxlabel="Actual bill status is set";

  }
  else{
    $kaxlabel="Actual bill status is removed";
  }
