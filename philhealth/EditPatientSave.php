...
mysqli_query($mycon1,"UPDATE `translist` SET `finaldiagnosis`='$finaldiagnosis', `roomandboard`='$roomandboard', `labothers`='$labothers', `meds`='$meds', `or`='$or', `pf`='$pf' WHERE `caseno`='$caseno'");
