            ...
            <div class='card mb-3'>
              <div class='card-header'>
                <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr>
                    <td><div align='left'><h5 class='fw-bold'><i class='icofont-pixels me-2'></i> Update Remarks</h5></div></td>
                  </tr>
                </table>
              </div>
...
echo "
                      <form method='post'>
                        <table border='0' cellpadding='0' cellspacing='0'>
                          <tr>
                            <td><div style='font-family: arial;font-weight: bold;font-size: 16px;color: #089AD1;padding: 0 0 0 3px;'>Remarks</div></td>
                            <td><div style='padding: 0 3px 0 3px;'>
                              <textarea name='remarks' style='border-radius: 5px;padding: 5px;width: 300px;' rows='4' placeholder='Remarks' autofocus>$adremarks</textarea>
                            </div></td>
                        ...
                        <input type='hidden' name='oldremarks' value='$adremarks' />
...
";
  ...
  $oldremarks=mysqli_real_escape_string($conn,$_POST['oldremarks']);
  $spn=mysqli_real_escape_string($conn,$_POST['spn']);


  mysqli_query($conn,"UPDATE `admission` SET `remarks`='$newremarks' WHERE `caseno`='$caseno'");
  mysqli_query($conn,"INSERT INTO `userlogs` (`loginuser`, `transaction`, `timearray`, `datearray`) VALUES ('".base64_decode($_SESSION['nm'])."','|$spn|Change Remarks to $newremarks from $oldremarks.|$caseno|','".date("H:i:s")."', '".date("Y-m-d")."')");

echo "
                <div style='font-family: arial;font-weight: bold;font-size: 16px;color: #089AD1;padding: 0 0 0 3px;'>Remarks Updated</div>
";
