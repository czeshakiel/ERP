...
<h6 class='light-info-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-14 mb-0'>(ECG, HEARTSTATION)</h6>
</div>

<form method='POST' action='?heartrep_print'>
...
$sqltest = $conn->query("SELECT * FROM receiving WHERE unit LIKE 'HEARTSTATION' or unit LIKE 'ECG' ORDER BY description ASC");
...
$sql22d = $conn->query("select * FROM nsauthdoctors where station='HEARTREADER' or station='HEARTDOCTOR' and name!=''");
