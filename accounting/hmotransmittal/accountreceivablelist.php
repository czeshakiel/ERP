...
echo"<script>alert('Saved....'); window.location='?view=accountreceivablelist$datax$datax2'</script>";
}
...
echo"<script>alert('Deleted....'); window.location='?view=accountreceivablelist$datax$datax2'</script>";
}
...
else{echo"<script>alert('Unable to process transaction!'); window.location='?view=accountreceivablelist$datax$datax2'</script>";}
}
?>
...
<form method="POST">
<input type="text" name="product" placeholder="&#128269; Search by Name (Lastname Firstname Middlename)">
</form>
</div>
...
<tr>
<td bgcolor="<?php echo $primarycolor ?>"><font size='2' color='white'></td>
<td bgcolor="<?php echo $primarycolor ?>"><font size='2' color='white'>Caseno</td>
<td bgcolor="<?php echo $primarycolor ?>"><font size='2' color='white'>Patient Name</td>
<td bgcolor="<?php echo $primarycolor ?>"><font size='2' color='white'>Date Admit</td>
<td bgcolor="<?php echo $primarycolor ?>" width="20%"><font size='2' color='white'>Amount</td>
</tr>
...
$btn = "<button class='btn btn-primary' name='btnsave'><li class='fa fa-check'></li></button>";
...
<tr>
<td bgcolor="<?php echo $primarycolor ?>"><font size='2' color='white'>Name</td>
<td bgcolor="<?php echo $primarycolor ?>"><font size='2' color='white'>amount</td>
<td bgcolor="<?php echo $primarycolor ?>"><font size='2' color='white'>Action</td>
</tr>
...
<form method='POST'>
<button type='submit' class='btn btn-danger' name='btndel'><li class='fa fa-trash'></li></button>
