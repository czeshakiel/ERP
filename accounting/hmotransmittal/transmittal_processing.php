<h5><font color='black'><i class="fa-solid fa-list-check"></i> FOR PROCESSING TRANSMITTAL</font></h5><hr>
...
<?php
$i = 0;
$sql4 = "select sum(amount) as amount, batchno, transdate, user, company, controlno, idhmo, trantype, ptype from arv_tbl_hmotransmittallist where transaction = 'Approved' and status='pending' group by batchno";
...
if($trantype=="insurance"){$dist = "?processingdetails&hmo=$hmo&batchno=$batchno&controlno=$controlno&transdate=$transdate"; $targ="";}
else{$dist = "hmotransmittal/transmittalletter_assistance.php?hmo=$hmo&batchno=$batchno&controlno=$controlno&transdate=$transdate"; $targ="target='_blank'";}
