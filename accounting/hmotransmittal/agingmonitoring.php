...
$hmo = $_POST['hmo'];
$vdate = $_POST['vdate'];
echo"<script>window.location='?agingmonitoringdetail&vdate=$vdate&hmo=$hmo';</script>";
}
?>
...
<li class="breadcrumb-item active"><a href="?agingmonitoring">Aging Monitoring</a></li>
</ol>
</nav>
</div><!-- End Page Title -->
...
<i class="bi bi-award"></i> AGING MONITORING
</div>
<div class="card-body">
