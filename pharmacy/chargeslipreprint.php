...
$sql22 = "SELECT * from arv_tbl_invoice where invno='$invno'";
$result22 = $conn->query($sql22);
while($row22 = $result22->fetch_assoc()) {
$ddate=date("M d, Y", strtotime($row22['datearray']));
$ttime=date("h:i:s a", strtotime($row22['timearray']));
}

$datearray1 = date("M d, Y");
...
$tot_adj=0;
$grandtotal=0;
$sql22 = "SELECT * from arv_tbl_invoice where caseno='$caseno' and invno='$invno' and trantype='$trantype'";
$result22 = $conn->query($sql22);
$countlist = mysqli_num_rows($result22);
while($row22 = $result22->fetch_assoc()) {
$quantity=$row22['quantity'];
$desc=$row22['desc'];
$sellingprice=($row22['net']+$row22['discount']) / $quantity;
$adjustment=$row22['discount'] / $quantity;
...
<td width="20%"><p align="right"><font size='1' class='font1'><b><?php echo $actualamount  ?></b></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td><div align="right"><font size='1' class='font1'><b>Less: SC/PWD Discount:</b></div></td>
<td width="20%"><p align="right"><font size='1' class='font1'><b><?php echo $discount ?></b></td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td><p align="right"><font size='1' class='font1'><b>Total Due:</b></td>
<td width="20%"><p align="right"><font size='1' class='font1'><b><?php echo $TOTALPRICE  ?></b></td>
</tr>
</table>
</td>
</tr>
...
$quantity=$row22['quantity'];
$desc=$row22['desc'];
$sellingprice=$row22['net'] / $quantity;
$adjustment=$row22['discount'] / $quantity;
$total = $sellingprice * $quantity;
$tot_adj = $tot_adj + $adjustment;
$grandtotal = $grandtotal + $total;
