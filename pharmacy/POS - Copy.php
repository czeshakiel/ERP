...
<td align="right"><h5><b>POINT OF SALE</b></h5></td></tr></table>
</div>
...
<td style='background: $col;' width='50%'>"; ?><a href="" onclick="alert('<?php echo $val ?>');"><?php echo"<font size='1' color='black'>$desc</a> <font color='$vatcol' size='1'>$wvat</font></td>
...
<td width="20%">
<form method="POST">
<button style="width: 135px; background: #830d21; color: white;" name="btnclear" id="btnclear" class="btn btn-danger" onclick="return confirm('Are you sure you want to clear the existing transaction?');"><font size="1"><i class="bi bi-slash-circle"></i> CLEAR [ F1 ]</font></button><br>
</form>
</td>

<td width="20%">
<form method="POST">
<button style="width: 135px; background: #0a3877; color: white;" class="btn btn-info" name="applysenior" id="applysenior""><font size="1"><i class="bx bxs-discount"></i> Apply Senior [Ctrl+1]</button>
</form>
</td>
...
<td width="20%">
<form method="POST">
<button style="width: 135px; background: #7a25a1; color: white;" class="btn btn-warning" name="revertsenior" id="revertsenior"><font size="1"><i class="bx bx-rewind-circle"></i> Revert Senior [Ctrl+2]</button>
</form>
</td>
...
<td width="20%">
<button style="width: 135px; background: #10703d; color: white;" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#patientprofile" id="newpatient"><font size="1"><i class="bx bx-rewind-circle"></i> New Patient [ F2 ]</button>
</td>



<td>
<button style="width: 135px; background: #705010; color: white;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#postpayment" id="postpayment1" onclick="getorno('<?php echo $mydept ?>'); load11('patient'); load22('doctor');"><font size="1"><i class="bx bx-rewind-circle"></i> Post Payemnt [ F9 ]</button>
</td>

<td>
<button class="btn btn-warning" style="width: 135px; background: #9f2c48; color: white;" data-bs-toggle="modal" data-bs-target="#submitreq" onclick="load1('patient'); load2('doctor');"><font size="1"><i class="bi bi-patch-check"></i> SUBMIT [ F10 ]</font></button><br>
</td>
</tr>
</table>
...
<form method="POST">
<table align="center" width="100%">
<tr><td><select class="form-control" name="pname" id="ptid2" onchange="ptid(this.value);" style="width: 100%;" required></select></td></tr>
