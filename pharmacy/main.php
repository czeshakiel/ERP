...
AND p.location = '$dept' AND p.administration = 'pending' AND p.shift != 'HOMEMEDS' AND p.quantity > 0 GROUP BY p.caseno, p.batchno, p.trantype, p.status
...
echo"
<tr>
<td bgcolor='$col' align='center'><font color='$colx' size='3'>$i.</td>
<td bgcolor='$col' style='color: $colx; font-size: 13px;'><table><tr><td><img src='../main/img/$ge.png' width='30' height='30' style='border-radius: 50%;'></td><td> $caseno<br><b>$patientname</b></td></tr></table></td>
<td bgcolor='$col' style='color: $colx; font-size: 13px;'><font color='gray'><i class='icofont-ui-calendar'></i></font> $ddate $invnox <br><font color='gray'><i class='icofont-user'></i></font> $userx</td>
<td bgcolor='$col' style='color: $colx; font-size: 13px;'><font color='gray'><i class='icofont-bed'></i></font> $room <font color='blue'>[$ns]</font> <br><font color='gray'><i class='icofont-company'></i></font> $batchno</td>
<td bgcolor='$col' style='color: $col1; font-size: 13px;'><span class='$lc'>$trantype</span><br><span class='$lc2'>$status1</span></td>
<td style='text-align: center;' bgcolor='$col'>
<a href='?details&caseno=$rowa2[caseno]&batchno=$rowa2[batchno]$datax&stat=$trantype' class='btn btn-outline-dark btn-sm' title='View Profile'><i class='icofont-waiter-alt'></i></a>
