...
if($lotno=="S"){
$result22223 = $conn->query("SELECT opd from productsmasterlist where code='$codep'");
while($row22223 = $result22223->fetch_assoc()) {$sellingp=$row22223['opd'];}
}
...
$sqlBB = "update poswalkin2 set sellingprice='$sellingp', gross='$newgross', adjustment='$newadj', net='$newnet', lessvat='$lessvat', less='$less', dis='Y' where id='$id'";
...
$datalist = $prodtype."||".$lotno."||".$unitp."||".$sellingp."||".$testcode."||".$qty1."||".$codep;
...
$sqlBB = "update poswalkin2 set sellingprice='$sp', gross='$newgross', adjustment='$newadj', net='$newnet', dis='N', lessvat='$lessvat', less='$less' where id='$id'";
if($conn->query($sqlBB) === TRUE){}
}
echo"<script>window.location='?pos';</script>";
}
...
<div id="scroll" class="keep-scrolling" style="height: 100%;">
<table class="tablex">
<?php
...
$mycount = mysqli_num_rows($resultcc);
...
<td>
<button class="btn btn-warning" style="width: 100%; background: #9f2c48; color: white;" data-bs-toggle="modal" data-bs-target="#submitreq"><font size="1"><i class="bi bi-patch-check"></i> SUBMIT [ F10 ]</font></button><br>
</td>
</tr>
</table>
...
<tr>
<td width="20%" style='font-size:11px;'>Lastname: <br><input type="text" name="lastname" style="height:30px; font-size:12pt; padding: 2px; width:100%;" required></td>
</tr>
<tr>
<td style='font-size:11px;'>Firstname: <br><input type="text" name="firstname" style="height:30px; font-size:12pt; padding: 2px; width:100%;" required></td>
</tr>
<tr>
<td style='font-size:11px;'>Middlename: <br><input type="text" name="middlename" style="height:30px; font-size:12pt; padding: 2px; width:100%;"></td>
</tr>
<tr>
<td style='font-size:11px;'>Suffix: <br><input type="text" name="suffix" placeholder="e.g. JR." style="height:30px; font-size:12pt; padding: 2px; width:100%;"></td>
</tr>
<tr>
<td style='font-size:11px;'>Birthdate: <br><input type="date" name="birthdate" value="<?php echo date('Y-m-d'); ?>" style="height:30px; font-size:12pt; padding: 2px; width:100%;"></td>
</tr>
<tr>
<td style='font-size:11px;'>Gender: <br>
<select name="gender" style="height:30px; font-size:12pt; padding: 2px; width:100%;">
...
<tr>
<td style='font-size:11px;'>Discount: <br>
<select name="discount" style="height:30px; font-size:12pt; padding: 2px; width:100%;">
...
<tr>
<td>Password: <br><input type="password" name="password" style="background-color: lightyellow; height:30px; font-size:12pt; padding: 2px; width:100%;" required></td>
</tr>
</table>
</div>
...
<form method="POST">
<table align="center" width="100%">
<tr><td><select class="selectpatient" name="pname" id="ptid2" style="width: 100%;" required></select></td></tr>
<tr><td><select class="selectdoctor" name="docname" id="docid2" style="width: 100%;" required></select></td></tr>
...
openOnEnter: true,
allowClear: true,
dropdownParent: $('#submitreq'),
ajax: {
url: '../main/functions.php',
dataType: 'json',
delay: 250,
