...
<tr>
<td>
<font color='gray'>Code:</font> $code <br> <font color='gray'>Description:</font> $desc</font><hr>
...
$discre = 0;
$sql222 = "SELECT * FROM `scm_adjustmenthistory` WHERE code='$code' and datearray between '$dstart' and '$dend' and dept='$dept' order by datearray, timearray";
