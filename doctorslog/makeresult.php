...
<tr>
<td width="45%"><font class="font8">READER:<br><input type="text" name="reader" value="<?php echo $radiologist ?>" style="height:30px; font-size:10pt; padding: 0px; text-align: center; width: 100%;" readonly></td>
<td><font class="font8">FILM NO.:<br><input type="text" name="filmno" value="<?php echo $filmno ?>" style="height:30px; font-size:10pt; padding: 0px; text-align: center; width: 100%;" required></td>
...
<tr>
<td colspan="3" valign="bottom" style="text-align: right;"><button class="btn btn-warning btn-sm" name="btn_sub" onclick="aac()"><i class="bi bi-twitter"></i> Submit Result</button></td>
</tr>
</table>
<hr>
