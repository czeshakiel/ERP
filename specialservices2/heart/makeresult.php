...
<tr>
<td width="30%"><font class="font8">READER:<br><input type="text" name="reader" value="<?php echo $radiologist ?>" style="height:30px; font-size:12pt; padding: 0px; text-align: center;" readonly></td>
<td><font class="font8">FILM NO.:<br><input type="text" name="filmno" value="<?php echo $filmno ?>" style="height:30px; font-size:12pt; padding: 0px; text-align: center;" required></td>
<td><font class="font8">RAD TECH:<br>
<select name="radtech" class="select2-single form-control" required>
<option value="<?php echo $_SESSION['userxx']; ?>"><?php echo $_SESSION['userxx']; ?></option>
...
<tr>
<td colspan="3" valign="bottom" style="text-align: right;"><button class="btn btn-danger btn-sm" name="btn_sub" onclick="aac()"><i class="bi bi-twitter"></i> Submit Result</button></td>
</tr>
</table>
<hr>
...
<link rel="stylesheet" type="text/css" href="<?php echo $ipxx ?>assets/vendor/editor/dist/themes/flat/style.css" />
<textarea id="id_cazary_full" placeholder="Enter Result here..." style="height: 650px; width: 100%;" name="result"></textarea>
...
<script type="text/javascript" src="<?php echo $ipxx ?>assets/vendor/editor/addition.js"></script>
<script type="text/javascript" src="<?php echo $ipxx ?>assets/vendor/editor/dist/cazary.min.js"></script>
