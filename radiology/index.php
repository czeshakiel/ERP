...
elseif(isset($_GET['details'])){$main="xrayresults.php"; $sidebar="sidebar.php";}
...
elseif(isset($_GET['editresult'])){$main="../readerslog/makeresult.php"; $sidebar="sidebar.php";}
elseif(isset($_GET['readerslogin'])){$main="readerslogin.php"; $sidebar="sidebar.php";}
elseif(isset($_GET['dicomreader'])){$main="dicomreader.php"; $sidebar="sidebar.php";}
elseif(isset($_GET['readersfee'])){$main="readersfee.php"; $sidebar="sidebar.php";}
