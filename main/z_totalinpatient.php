          ...
          <div class="card">
            ...
            <table class="tablex" width="100%">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col" width="35%">Patient Information</th>
                    <th scope="col">Date/ Time Admitted <br>Attending Physician</th>
                    <th scope="col">Room & Status</th>
                    <th scope="col" width="27%">Inital Diagnosis</th>
                  </tr>
                </thead>
                <tbody>
...
$sql = "SELECT a.caseno,a.dateadmit,a.room,a.status,a.ap,a.result,a.hmomembership,pp.lastname,pp.firstname,pp.middlename,pp.sex, a.timeadmitted, a.patientidno,
 a.employerno, r.nursestation, a.initialdiagnosis FROM admission a LEFT JOIN patientprofile pp ON pp.patientidno=a.patientidno JOIN room r ON r.room=a.room WHERE $qry 
...
$initialdx = $row['initialdiagnosis'];
...
echo"
<tr>
<td valign='TOP' bgcolor='$col' align='center'><font color='$colx' size='2'>$i.</td>
<td valign='TOP' data-label='Patient Information' bgcolor='$col' style='color: $colx; font-size: 11px;'><div class='row'><div class='col-lg-2'><a href='?detail&caseno=$row[caseno]' title='View Profile'><img src='../main/img/$ge.png' width='30' height='30' style='border-radius: 50%;'></a></div><div class='col-lg-10'> $patientidno/ $caseno/ $hcaseno $newadd<br><b>$name</b></div></div></td>
<td valign='TOP' data-label='Date/Time Admit/ AP' bgcolor='$col' style='color: $colx; font-size: 11px;'>$dateadmit $timeadmitted <br> $ap</td>
<td valign='TOP' data-label='Room/Status' bgcolor='$col' style='color: $colx; font-size: 11px;'>$room<br><font color='$col' class='$blink'>$status</td>
<td valign='TOP' bgcolor='$col' style='color: $colx; font-size: 10px; text-align: center;'>
$initialdx
</td>
</tr>
";
