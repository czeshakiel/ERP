...
$user = $_GET['user'];
$approvalno=$_GET['approvalno'];


if($refno==""){$qry = "batchno='$batchno'";}
else{$qry="refno='$refno'";}
...
$chargeto = $row2['addemployer'];
$sqlAp=mysqli_query($conn,"SELECT `name` FROM nsauthemployees WHERE empid='$chargeto'");
  if(mysqli_num_rows($sqlAp)>0){
    $myap=mysqli_fetch_array($sqlAp);
    $chargeto=$myap['name'];
  }
...
<table width='330' border='0' cellpadding='0' cellspacing='0'>
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
      <tr>
        <td width='25'><div align='center'><img src='../main/img/logo/kmsci.png' width='23' height='auto' /></div></td>
  ...
  <tr>
   ...
   <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
      <tr>
        <td><div align='left' class='arial s10 black bold'>&nbsp;Charge to: <?=$chargeto;?></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
	  ...
	  <?php
	  if($approvalno==""){
$sql4 = "SELECT * FROM productout where $qry and quantity>0";
}else{
	$sql4 = "SELECT * FROM productout where approvalno='$approvalno' and caseno='$caseno' and quantity>0";
}
$result4 = $conn->query($sql4);
while($row4 = $result4->fetch_assoc()) {
...
if($trant=="cash"){$trantyp="Cash";}
else if($trant=="charge"){$trantyp="Charge";}
else{$trantyp=$trant;}

$sql222 = "SELECT * from labtest where caseno='$caseno' and refno='$refno'";
$result222 = $conn->query($sql222);
while($row222 = $result222->fetch_assoc()) {
$remarks=$row222['remarks'];
}

$gen=""; $description="";
$sql222 = "SELECT * from receiving where code='$productcode'";
$result222 = $conn->query($sql222);
while($row222 = $result222->fetch_assoc()) {
$gen= " (".$row222['generic'].")";
...
<tr>
<td width='10'></td>
<td><div align='left' class='courier s11 black bold'>$desc <span style='color: blue;font-size: 10px;'>($trantyp)</span></div></td>
<td width='30'><div align='center' class='courier s11 black bold'>$qty</div></td>
</tr>
";
}
...
<div id="apDiv1">
  <table width="330" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td class='t2'>PREPARED BY : <b><?php echo $user ?></b></td>
    </tr>
   </table>
</div>
