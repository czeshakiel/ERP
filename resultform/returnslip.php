...
<table width='370' border='0' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
      <tr>
        <td><div align='center' class='arial s10 black bold' style='font-size: 15px;'>&nbsp;ITEM(S) RETURN</div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
$sql4 = "SELECT * FROM productreturn where caseno='$caseno' and trantype='finalized' $bn";
$result4 = $conn->query($sql4);
while($row4 = $result4->fetch_assoc()) {
...
$desc=$row5['description']." [".$row5['generic']."]";
}
echo "
<tr>
<td width='10'></td>
<td style='border-bottom-style: double;'><div align='left' class='courier s11 black bold'>$desc</div></td>
