<?php
require_once '../resultform/dompdf/autoload.inc.php';
...
$sql222 = "select * from stocktable where dept='$dept' and code='$code' and datearray between '$dstart' and '$dend' order by datearray";
$result222 = $conn->query($sql222);
while($row222 = $result222->fetch_assoc()){ 
$date=date("M-d-Y", strtotime($row222['datearray']));
