...
$newbatchno = $_GET['batchno'];
$bn = "and origqty='$newbatchno'";
}
...
<table width='370' border='0' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
      <tr>
        <td><div align='center' class='arial s10 black bold' style='font-size: 15px;'>&nbsp;CHARGE TO STATION (Credit Notes)</div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
	  ...
	  <?php
$sql4 = "SELECT * FROM productreturnCN where caseno='$caseno' and trantype='return' $bn";
$result4 = $conn->query($sql4);
while($row4 = $result4->fetch_assoc()) {
$code=$row4['productcode'];
$qty=$row4['quantity1'];
$nurse=$row4['nurse'];
...
$generic=$row5['generic'];
}
echo "
<tr>
<td width='10'></td>
<td><div align='left' class='courier s11 black bold'>$desc ($generic)</div></td>
<td><div align='center' class='courier s11 black bold'>$qty</div></td>
</tr>
<tr>
<td width='10'></td>
<td style='border-bottom-style: double;'><div align='left' class='courier s11 black bold'><i><font color='red'>$nurse - $station</div></td>
<td style='border-bottom-style: double;' width='30'><div align='center' class='courier s11 black bold'><i><font color='red'>$amount</div></td>
</tr>
";
}
