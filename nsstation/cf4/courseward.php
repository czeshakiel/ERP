...
$sql778m = "Update courseward_logs set logs = CONCAT(logs, '\n$userxx') where trans_id='$idno'";
if ($conncf4->query($sql778m) === TRUE) {}
...
<label for="floatingTextarea"><font color="blue">&#x267F; Enter Doctors Order here......</font></label>
</div>
</div>
...
elseif($count_courseward==0){echo"<p align='center'><font color='red' size='5'>Please enter minimum of of 2 course ward!</font></p>";}
