...
echo"<a href='http://$ip/cgi-bin/bloodchemnewns.cgi?refno=$refno&productdesc=$productdesc&trantype=$trantype&nursename=$user&nursestation=&caseno=$caseno&setgrp=2&lyte=$lotno' target='_bank'><button type='submit' class='btn btn-outline-danger btn-sm'><i class='icofont-flask'></i></button></a>";
}
}
?>
</td>
