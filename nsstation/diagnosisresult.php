...
<?php
if((isset($_POST['stest']))||(isset($_POST['cres']))||(isset($_POST['sres']))){
            ...
            <td>
              <div class='container'>
                <div class='btn-group btn-group-justified' style='width: 100%;'>
                  <button name='ipd' style='width:20%; font-size: 12px;' onclick=loadz('xray'); $ipd ><i class='icofont-users-alt-5'></i> Imaging Results</button>
                  <button name='opd' style='width:20%; font-size: 12px;' onclick=loadz('lab'); $opd ><i class='icofont-users-social'></i> Laboratories</button>
                  <button name='rdu' style='width:20%; font-size: 12px;' onclick=loadz('ecg'); $ttbd ><i class='icofont-ui-clip-board'></i> ECG Results</button>
                </div>
              </div>
            </td>
          </tr>
