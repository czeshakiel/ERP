...
<?php
$i=0;
$sql = $conn->query("SELECT * FROM productout where caseno= '$caseno' and  (productsubtype = 'PHARMACY/SUPPLIES' or productsubtype = 'RDU SUPPLIES' or 
productsubtype = 'RDU-SUPPLIES' or productsubtype LIKE '%CSR KIT%' or productsubtype LIKE '%OR/DR SUPPLIES%' or productsubtype LIKE '%MEDICAL SURGICAL SUPPLIES%'
or productsubtype LIKE '%MEDICAL SUPPLIES%') and (status = 'Approved' or status= 'PAID' or status= 'BALANCE' or status= 'requested' or status= 'REFUND')
