...
<h6 class='light-info-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-14 mb-0'><i class='icofont-patient-bed'></i> TEST PERFORMED</h6>
</div><br>
<?php
...
$ck = $conn->query("select * from productout where caseno='$caseno' and productsubtype = '$array[$ix]' and (terminalname!='Testdone' and terminalname!='Testtobedone')");
$ck2 = $conn->query("select * from productout where caseno='$caseno' and location like '%$array[$ix]%' and (terminalname!='Testdone' and terminalname!='Testtobedone')");
...
$i = 0;
$sql22 = "SELECT * from productout where caseno='$caseno' $que and status!='CANCELLED' and (terminalname!='Testdone' and terminalname!='Testtobedone') order by producttype, productsubtype, terminalname, productdesc";
...
<li><a class='dropdown-item' href='../resultform/ticket_batch.php?caseno=$caseno&refno=$refno&user=$user' target='_blank'><i class='fa fa-print'></i> Print</a>
";
?>
...
<div class='dd-handle'>
<div class='task-info d-flex align-items-center justify-content-between'>
<h6 class='light-warning-bg py-1 px-2 rounded-1 d-inline-block fw-bold small-14 mb-0'><i class='icofont-patient-bed'></i> Medicine, Supplies & Other Request</h6><br>
</div>
