...
<table width='330' border='0' cellpadding='0' cellspacing='0'>
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
      <tr>
        <td width='25'><div align='center'><img src='../../main/img/logo/mmshi.png' width='23' height='auto' /></div></td>
  ...
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
      ...
      <tr>
        <td class='b1'><div align='left' class='arial s11 black'>&nbsp;Requesting to: <b id='locx'></b></div></td>
      </tr>
    </table></td>
  </tr>
	<tr>
  ...
  <tr>
    <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
	  ...
	  <?php
$sql4 = "SELECT * FROM productout where $qry and quantity>0 and trantype='charge' and administration='pending'";
$result4 = $conn->query($sql4);
while($row4 = $result4->fetch_assoc()) {
...
echo"<script>document.getElementById('locx').innerHTML = '$location';</script>";
