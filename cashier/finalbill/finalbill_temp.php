...
$sqla11 = "INSERT INTO `collection_temp2`(`refno`, `acctno`, `acctname`, `ofr`, `description`, `accttitle`, `amount`, `discount`, `date`, `Dept`, `username`, `shift`, `type`, `paymentTime`, `paidBy`, `datearray`, `branch`) VALUES ('$refnohosp', '$caseno', '$name', '', 'HOSPITAL BILL', 'AP PATIENT DEPOSIT', '$hospitalpay', '', '$vdate', 'in', '$user', '', 'pending', CURTIME(), '$dept', CURDATE(), '$branch')";
...
$sqla11 = "INSERT INTO `collection_temp2`(`refno`, `acctno`, `acctname`, `ofr`, `description`, `accttitle`, `amount`, `discount`, `date`, `Dept`, `username`, `shift`, `type`, `paymentTime`, `paidBy`, `datearray`, `branch`) VALUES ('$refnohosp', '$caseno', '$name', '', 'HOSPITAL BILL', '$artrade', '$bal', '', '$vdate', 'in', '$user', '$chargeto', 'pending', CURTIME(), '$dept', CURDATE(), '$approvedby')";
...
$sqla11 = "INSERT INTO `collection_temp2`(`refno`, `acctno`, `acctname`, `ofr`, `description`, `accttitle`, `amount`, `discount`, `date`, `Dept`, `username`, `shift`, `type`, `paymentTime`, `paidBy`, `datearray`, `branch`) VALUES ('$refnodoc[$i]', '$caseno', '$name', '', '$pdesc', 'AR TRADE PF', '$bal2', '', '$vdate', 'in', '$user', '$chargeto', 'pending', CURTIME(), '$dept', CURDATE(), '$branch')";
...
//end of update 10-12-2023 8:56am
