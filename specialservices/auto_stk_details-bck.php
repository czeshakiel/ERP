...
";
  ...
  $fspo=mysqli_real_escape_string($tconn,$_POST['po']);
...
";
  ...
  $reclog="$user --> PO: $fspo --> Items: $zacount --> Remarks: Finalized PO.";
  mysqli_query($conn,"INSERT INTO `userlogs` (`transaction`, `loginuser`, `datearray`, `timearray`) VALUES ('$reclog', '$user', '".date("Y-m-d")."', '".date("H:i:s")."')");
