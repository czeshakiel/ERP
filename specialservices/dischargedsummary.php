...
<td style="font-size: 11px;">:</td>
<td style="font-size: 11px; border-bottom: 1px solid black;" colspan="5">'.strtoupper($finaldiagnosis).'</td>
</tr>
<tr>
<td style="font-size: 11px;"><b>Operation Done</b></td>
<td style="font-size: 11px;">:</td>
<td style="font-size: 11px; border-bottom: 1px solid black;" colspan="5">'.strtoupper($operationdone).'</td>
</tr>
</table>
...
productouthm po, homemeds h WHERE po.caseno=h.caseno and po.productcode=h.code and h.caseno='$caseno' ORDER by h.no");
while($afetch = $dd->fetch_assoc()){
$no=$afetch['no'];
$refno=$afetch['refno'];
