...
if((!isset($_SESSION['un']))&&(!isset($_SESSION['pw']))&&(!isset($_SESSION['nm']))&&(!isset($_SESSION['ac']))){
  $cont=base64_encode(str_replace("/ERP/laboratory/","",$_SERVER['REQUEST_URI']));
  ...
  <div class='modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable'>
    <div class='modal-content'>
      <div class='modal-header'>
        ...
        <a href='../login/?dept=LABORATORY&cont=$cont'><button type='button' class='btn-close' aria-label='Close'></button></a>
      </div>
