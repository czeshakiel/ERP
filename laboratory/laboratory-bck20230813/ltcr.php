  ...
  <form method='post'>
    <table border='0' cellpadding='0' cellspacing='0'>
      ...
      <tr>
        ...
        <td class='b2 l1 r2' colspan='2'><div align='left' style='padding: 5px;'><input type='text' name='printbatchno' placeholder='Laboratory Number' style='width: 100%;height: 35px;font-size: 14px;border-radius: 5px;border: 2px solid #000000;' value='$pref".date("YmdHis")."' required /></div></td>
      <tr>
      <tr>
...
echo "
          ...
          <table border='0' width='100%' cellpadding='0' cellspacing='0'>
            <tr>
              <td style='padding-right: 5px;'><div align='center'>
                <select name='result-$x-$b' style='height: 30px;width: 210px;font-size: 15px;' autofocus required>
                  <option value=''></option>
";
...
echo "
          <input type='hidden' name='prf-$x-$b' value='' />
          <input type='text' name='result-$x-$b' style='height: 30px;font-size: 15px;' placeholder='Type Result' value='' autofocus />
";
            }
            else{
              if($type==3){
...
echo "
              <td class='b1 l1'><div align='center' style='padding: 5px 5px;'>
                ...
                <select name='result-$x-$c-$zy' style='height: 30px;' required>
