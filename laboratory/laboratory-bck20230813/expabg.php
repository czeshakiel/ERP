            ...
            <div class='card mb-3'>
              <div class='card-header'>
                <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr>
                    <td width='50%'><div align='left'><h5 class='fw-bold'><i class='icofont-question-circle me-2'></i> UN-VERIFIED ABG LIST</h5></div></td>
...
$ax=0;
$axsql=mysqli_query($conn,"SELECT * FROM `labpending` WHERE `itemcode`='100004406n-35' AND `resultstatus`='Testdone' AND `testdonedt` LIKE '$da%%' AND `verified`='0' ORDER BY `testdonedt`");
while($axfetch=mysqli_fetch_array($axsql)){
  ...
  $plink="<form name='Print' target='_blank' method='get' action='../../arv2022/specialservices/abg_printresult_beta.php'><input type='hidden' name='caseno' value='$caseno' /><input type='hidden' name='refno' value='$refno' /><button type='submit' class='btn btn-info text-white' title='View Result'><i class='icofont-print'></i></button></form>";
