...
echo "
                          <tr>
                            <td>$ar</td>
                            <td>$arreqno</td>
                            <td><div align='center'><a href='../medmatrix/stock_request_print/$arreqno' target='_blank'><button type='button' class='btn btn-success' title='Print Request'><i class='icofont-printer text-white'></i></button></a></div></td>
                          </tr>
";
}
