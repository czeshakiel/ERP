          ...
          <div class='col-sm-12'>
            <div class='card mb-3'>
              ...
              <div class='card-body' style='padding-top: 0px;'>
                <iframe src='../extra/CartBeta/?caseno=$caseno&ct=sot-lab&dept=$dept&user=$userunique&lin&linu=".base64_encode($userunique)."&linp=".base64_encode($_SESSION['pw'])."' title='description' width='100%' height='420' style='border: none;'></iframe>
              </div>
            </div>
          </div>
        </div><!-- Row End -->
