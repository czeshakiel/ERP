      ...
      <ul class='menu-list flex-grow-1 mt-3'>
        ...
        <li class='collapsed'>
          ...
          <ul class='sub-menu collapse $x3' id='transactions'>
            <li><a class='ms-link $bacc3a' href='../medmatrix/request_stock/".base64_decode($_SESSION['nm'])."/".base64_decode($_SESSION['un'])."/LABORATORY' target='_blank'><span><i class='icofont-ui-cart'></i> Stock Request</span></a></li>
