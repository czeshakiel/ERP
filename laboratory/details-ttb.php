<?php
  ...
  if(($adstatus=="Active")||($adstatus=="LOCKED")||($adstatus=="YELLOW TAG")){
    if($kst=="pending"){
      ...
      $uplogs="|LabUpdate|$patientname|Change status of $ipdesc to Test to be Done.|$caseno|$irefno|";
...
echo "
              <div class='card-body'>
                <div align='left' class='text-danger'><h4><i class='icofont-warning'></i> Error!!! Action blocked!!!Test status already set to Test To Be Done.</h4></div>
              </div>
";
