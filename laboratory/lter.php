...
echo "
            <option value='".$mtfetch['empid']."' $mts>".mb_strtoupper($mtfetch['name'])."-".$mtfetch['empid']."</option>
";
}
...
echo "
              <td class='b1 l1'><div align='center' style='padding: 5px 5px;'>
                ...
                <select name='result-$c-$zy' style='height: 30px;'>
...
echo "
              <td class='b1 l1'><div align='center' style='padding: 5px 5px;'>
                <input type='hidden' name='no-$c-$zy' value='$dno' />
                <input type='text' name='result-$c-$zy' style='height: 30px;' placeholder='Input Result' value='$resultn' required />
              </div></td>
";
    }
...
echo "
          ...
          <table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td>
                <select name='result-$b' style='height: 30px;width: 215px;font-size: 15px;' autofocus>
                  <option value=''></option>
";
...
echo "
          <input type='hidden' name='prf-$b' value='' />
          <input type='text' name='result-$b' style='height: 30px;width: 215px;font-size: 15px;' placeholder='Type Result' value='$setrs' autofocus />
";
    }
    else{
      if($type==3){
        $cbmn="";$cbsc="";
        if(stripos($setrs, " min.") !== FALSE){
          $rssp=preg_split("/\ min./",$setrs);
          $cbmn=trim($rssp[0]);

          if(stripos(trim($rssp[1]), " sec.") !== FALSE){
            $rssp2=preg_split("/\ sec./",trim($rssp[1]));
            $cbsc=trim($rssp2[0]);
          }
        }
...
echo "
          <input type='hidden' name='prf-$b' value='' />
          <label>
            <input type='number' name='result-$b' placeholder='Minutes' style='width: 130px;' value='$cbmn' autofocus /> Min.
          </label>
          <label>
            <input type='number' name='result2-$b' placeholder='Seconds' style='width: 130px;' value='$cbsc' autofocus /> Sec.
          </label>
";
      }
      else{
          ...
          <table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td style='padding-right: 5px;font-size: 15px;'>
                <select name='prf-$b' style='height: 30px;font-size: 15px;'>
              ...
              <td>
                <input type='text' name='result-$b' style='height: 30px;' placeholder='Input Result' value='$setrs' autofocus />
              </td>
            </tr>
          </table>
";
...
echo "
          <table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td>
                <input $intype name='result-$b' style='height: 30px;' placeholder='Input Result' value='$setrs' autofocus />
              </td>
            </tr>
          </table>
";
