...
$ax=0;
$axsql=mysqli_query($conn,"SELECT `code`, `description`, `lotno`, `unit`, `testcode`, `gtestcode` FROM `receiving` WHERE `unit`='LABORATORY' ORDER BY `itemname`");
...
echo "
                    <tr>
                      ...
                      <td><div align='center' style='font-size: 13px;'>$lotno</div></td>
