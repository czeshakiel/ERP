...
$zasql=mysqli_query($conn,"SELECT `patientidno`, `caseno`, `membership`, `hmo`, `room`, `street`, `barangay`, `municipality`, `province`, `initialdiagnosis`, `ap`, `dateadmitted`, `branch`, `employerno`, `ad`, `status` FROM `admission` WHERE `caseno`='$caseno'");
              ...
              <div class='card-body'>
                <table border='0' style='width: 100%;' align='center' cellpadding='0' cellspacing='0'>
                  ...
                  <tr>
                    ...
                    <td><div align='left' style='font-size: 14px;font-weight: bold;'>$datedischarged $timedischarged</div></td>
                  </tr>
                  <tr>
            ...
            <div class='card mb-3'>
              <div class='card-header'>
                <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr>
                    <td><div align='left'><h5 class='fw-bold'><i class='icofont-print me-2'></i> Print Lab Request Ticket</h5></div></td>
                  </tr>
                </table>
              </div>
              <div class='card-body'>
                <iframe src='../extra/Ticket/lab_ticket.php?caseno=$caseno&nursename=$nm&dept=laboratory' title='description' width='100%' height='600' style='border: none;'></iframe>
              </div>
            </div>
          </div>
        </div><!-- Row End -->
