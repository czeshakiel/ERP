...
if(isset($_SESSION['pw'])){$spw=$_SESSION['pw'];}else{$spw="";}
if(isset($_SESSION['nm'])){$snm=base64_decode($_SESSION['nm']);}else{$snm="";}
            ...
            <div class='card mb-3'>
              <div class='card-header'>
                <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr>
                    <td style='border-bottom: 1px solid #000000;padding-bottom: 5px;'><div align='left'><h5 class='fw-bold'><i class='icofont-ticket me-2'></i> Ticket</h5></div></td>
              ...
              <div class='card-body' style='padding-top: 0px;'>
                <iframe src='../../2021codes/Ticket/lab_ticket.php?caseno=$caseno&nursename=$snm&dept=LABORATORY' title='description' width='100%' height='500' style='border: none;'></iframe>
              </div>
            </div>
          </div>
        </div><!-- Row End -->
