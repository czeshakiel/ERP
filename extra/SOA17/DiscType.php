      ...
      <td><table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          ...
          <td><table bordercolor='#000000' bgcolor='#747474' border='1' cellpadding='0' cellspacing='0'>
            <tr>
              <form name='CSF' method='post' action='DiscTypeSave.php'>
              <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td height='30'><div align='left' class='arial12whitebold'>&nbsp;Discount Type&nbsp;</div></td>
                  <td height='30'><div align='center' class='arial12whitebold'>:</div></td>
                  <td height='30'><div align='left' class='arial13white'>
                    <input type='hidden' name='discounttype1' value='' />
                    &nbsp;<input type='checkbox' name='discounttype1' value='c' />PCSO<br />
                    <input type='hidden' name='discounttype2' value='' />
                    &nbsp;<input type='checkbox' name='discounttype2' value='c' />DSWD<br />
                    <input type='hidden' name='discounttype3' value='' />
                    &nbsp;<input type='checkbox' name='discounttype3' value='c' />DOH<br />
                    <input type='hidden' name='discounttype4' value='' />
                    &nbsp;<input type='checkbox' name='discounttype4' value='c' />HMO<br />
                    <input type='hidden' name='discounttype5' value='' />
                    &nbsp;<input type='checkbox' name='discounttype5' value='c' />Others<br />
                    &nbsp;<input type='text' name='discounttype5o' class='textfield08' value='' />
                  </div></td>
                </tr>
                <tr>
