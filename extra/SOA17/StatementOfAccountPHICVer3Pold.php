...
while($prfetch=mysqli_fetch_array($prsql)){
  ...
  $pratsql=mysqli_query($mycon1,"SELECT * FROM `productout` WHERE `caseno`='$caseno' AND `productdesc`='$prdoctor'");
  ...
  //Attending--------------------------------------------------------------------------------------
    $prcosql=mysqli_query($mycon1,"SELECT * FROM `productout` WHERE `caseno`='$caseno' AND `producttype`='IPD comanaged'");
  ...
  //Surgeon----------------------------------------------------------------------------------------
    $prcssql=mysqli_query($mycon1,"SELECT * FROM `productout` WHERE `caseno`='$caseno' AND `producttype`='IPD co-surgeon'");
  ...
  //Surgeon----------------------------------------------------------------------------------------
    $prcasql=mysqli_query($mycon1,"SELECT * FROM `productout` WHERE `caseno`='$caseno' AND `producttype`='IPD co-anesthesiologist'");
...
echo "
        <tr>
          ...
          <td><div align='right' class='times10black'>&nbsp;".$pragr."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;0.00&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".$praad."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".$prahm."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".$prap1."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".$prap2."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".$praex."&nbsp;</div></td>
        </tr>
";
}
...
//start-- sum of the total AR ... PF
          $totalAR_PF=0;
          $AR_PF_query=mysql_query("SELECT * FROM acctgenledge where caseno='$caseno' and acctitle like '%AR%' and acctitle like '%PF%' ");
                    while($AR_PF_fetch=mysql_fetch_array($AR_PF_query))
                            {
                             $acctitle=$AR_PF_fetch['acctitle'];
                             $amount=$AR_PF_fetch['amount'];
...
echo "
        ...
        <tr>
          ...
          <td><div align='right' class='times13blackbold'>&nbsp;".number_format(($tprp1+$phictot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times13blackbold'>&nbsp;".number_format(($tprp2+$phic1tot),2,'.',',')."&nbsp;</div></td>
