...
//load the account and collection less to patient bill
echo "  
          <tr>
                    ...
                    while($lessacctfetch=mysql_fetch_array($lessacct))
                            {
                             ...
                             $amount=$lessacctfetch['amount'];
                              ...
                              echo "<tr>
                                    <td align='left' class='times10black' colspan='7'>$acctitle</td>
                                    <td align='right' class='times10blackbold' >$amount</td>
                                    </tr>
                                    ";
