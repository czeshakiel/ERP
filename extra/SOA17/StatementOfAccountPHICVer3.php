...
echo "  
        ...
        ";
                       // $lessacct=mysql_query("SELECT * FROM acctgenledge where caseno='$caseno'");
                        $lessacct=mysql_query("SELECT * FROM acctgenledge where caseno='$caseno' and  acctitle like '%AR%' ");
                    while($lessacctfetch=mysql_fetch_array($lessacct))
                             ...
                             $date=$lessacctfetch['date'];
                              ...
                              echo "<tr>
                                    ...
                                    <table border='1' width='100%'>
                                    		<tr>
                                    			<td width='30%'>&nbsp; </td>
                                    			<td align='left'>$acctitle - $date </td>
                                    			<td >&nbsp;  </td>
                                    		</tr>
                                    </table>
                                    </td>
                       ...
                       // $lessacct=mysql_query("SELECT * FROM acctgenledge where caseno='$caseno'");
                        $lesscollect=mysql_query("SELECT * FROM collection where acctno='$caseno' and (accttitle='%PATIENTS DEPOSIT%' or accttitle='%PATIENTS DEPOSIT%') and type !='pending' ");
                    while($lesscollectfech=mysql_fetch_array($lesscollect))
                            {
                             ...
                             $ofr=$lesscollectfech['ofr'];
                              ...
                              echo "<tr>
                                    <td align='center' class='times10black' >$acctitle - $ofr</td>
                                    <td align='right' class='times10black' colspan='7'>".number_format($amount,2)."</td>
                                    </tr>
                                    ";
...
//start-- sum of the total Less (AR and Patient's Deposit)
          ...
          $total_PD=0;
          $PD_query=mysql_query("SELECT * FROM collection where acctno='$caseno' and (accttitle='%PATIENTS DEPOSIT%' or accttitle='%PATIENTS DEPOSIT%') and type !='pending' ");
