...
$poutsql=mysql_query("SELECT productsubtype FROM $db WHERE caseno='$caseno' AND quantity > 0 AND productsubtype NOT LIKE 'PROFESSIONAL FEE' AND trantype='charge' GROUP BY productsubtype ORDER BY productsubtype");
...
$poutdsql=mysql_query("SELECT sellingprice, quantity, adjustment, gross, hmo, phic, phic1, excess FROM $db WHERE caseno='$caseno' AND quantity > 0 AND trantype='charge' AND productsubtype='$pstype' AND administration NOT LIKE 'pending'");
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetailstest.php?caseno=$caseno&type=$pstype&db=$setdb' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;".$pstype."</div></a></td>
...
$poutdsql=mysql_query("SELECT sellingprice, quantity, adjustment, gross, hmo, phic, phic1, excess FROM $db WHERE caseno='$caseno' AND trantype='charge' AND productsubtype='ECG'");
...
//$jklsql=mysql_query("SELECT * FROM $db WHERE caseno='$caseno' AND trantype='charge' AND productsubtype='LABORATORY'");
//$jklcount=mysql_num_rows($jklsql);

//if($jklcount==0){
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetailstest.php?caseno=$caseno&type=$pstype&db=$setdb' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;ECG</div></a></td>
...
$poutdsql=mysql_query("SELECT sellingprice, quantity, adjustment, gross, hmo, phic, phic1, excess FROM $db WHERE caseno='$caseno' AND trantype='charge' AND productsubtype='LABORATORY'");
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetailstest.php?caseno=$caseno&type=$pstype&db=$setdb' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;LABORATORY</div></a></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format($actual,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(0,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format($poutdadjtot,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format($hmo,2,'.',',')."&nbsp;</div></td>
...
$poutdsql=mysql_query("SELECT sellingprice, quantity, adjustment, gross, hmo, phic, phic1, excess FROM $db WHERE caseno='$caseno' AND trantype='charge' AND productsubtype='OTHER FEES'");
...
echo "
        <!-- tr>
          <td><a href='../../2020codes/TestCodes/testviewdetailstest.php?caseno=$caseno&type=$pstype&db=$setdb' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;OTHER FEES</div></a></td>
...
//MISC
else if(($pstype=='ADMISSION FEE')||($pstype=="ER FEE")||($pstype=="GENERAL SUPPLIES")||($pstype=="MEDICAL EQUIPMENT")||($pstype=="MISCELLANEOUS")||($pstype=="OR-CHARGES")||($pstype=="OR/DR SUPPLIES")||($pstype=="OR/DR/ER FEE")||($pstype=='ADMITTING FEE')||($pstype=='MISCELLANEOUS CR')||($pstype=='NURSING CHARGES')||($pstype=='NURSING SERVICE FEE')||($pstype=='NURSING_CHARGES')){
$poutdsql=mysql_query("SELECT sellingprice, quantity, adjustment, gross, hmo, phic, phic1, excess FROM $db WHERE caseno='$caseno' AND trantype='charge' AND quantity > 0 AND productsubtype='$pstype'");
...
$poutdsql=mysql_query("SELECT sellingprice, quantity, adjustment, gross, hmo, phic, phic1, excess FROM $db WHERE caseno='$caseno' AND quantity > 0 AND trantype='charge' AND productsubtype='$pstype'");
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetailstest.php?caseno=$caseno&type=MEDICAL SUPPLIES' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;MEDICAL SUPPLIES</div></a></td>
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetailstest.php?caseno=$caseno&type=MISCELLANEOUS' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;MISCELLANEOUS</div></a></td>
...
$b=0;
$popfsql=mysql_query("SELECT productdesc, producttype FROM $db WHERE caseno='$caseno' AND trantype='charge' AND (producttype='IPD attending' OR producttype='IPD surgeon' OR producttype='IPD anesthesiologist') AND productsubtype='PROFESSIONAL FEE' GROUP BY productdesc");
...
$asapfsql=mysql_query("SELECT SUM(sellingprice*quantity) AS gross, SUM(adjustment) AS discount, SUM(phic) AS p1, SUM(phic1) AS p2, SUM(hmo) AS hmo, SUM(excess) AS exc FROM $db WHERE caseno='$caseno' AND productdesc='$doctor' AND trantype='charge' AND productsubtype='PROFESSIONAL FEE'");
...
//Start Other Doctors
$otdsql=mysql_query("SELECT (sellingprice*quantity) AS gross, adjustment AS discount, phic AS p1, phic1 AS p2, hmo AS hmo, excess AS exc FROM $db WHERE caseno='$caseno' AND productdesc NOT LIKE '$doctor' AND trantype='charge' AND producttype NOT LIKE 'IPD attending' AND producttype NOT LIKE 'IPD surgeon' AND producttype NOT LIKE 'IPD anesthesiologist' AND producttype NOT LIKE 'IPD admitting' AND productsubtype='PROFESSIONAL FEE'");
...
//Start Surgeon
$kssql=mysql_query("SELECT productdesc FROM $db WHERE caseno='$caseno' AND trantype='charge' AND producttype='IPD surgeon' AND productsubtype='PROFESSIONAL FEE'");
$kscount=mysql_num_rows($kssql);
if($kscount!=0){
$ksfetch=mysql_fetch_array($kssql);
$surgeon=$ksfetch['productdesc'];

$sdsql=mysql_query("SELECT (sellingprice*quantity) AS gross, adjustment AS discount, phic AS p1, phic1 AS p2, hmo AS hmo, excess AS exc FROM $db WHERE caseno='$caseno' AND productdesc='$surgeon' AND trantype='charge' AND producttype NOT LIKE 'IPD surgeon' AND productsubtype='PROFESSIONAL FEE'");
...
$kasql=mysql_query("SELECT productdesc FROM $db WHERE caseno='$caseno' AND trantype='charge' AND producttype='IPD anesthesiologist' AND productsubtype='PROFESSIONAL FEE'");
$kacount=mysql_num_rows($kasql);
if($kacount!=0){
$kafetch=mysql_fetch_array($kasql);
$anes=$kafetch['productdesc'];

$adsql=mysql_query("SELECT (sellingprice*quantity) AS gross, adjustment AS discount, phic AS p1, phic1 AS p2, hmo AS hmo, excess AS exc FROM $db WHERE caseno='$caseno' AND productdesc='$anes' AND trantype='charge' AND producttype NOT LIKE 'IPD anesthesiologist' AND productsubtype='PROFESSIONAL FEE'");
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetailstest.php?caseno=$caseno&type=PROFESSIONAL FEE' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;$b.&nbsp;".strtoupper($doctor)."</div></a></td>
...
$pensql=mysql_query("SELECT sellingprice, quantity, adjustment, gross, hmo, phic, phic1, excess FROM $db WHERE caseno='$caseno' AND quantity > 0 AND trantype='charge' AND (productsubtype='PHARMACY/MEDICINE' OR productsubtype='PHARMACY/SUPPLIES') AND administration LIKE 'pending'");
