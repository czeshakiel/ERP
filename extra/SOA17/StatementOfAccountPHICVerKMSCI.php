        ...
        <tr>
          ...
          <td width='52%'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='20' class='table1Bottom'><div align='left' class='times12black'>&nbsp;$agerel&nbsp;</div></td>
            </tr>
          </table></td>
          <td width='42%'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              ...
              <td width='auto' class='table1Bottom'><div align='left' class='times12black'>&nbsp;".date("M-d-Y h:i:s a")."&nbsp;</div></td>
            </tr>
			</td></tr>
			<tr><td>
			<tr>
              ...
              <td width='auto' class='table1Bottom'><div align='left' class='times12black'>&nbsp;".date("M d, Y",strtotime($dateadmit))." ".$timeadmittedrel."&nbsp;</div></td>
            </tr>
			</td></tr>
          </table></td>
          <td width='4%'></td>
        ...
        <tr>
          ...
          <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='auto' class='table1Bottom'><div align='left' class='times12black'>&nbsp;$street $barangay $municipality $province&nbsp;</div></td>
            </tr>
          </table></td>
          <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='auto' class='table1Bottom'><a href='TempDateDis.php?caseno=$caseno' target='_blank' class='astyle'><div align='left' class='times12black'>
";
            ...
            <tr>
              <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  ...
                  <td width='auto' class='table1Bottom'><div align='left' class='times12black'>&nbsp;$finaldiagnosis&nbsp;</div></td>
                </tr>
              </table></td>
            <tr>
            <tr>
                  ...
                  <td width='auto' class='table1Bottom' valign='middle'><a href='AddDetails.php?caseno=$caseno&type=1' class='astyle' target='_blank'><div align='left'>
                    <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                      <tr>
                        ...
                        <td width='auto'><div align='left' class='times12black'>$c1disp&nbsp;</div></td>
                      <tr>
                    </table>
                  </div></a></td>
                </tr>
...
echo "
                <tr>
                  ...
                  <td width='auto' class='table1Bottom' valign='middle'><a href='AddDetails.php?caseno=$caseno&type=2' class='astyle' target='_blank'><div align='left'>
                    <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                      <tr>
                        <td width='45' valign='middle'><div align='left' class='times12blackbold'>&nbsp;$secicdcode</div></td>
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetails.php?caseno=$caseno&type=$pstype' target='_blank' class='astyle'><div align='left' class='times11blackbold'>&nbsp;".$pstype."</div></a></td>
          <td><div align='right' class='times12black'>&nbsp;".number_format($actual,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times12black'>&nbsp;".number_format(0,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times12black'>&nbsp;".number_format($poutdadjtot,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times12black'>&nbsp;".number_format($hmo,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times12black'>&nbsp;".number_format($phic,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times12black'>&nbsp;".number_format($phic1,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times12black'>&nbsp;".number_format($excess,2,'.',',')."&nbsp;</div></td>
        </tr>
";
}
