...
$tap=mysql_real_escape_string($_POST['tap']);
...
if($tdscount!=0){
mysql_query("UPDATE tempdatestorage SET date='$date', time='$time' WHERE caseno='$caseno'");
}
else{
mysql_query("INSERT INTO `tempdatestorage` (`caseno`, `date`, `time`) VALUES ('$caseno', '$date', '$time')");
}
...
echo "<META HTTP-EQUIV='Refresh'CONTENT='0;URL=TempDateDis.php?caseno=$caseno'>";
?>
</body>
</html>
