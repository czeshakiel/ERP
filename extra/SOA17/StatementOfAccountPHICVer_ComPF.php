...
if(($adstatus=="MGH")||($adstatus=="discharged")||($adstatus=="TRANSFERRED") ||($adstatus=="ABSCONDED") ||($adstatus=="DAMA") ||($adstatus=="HAMA")){
}
else{
echo "
    <tr>
...
//MISC
else if(($pstype=='ADMISSION FEE')||($pstype=="ER FEE")||($pstype=="GENERAL SUPPLIES")||($pstype=="MEDICAL EQUIPMENT")||($pstype=="MISCELLANEOUS")||($pstype=="OR-CHARGES")||($pstype=="OR/DR SUPPLIES")||($pstype=="OR/DR/ER FEE")||($pstype=='ADMITTING FEE')||($pstype=='MISCELLANEOUS CR')||($pstype=='MISCELLANEOUS-L')||($pstype=='NURSING CHARGES')||($pstype=='NURSING SERVICE FEE')||($pstype=='NURSING_CHARGES')||($pstype=='LINENS')||($pstype=='LAUNDRY SUPPLIES') ||($pstype=='OTHER INCOME')){
...
if($prptype!="ON CALL"){
$logall2="$logdoc<->".$pragr."<->".$praad."<->".$prahm."<->".$prap1."<->".$prap2."<->".$praex."<->|";
...
if(number_format($tprp1,2)!=number_format($fcpshare,2)){
  $stpbgp1="#FF0000";
}

if(number_format($tprp2,2)!=number_format($secpshare,2)){
  $stpbgp2="#FF0000";
}
...
echo "
        <tr>
          ...
          <td bgcolor='$stpbgp1'><div align='right' class='times13blackbold'>&nbsp;".number_format($tprp1,2,'.',',')."&nbsp;</div></td>
          <td bgcolor='$stpbgp2'><div align='right' class='times13blackbold'>&nbsp;".number_format($tprp2,2,'.',',')."&nbsp;</div></td>
...
//$lessacct=mysql_query("SELECT type as status,accttitle as acctitle,sum(amount) as amount,datearray,refno,ofr FROM collection where acctno='$caseno' and accttitle like '%AR %' group by ofr");
