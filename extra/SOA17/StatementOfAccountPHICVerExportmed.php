...
?>
<!--button id="create_pdf">Generate PDF</button><button onclick="tableToExcel('printThis','Detailed_Report')" class="btn btn-success">EXPORT</button-->
<br>
<br>
<form class="form">
<?php
echo "
<div align='center' id='printThis' contentEditable='true'>
...
//MISC
else if(($pstype=="GENERAL SUPPLIES")||($pstype=="MEDICAL EQUIPMENT")||($pstype=="MISCELLANEOUS")||($pstype=="OR-CHARGES")||($pstype=="OR/DR SUPPLIES")||($pstype=="OR/DR/ER FEE")||($pstype=='ADMITTING FEE')||($pstype=='MISCELLANEOUS CR')||($pstype=='NURSING CHARGES')||($pstype=='NURSING SERVICE FEE')||($pstype=='NURSING_CHARGES')||($pstype=='LINENS')||($pstype=='LAUNDRY SUPPLIES') ||($pstype=='OTHER INCOME')){
...
$admittotactual+=$actual;
$admitadjsubtot+=$poutdadjtot;
$admitgrosssubtot+=$poutdgrosstot;
$admithmotot+=$hmo;
$admitphictot+=$phic;
$admitphic1tot+=$phic1;
$admitexcesstot+=$excess;
...
$ertotactual+=$actual;
$eradjsubtot+=$poutdadjtot;
$ergrosssubtot+=$poutdgrosstot;
$erhmotot+=$hmo;
$erphictot+=$phic;
$erphic1tot+=$phic1;
$erexcesstot+=$excess;
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetails.php?caseno=$caseno&type=ADMISSION FEE' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;ADMISSION FEE</div></a></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($admittotactual),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(0,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($admitadjsubtot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($admithmotot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($admitphictot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($admitphic1tot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($admitexcesstot),2,'.',',')."&nbsp;</div></td>
        </tr>
";
}
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetails.php?caseno=$caseno&type=ER FEE' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;ER FEE</div></a></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($ertotactual),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(0,2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($eradjsubtot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($erhmotot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($erphictot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($erphic1tot),2,'.',',')."&nbsp;</div></td>
          <td><div align='right' class='times10black'>&nbsp;".number_format(($erexcesstot),2,'.',',')."&nbsp;</div></td>
        </tr>
";
}
...
$b=0;
$popfsql=mysql_query("SELECT productdesc, producttype FROM productout WHERE caseno='$caseno' AND trantype='charge' AND (producttype='IPD attending' OR producttype='IPD surgeon' OR producttype='IPD anesthesiologist') AND productsubtype='PROFESSIONAL FEE' GROUP BY productdesc");
...
echo "
        <tr>
          <td><a href='../../2020codes/TestCodes/testviewdetails.php?caseno=$caseno&type=PROFESSIONAL FEE' target='_blank' class='astyle'><div align='left' class='times10blackbold'>&nbsp;$b.&nbsp;DR. ".strtoupper($doctor)."</div></a></td>
...
echo "
        ...
        //                       }
                             $lessacct=mysql_query("SELECT type as status,accttitle as acctitle,sum(amount) as amount,datearray,refno,ofr FROM collection where acctno='$caseno'  and accttitle like '%AR %'   group by SUBSTRING_INDEX(accttitle, ' ', 2)");
...
<tr>
              ...
              <td align='right' class='times10black' colspan='7'>&nbsp;</td>
              </tr>
              ";
              echo "
      <tr>
