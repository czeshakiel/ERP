...
$b=0;
$popfsql=mysql_query("SELECT productdesc, producttype FROM productout WHERE caseno='$caseno' AND trantype='charge' AND productsubtype='PROFESSIONAL FEE' GROUP BY productdesc ORDER BY FIELD(`producttype`, 'IPD attending', 'IPD surgeon', 'IPD anesthesiologist', 'ON CALL')");
