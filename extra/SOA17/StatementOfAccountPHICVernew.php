...
echo "
   ...
   $lesscollect=mysql_query("SELECT accttitle,amount,ofr,date FROM collection where acctno='$caseno'  and (accttitle='PATIENTS DEPOSIT' or accttitle='CASHONHAND' or accttitle='PROFESSIONAL FEE' or accttitle='AR TRADE' or accttitle='AR TRADE PF') and type !='pending'");
                    while($lesscollectfech=mysql_fetch_array($lesscollect))
                            {
                             $acctitle=$lesscollectfech['accttitle'];
                             $amount=$lesscollectfech['amount'];
...
//start-- sum of the total Less (AR and Patient's Deposit)
          ...
          $total_PD=0;
          $PD_query=mysql_query("SELECT * FROM collection where acctno='$caseno' and (accttitle='PATIENTS DEPOSIT' or accttitle='CASHONHAND' or accttitle='PROFESSIONAL FEE' or accttitle='AR TRADE' or accttitle='AR TRADE PF') and type !='pending' ");
