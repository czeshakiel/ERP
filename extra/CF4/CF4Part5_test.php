...
xmlhttp.open("GET","CF4Part5SearchResult.php?caseno='.$caseno.'&source='.$source.'&searchme="+document.searchme.searchme.value,true);
xmlhttp.send();
}
...
mysql_select_db("cf4");
$asql=mysql_query("SELECT * FROM subjective WHERE caseno='$caseno'");
$acount=mysql_num_rows($asql);
if($acount!=0){
while($afetch=mysql_fetch_array($asql)){$pOtherComplaint=$afetch["pOtherComplaint"];$pSignsSymptoms=$afetch["pSignsSymptoms"];$pPainSite=$afetch["pPainSite"];}
}
else{
...
if(empty($_GET["aa"])){$aa="";}
else{$aa=mysql_real_escape_string($_GET["aa"]);}

mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("kmsci");
$aasql=mysql_query("SELECT drugdesc FROM phicmedicine WHERE drugcode='$aa'");

$aacount=mysql_num_rows($aasql);
if($aacount==0){
$drugdesc="";
}
else{
while($aafetch=mysql_fetch_array($aasql)){$drugdesc=$aafetch['drugdesc'];}
}

//bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
if(empty($_GET["bb"])){$bb="";}
else{$bb=mysql_real_escape_string($_GET["bb"]);}

mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("kmsci");
$bbsql=mysql_query("SELECT gendesc FROM phicmedsgeneric WHERE gencode='$bb'");

$bbcount=mysql_num_rows($bbsql);
if($bbcount==0){
$gendesc="";
}
else{
while($bbfetch=mysql_fetch_array($bbsql)){$gendesc=$bbfetch['gendesc'];}
}

//ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
if(empty($_GET["cc"])){$cc="";}
else{$cc=mysql_real_escape_string($_GET["cc"]);}

mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("kmsci");
$ccsql=mysql_query("SELECT saltdesc FROM phicmedssalt WHERE saltcode='$cc'");

$cccount=mysql_num_rows($ccsql);
if($cccount==0){
$saltdesc="";
}
else{
while($ccfetch=mysql_fetch_array($ccsql)){$saltdesc=$ccfetch['saltdesc'];}
}

//ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
if(empty($_GET["dd"])){$dd="";}
else{$dd=mysql_real_escape_string($_GET["dd"]);}

mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("kmsci");
$ddsql=mysql_query("SELECT strengthdesc FROM phicmedsstrength WHERE strengthcode='$dd'");
...
while($ddfetch=mysql_fetch_array($ddsql)){$strengthdesc=$ddfetch['strengthdesc'];}
}

//eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
if(empty($_GET["ee"])){$ee="";}
else{$ee=mysql_real_escape_string($_GET["ee"]);}

mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("kmsci");
$eesql=mysql_query("SELECT formdesc FROM phicmedsform WHERE formcode='$ee'");

$eecount=mysql_num_rows($eesql);
if($eecount==0){
$formdesc="";
}
else{
while($eefetch=mysql_fetch_array($eesql)){$formdesc=$eefetch['formdesc'];}
}

//fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
if(empty($_GET["ff"])){$ff="";}
else{$ff=mysql_real_escape_string($_GET["ff"]);}

mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("kmsci");
$ffsql=mysql_query("SELECT unitdesc FROM phicmedsunit WHERE unitcode='$ff'");

$ffcount=mysql_num_rows($ffsql);
if($ffcount==0){
$unitdesc="";
}
else{
while($fffetch=mysql_fetch_array($ffsql)){$unitdesc=$fffetch['unitdesc'];}
}

//ggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg
if(empty($_GET["gg"])){$gg="";}
else{$gg=mysql_real_escape_string($_GET["gg"]);}

mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("kmsci");
$ggsql=mysql_query("SELECT packagedesc FROM phicmedspackage WHERE packagecode='$gg'");

$ggcount=mysql_num_rows($ggsql);
if($ggcount==0){
$packagedesc="";
}
else{
while($ggfetch=mysql_fetch_array($ggsql)){$packagedesc=$ggfetch['packagedesc'];}
}
...
<table style='width:100%;'>
  <tr>
    <td width='10'></td>
    <td>
    <a href='CF4Part5_test.php?caseno=$caseno&source=$source' style='text-decoration: none;'><div class='alert alert-success' style='margin-bottom: 0px'>
        ...
        <td>
          ...
          <table style='margin-top: 15px; text-align: left;'>
            <tbody>
              ...
              <tr>
                <td>
                  <input type='text' name='pRoute' id='pRoute' class='form-control' value='' style='width: 220px; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' maxlength='500' />
                </td>

                <td>
                  <input type='text' name='pFrequencyInstruction' id='pFrequencyInstruction' class='form-control' value='' style='width: 220px; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' maxlength='500' />
                </td>
              </tr>
            </tbody>
          </table>
          <table style='margin-top: 15px; text-align: left;'>
            ...
            <tr>
              <td>
                <input type='text' name='pQuantity' id='pQuantity' class='form-control' value='' style='width: 80px; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' autocomplete='off' maxlength='5' onkeypress='return isNumberKey(event);' />
              </td>
              <td>
                <input type='text' name='pTotalPrice' id='pTotalPrice' class='form-control' value='' style='width: 150px; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' autocomplete='off' maxlength='15' onkeypress='return isNumberWithDecimalKey(event);' />
              </td>
            </tr>
          </table>
        </td>
...
if((stripos($caseno, "I-") !== FALSE)||(stripos($caseno, "O-") !== FALSE)){
  ...
  $medisql=mysql_query("SELECT productdesc, productcode, SUM(quantity) AS quantity, sellingprice FROM productout WHERE caseno='$caseno' AND trantype='charge' AND quantity > 0 AND gross > 0 GROUP BY productcode");
  while($medifetch=mysql_fetch_array($medisql)){
  ...
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("kmsci");
  $mtsql=mysql_query("SELECT * FROM medtranslator WHERE code='$productcode'");
  $mtcount=mysql_num_rows($mtsql);

  $sroute="";
  $sfreq="";
  $paisql=mysql_query("SELECT route, frequency FROM productoutaddinfo WHERE caseno='$caseno' AND code='$productcode'");
  $paifetch=mysql_fetch_array($paisql);
  ...
  $ifpre=0;
  if($mtcount!=0){
  while($dcfetch=mysql_fetch_array($mtsql)){$dc=$dcfetch['drugcode'];}

  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("cf4");
  $fpsql=mysql_query("SELECT * FROM medicine WHERE pDrugCode='$dc' AND caseno='$caseno'");
  $fpcount=mysql_num_rows($fpsql);
  ...
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("cf4");
  $fpsql=mysql_query("SELECT * FROM medicine WHERE pGenericName='$productdesc' AND caseno='$caseno'");
  $fpcount=mysql_num_rows($fpsql);
  ...
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("kmsci");
  $agsql=mysql_query("SELECT * FROM phicmedicine WHERE drugcode='$aaa'");
  while($agfetch=mysql_fetch_array($agsql)){
  ...
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("kmsci");
  $bbbsql=mysql_query("SELECT gendesc FROM phicmedsgeneric WHERE gencode='$bbb'");
  while($bbbfetch=mysql_fetch_array($bbbsql)){$gendescauto=$bbbfetch['gendesc'];}

  //ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("kmsci");
  $cccsql=mysql_query("SELECT saltdesc FROM phicmedssalt WHERE saltcode='$ccc'");
  while($cccfetch=mysql_fetch_array($cccsql)){$saltdescauto=$cccfetch['saltdesc'];}

  //ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("kmsci");
  $dddsql=mysql_query("SELECT strengthdesc FROM phicmedsstrength WHERE strengthcode='$ddd'");
  while($dddfetch=mysql_fetch_array($dddsql)){$strengthdescauto=$dddfetch['strengthdesc'];}

  //eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("kmsci");
  $eeesql=mysql_query("SELECT formdesc FROM phicmedsform WHERE formcode='$eee'");
  while($eeefetch=mysql_fetch_array($eeesql)){$formdescauto=$eeefetch['formdesc'];}

  //fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("kmsci");
  $fffsql=mysql_query("SELECT unitdesc FROM phicmedsunit WHERE unitcode='$fff'");
  while($ffffetch=mysql_fetch_array($fffsql)){$unitdescauto=$ffffetch['unitdesc'];}

  //ggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg
  mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
  mysql_select_db("kmsci");
  $gggsql=mysql_query("SELECT packagedesc FROM phicmedspackage WHERE packagecode='$ggg'");
  while($gggfetch=mysql_fetch_array($gggsql)){$packagedescauto=$gggfetch['packagedesc'];}
...
if($mtcount==0){
echo "
                      <td><a href='../2019codes/CF4Meds/MedSearchGen.php?Assign=Assign+Code&code=$productcode' target='_blank' style='text-decoration: none;'><div align='center' style='color: red;'>&nbsp;Add Proper Generic Name&nbsp;</div></a></td>
";
}
...
//AUTO MEDS------------------------------------------------------------------------------------------------------------------------------------------
mysql_connect("192.168.0.135","eclaims","eclaims");
mysql_select_db("cf4_meds");
$medisql=mysql_query("SELECT medicine_items.bestellnum, medicine_items.quantity, medicine_items.price_charge, medicines.description FROM medicine_items, medicines WHERE medicine_items.encounter_nr='$caseno' AND medicine_items.bestellnum=medicines.bestellnum");
while($medifetch=mysql_fetch_array($medisql)){
$productcode=$medifetch['bestellnum'];
$productdesc=strtoupper($medifetch['description']);
$qty=$medifetch['quantity'];
$ramt=$medifetch['price_charge'];
$tamt=$ramt*$qty;
...
echo "
          <table style='margin-top: 15px; text-align: left;'>
            <tbody>
              ...
              <tr>
                <td>
                  <input type='text' name='pGenericFreeText' id='pGenericFreeText' class='form-control' value='$generic' style='width: 100%; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' autocomplete='off' maxlength='500' />
                </td>
              </tr>
            </tbody>
          </table>
...
mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("cf4");
$bsql=mysql_query("SELECT * FROM medicine WHERE caseno='$caseno'");
...
mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("kmsci");
$aaasql=mysql_query("SELECT drugdesc FROM phicmedicine WHERE drugcode='$pDrugCode'");
while($aaafetch=mysql_fetch_array($aaasql)){$desc=$aaafetch['drugdesc'];}
}
...
echo "
        <tr>
          ...
          <td width='100'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td><a href='CF4Part5Edit.php?caseno=$caseno&source=$source&count=$b' class='astyle'><img src='Resources/Button/Edit-S-Out.png' alt='Edit' width='auto' height='35' id='Image1$b' onmouseover=MM_swapImage('Image1$b','','Resources/Button/Edit-S-Over.png',0) onmouseout=MM_swapImgRestore() /></a></td>
              <td width='3'></td>
...
if($source==1){
echo "
  <form name='CF4Finalize' method='get' action='CF4Finalize_test.php'>
  <tr>
    <td></td>
...
mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db("cf4");
$zsql=mysql_query("SELECT pHciCaseNo, pHciTransNo FROM enlistment WHERE caseno='$caseno'");
$zcount=mysql_num_rows($zsql);

if($zcount!=0){
echo "
        <td height='60'><a href='CF4Part4.php?caseno=$caseno&source=$source' class='astyle'><div align='right'><input type='button' class='btn btn-primary' name='CF4 Part 4' value='CF4 Part 4' title='CF4 Part 4' style='margin: 10px 0px 0px 0px;' /></div></td>
        <td width='3'></td>
";
}

echo "
        <td height='60'><a href='CF4Part3.php?caseno=$caseno&source=$source' class='astyle'><div align='right'><input type='button' class='btn btn-primary' name='CF4 Part 3' value='CF4 Part 3' title='CF4 Part 3' style='margin: 10px 0px 0px 0px;' /></div></td>
        <td width='3'></td>
        <td height='60'><a href='CF4Part2.php?caseno=$caseno&source=$source' class='astyle'><div align='right'><input type='button' class='btn btn-primary' name='CF4 Part 2' value='CF4 Part 2' title='CF4 Part 2' style='margin: 10px 0px 0px 0px;' /></div></td>
        <td width='3'></td>
        <td height='60'><a href='CF4Part1.php?caseno=$caseno&source=$source' class='astyle'><div align='right'><input type='button' class='btn btn-primary' name='CF4 Part 1' value='CF4 Part 1' title='CF4 Part 1' style='margin: 10px 0px 0px 0px;' /></div></td>
        <td width='20'></td>
...
$acount=mysql_num_rows($asql);echo $acount."asfdgashfgasgfyjsafg";
