...
if($txtWardDocAction!=""){
  ...
  mysqli_query($conncf4,"INSERT INTO `courseward` (`pHciCaseNo`, `pHciTransNo`, `pDateAction`, `pDoctorsAction`, `pReportStatus`, `pDeficiencyRemarks`, `caseno`) VALUES ('$pHciCaseNo', '$pHciTransNo', '$txtWardDateOrder', '$txtWardDocAction', 'U', '', '$caseno')");

echo "
  <span class='arial16bluebold'>Entries saved...</span>
";

echo "<META HTTP-EQUIV='Refresh'CONTENT='0;URL=?cf4p4&caseno=$caseno'>";
}
else{
echo "
  <span class='arial16redbold'>Cannot be blank! Try again!!!</span>
";
