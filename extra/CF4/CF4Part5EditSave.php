...
mysqli_query($mycon5,"UPDATE `medicine` SET `pGenericName`='$pGenericFreeText', `pRoute`='$pRoute', `pQuantity`='$pQuantity', `pTotalAmtPrice`='$pTotalPrice', `pInstructionFrequency`='$pFrequencyInstruction' WHERE `no`='$no'");
  ...
  <tr>
    <td><div align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <td><div align='center' class='arial16greenbold'>Changes saved!!!</div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<table style='height:100%;width:100%; position: absolute; top: 0; bottom: 0; left: 0; right: 0;' border='0' cellpadding='0' cellspacing='0'>
  <tr>
    <td><div align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <td><div align='center' class='arial16redbold'>Cannot be blank! Try again!!!</div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
echo "<META HTTP-EQUIV='Refresh'CONTENT='1;URL=CF4Part5.php?caseno=$caseno&source=$source'>";
}
