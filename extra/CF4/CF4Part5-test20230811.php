        ...
        <td>
          ...
          <table style='margin-top: 15px; text-align: left;'>
            <tbody>
              ...
              <tr>
                <td>
                  <input type='text' name='pGenericFreeText' id='pGenericFreeText' class='form-control' value='' style='width: 100%; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' autocomplete='off' maxlength='500' placeholder='Generic Name/Salt/Strength/Form/Unit/Package' />
                </td>
              </tr>
            </tbody>
          </table>
          <table style='margin-top: 15px; text-align: left;'>
            <tbody>
              ...
              <tr>
                <td>
                  <input type='text' name='pRoute' id='pRoute' class='form-control' value='$nomedroute' style='width: 220px; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' maxlength='500' placeholder='Route' />
                </td>
                <td>
                  <input type='text' name='pFrequencyInstruction' id='pFrequencyInstruction' class='form-control' value='$nomedfreq' style='width: 220px; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' maxlength='500' placeholder='Frequency' />
                </td>
              </tr>
            </tbody>
          </table>
          <table style='margin-top: 15px; text-align: left;'>
            ...
            <tr>
              <td>
                <input type='number' name='pQuantity' id='pQuantity' class='form-control' value='$nomedqty' style='width: 80px; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' autocomplete='off' maxlength='5' placeholder='Qty.' />
              </td>
              <td>
                <input type='number' step='0.01' name='pTotalPrice' id='pTotalPrice' class='form-control' value='$nomedtot' style='width: 150px; color: #000; margin: 0px 10px 0px 0px; text-transform: uppercase' autocomplete='off' maxlength='15' placeholder='Total Amount' />
              </td>
            </tr>
          </table>
        </td>
...
if((stripos($caseno, "RC-") !== FALSE)||(stripos($caseno, "I-") !== FALSE)||(stripos($caseno, "O-") !== FALSE)){
  //AUTO MEDS----------------------------------------------------------------------------------------------------------------------------------------
  include("CF4Part5-AutoMeds.php");
  //END AUTO MEDS------------------------------------------------------------------------------------------------------------------------------------

  //AUTO MEDS NO GENERIC-----------------------------------------------------------------------------------------------------------------------------
  include("CF4Part5-AutoMeds-NG.php");
  //END AUTO MEDS NO GENERIC-------------------------------------------------------------------------------------------------------------------------
...
echo "
        <tr>
          ...
          <form name='CF4Part5Remove' method='post' id='RemoveCF4' action='CF4Part5Remove-test20230811.php' ";?> onsubmit="return confirm('Are you sure you want to remove this entry?');" <?php echo ">
          ...
          <input type='hidden' name='caseno' value='$caseno' />
          <input type='hidden' name='source' value='$source' />
          <input type='hidden' name='pDrugCode' value='$pDrugCode' />
...
echo "
  ...
  <tr>
    <td></td>
    <td><div align='right'><table border='0' width='100%' cellpadding='0' cellspacing='0'>
      <tr>
        <td><div align='left'><table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            <td height='60'><a href='CF4Part5Zero.php?caseno=$caseno&source=$source' class='astyle'><div align='right'><input type='button' class='btn btn-warning' name='CF4 Part 5' value='Reload Meds' title='Reload Meds' style='margin: 10px 0px 0px 0px;' /></div></td>
          </tr>
        </table></div></td>
        <td><div align='right'><table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            <td height='60'><a href='../MedMatrixeClaims/3/CF4/?caseno=$caseno' class='astyle' target='_blank'><div align='right'><input type='button' class='btn btn-primary' value='PRINTABLE CF4' title='PRINTABLE CF4' style='margin: 10px 0px 0px 0px;' /></div></td>
            <td width='3'></td>
";
