...
<div align='center'>
  <table style='height:100%;width:94%; position: absolute; top: 0; bottom: 0; left: 3%; right: 3%;' border='0' bordercolor='#000000' cellpadding='0' cellspacing='0' bgcolor='#FFFFFF'>
    <tr>
...
$asql=mysqli_query($mycon1,"SELECT `patientidno` FROM `admission` WHERE `caseno`='$caseno'");
$afetch=mysqli_fetch_array($asql);
$patientidno=$afetch['patientidno'];

echo "<META HTTP-EQUIV='Refresh'CONTENT='0;URL=DataEntryeClaimsReloadReal.php?caseno=$caseno&patientidno=$patientidno&uname=$username'>";
//header("location: DataEntryeClaimsReal.php?caseno=$caseno&patientidno=$patientidno");
?>
</body>
</html>
