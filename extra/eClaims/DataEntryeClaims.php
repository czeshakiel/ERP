...
$username=mysqli_real_escape_string($mycon1,$_GET['username']);

echo "<META HTTP-EQUIV='Refresh'CONTENT='0;URL=DataEntryeClaimsReal.php?caseno=$caseno&patientidno=$patientidno&uname=$username'>";
