...
$patfsql=mysqli_query($mycon1,"SELECT UPPER(lastname) AS lastname, UPPER(firstname) AS firstname, UPPER(middlename) AS middlename, birthdate, age, UPPER(sex) AS sex, suffix, birthdate, dateofbirth FROM patientprofile WHERE patientidno='$patientidno'");
...
$pGuId=$pemiscfetch['pGuId'];
  ...
  mysqli_query($mycon5,"INSERT INTO `pemisc` (`caseno`, `pSkinId`, `pHeentId`, `pChestId`, `pHeartId`, `pAbdomenId`, `pNeuroId`, `pRectalId`, `pGuId`, `pReportStatus`) VALUES('$erthcaseno', '$pSkinId', '$pHeentId', '$pChestId', '$pHeartId', '$pAbdomenId', '$pNeuroId', '$pRectalId', '$pGuId', 'U')");
}
...
$pDoctorsAction=str_replace(":","",$pDoctorsAction);
  ...
  mysqli_query($mycon5,"INSERT INTO `courseward` (`caseno`, `pHciCaseNo`, `pHciTransNo`, `pDateAction`, `pDoctorsAction`, `pReportStatus`) VALUES('$erthcaseno', '$pHciCaseNo', '$pHciTransNo', '$pDateAction', '$pDoctorsAction', 'U')");
}
...
$pIllnessHistory=str_replace("  "," ",$pIllnessHistory);
  ...
  mysqli_query($mycon5,"INSERT INTO `subjective` (`caseno`, `pChiefComplaint`, `pIllnessHistory`, `pOtherComplaint`, `pSignsSymptoms`, `pPainSite`, `pReportStatus`) VALUES('$erthcaseno', '$pChiefComplaint', '$pIllnessHistory', '$pOtherComplaint', '$pSignsSymptoms', '$pPainSite', '$pReportStatus')");
}
...
$pGuRem=$pespecificfetch['pGuRem'];
  ...
  mysqli_query($mycon5,"INSERT INTO `pespecific` (`caseno`, `pSkinRem`, `pHeentRem`, `pChestRem`, `pHeartRem`, `pAbdomenRem`, `pNeuroRem`, `pRectalRem`, `pGuRem`, `pReportStatus`) VALUES('$erthcaseno', '$pSkinRem', '$pHeentRem', '$pChestRem', '$pHeartRem', '$pAbdomenRem', '$pNeuroRem', '$pRectalRem', '$pGuRem', 'U')");
}
...
$pHeadCirc=$pepertfetch['pHeadCirc'];
  ...
  mysqli_query($mycon5,"INSERT INTO `pepert` (`caseno`, `pSystolic`, `pDiastolic`, `pHr`, `pRr`, `pTemp`, `pHeight`, `pWeight`, `pVision`, `pLength`, `pHeadCirc`, `pReportStatus`) VALUES('$erthcaseno', '$pSystolic', '$pDiastolic', '$pHr', '$pRr', '$pTemp', '$pHeight', '$pWeight', '$pVision', '$pLength', '$pHeadCirc', 'U')");
}
...
$pGensurveyRem=$pegensurveyfetch['pGenSurveyRem'];
  ...
  mysqli_query($mycon5,"INSERT INTO `pegensurvey` (`caseno`, `pGenSurveyId`, `pGenSurveyRem`, `pReportStatus`) VALUES('$erthcaseno', '$pGensurveyId', '$pGensurveyRem', 'U')");
}
...
$pSpecificDesc=str_replace("  "," ",$pSpecificDesc);
  ...
  mysqli_query($mycon5,"INSERT INTO `mhspecific` (`caseno`, `pMdiseaseCode`, `pSpecificDesc`, `pReportStatus`) VALUES('$erthcaseno','$pMdiseaseCode','$pSpecificDesc','U')");
}
...
$pWFamPlan=$preghistfetch['pWFamPlan'];
  ...
  mysqli_query($mycon5,"INSERT INTO `preghist` (`caseno`, `pPregCnt`, `pDeliveryCnt`, `pDeliveryTyp`, `pFullTermCnt`, `pPrematureCnt`, `pAbortionCnt`, `pLivChildrenCnt`, `pWPregIndhyp`, `pWFamPlan`, `pReportStatus`) VALUES('$erthcaseno', '$pPregCnt', '$pDeliveryCnt', '$pDeliveryTyp', '$pFullTermCnt', '$pPrematureCnt', '$pAbortionCnt', '$pLivChildrenCnt', '$pWPregIndhyp', '$pWFamPlan', 'U')");
}
...
mysqli_query($mycon4,"DELETE FROM hcode WHERE caseno='$erthcaseno'");
mysqli_query($mycon4,"INSERT INTO `hcode` (`caseno`, `pHospitalTransmittalNo`) VALUES ('$erthcaseno', '$hcode')");
//---------------------------------------------------------------------------------------------------------------------------------------------------
...
mysqli_query($mycon4,"UPDATE `rthclaim` SET `hiscaseno`='$caseno', `hispname`='$pn', `hisadt`='".date("Y-m-d H:i:s",strtotime($datetimead))."', `hisddt`='".date("Y-m-d H:i:s",strtotime($datetimedis))."', `hisbdate`='$dob', `hissex`='$sex', `hisptype`='$paymentmode', `hiscr1`='$cr1', `hiscr2`='$cr2', `hisadd`='$initialdiagnosis', `hisdsd`='$finaldiagnosis' WHERE `caseno`='$erthcaseno'");
