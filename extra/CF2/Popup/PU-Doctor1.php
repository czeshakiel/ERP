...
<div class='login-popup-AD'>
  <div class='form-popup-AD' id='ad0' align='center'>
    <form action='DateSignedSave.php' method='get' class='form-container-AD'>
      <h4><strong>Doctor 1</strong></h4>
...
echo "
        ...
        <tr>
          <td colspan='3'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td><button type='button' class='btn cancel' onclick='closead0()'>Close</button></td>
...
<script>
  function openad0() {
    document.getElementById('ad0').style.display='block';
  }
