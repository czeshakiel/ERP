...
<div class='login-popup-AD'>
  <div class='form-popup-AD' id='hci' align='center'>
    <form action='HCIRepSave.php' method='get' class='form-container-AD'>
      <h4><strong>HCI Representative</strong></h4>
...
echo "
        ...
        <tr>
          <td colspan='3'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td><button type='button' class='btn cancel' onclick='closehci()'>Close</button></td>
