...
include("Popup/PUS-Doctor.php");
	...
	$SQLcount=mysql_query("SELECT count(autono) as count FROM finalcaserate WHERE caseno='$caseno'");
        if(mysql_num_rows($SQLcount)>0)
        {
          while($countfetch=mysql_fetch_array($SQLcount))
          {
	...
	{ 
			...
			echo "
			                ...
			                <td><table border='0' cellpadding='0' cellspacing='0' width='100%'>
			                  ...
			                  <tr>
			                    <td colspan='15' height='3'></td>
			                        ...
			                        $num=1;
			                        $SQLcase=mysql_query("SELECT * FROM finalcaserate WHERE caseno='$caseno' ORDER BY FIELD(level, 'primary','secondary','additional'),autono limit $limit,6");
			  ...
			  echo"
			                  ...
			                  <tr>
			                    <td></td>
			                    <td><div align='left' class='tahoma s10 black'>c.&nbsp;</div></td>
			                  ...
			                  <tr>
			                    <td></td>
			                    <td><div align='left' class='tahoma s10 black'>d.&nbsp;</div></td>
			                  ...
			                  <tr>
			                    <td></td>
			                    <td><div align='left' class='tahoma s10 black'>e.&nbsp;</div></td>
			                  ...
			                  <tr>
			                    <td></td>
			                    <td><div align='left' class='tahoma s10 black'>f.&nbsp;</div></td>
