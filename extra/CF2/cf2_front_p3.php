...
$dontinclude="";
$fcrpsql=mysqli_query($conn,"SELECT * FROM `finalcaserate` WHERE `caseno`='$caseno' AND `con`='' ORDER BY FIELD(`level`, 'primary', 'secondary', '', 'additional'), CAST(`autono` AS UNSIGNED)");
