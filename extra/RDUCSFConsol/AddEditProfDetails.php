...
$asql=mysqli_query($conn,"SELECT `doctor1`, `datesigned1`, `copay1`, `doctor2`, `datesigned2`, `copay2`, `doctor3`, `datesigned3`, `copay3` FROM `claiminfoadd` WHERE `caseno`='$caseno'");
...
$bsql=mysqli_query($conn,"SELECT phicacc, lastname, firstname, middlename, suffix FROM docdetails ORDER BY lastname, firstname");
...
$dsql=mysqli_query($conn,"SELECT phicacc, lastname, firstname, middlename, suffix FROM docdetails ORDER BY lastname, firstname");
...
$fsql=mysqli_query($conn,"SELECT phicacc, lastname, firstname, middlename, suffix FROM docdetails ORDER BY lastname, firstname");
