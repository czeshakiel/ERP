...
";
      ...
      if(isset($_POST['eno'])){
        ...
        mysqli_query($conn,"UPDATE `labnormalvalues` SET `testname`='$testname', `testabr`='$testabr', `grplabel`='$grplabel', `grp`='$grp', `sort`='$sort', `amll`='$amll', `amul`='$amul', `afll`='$afll', `aful`='$aful', `cll`='$cll', `cul`='$cul', `nll`='$nll', `nul`='$nul', `displaynv`='$displaynv', `others`='$othval', `unit`='$unit', `type`='$type', `header`='$header', `respos`='$respos' WHERE `no`='$eno'");
      }
      else{
        if($grp==2){$othval=$choices;}
        else if($grp==3){$othval=$others;}
        ...
        mysqli_query($conn,"INSERT INTO `labnormalvalues` (`code`, `testname`, `testabr`, `grplabel`, `grp`, `sort`, `amll`, `amul`, `afll`, `aful`, `cll`, `cul`, `nll`, `nul`, `displaynv`, `others`, `unit`, `type`, `header`, `respos`, `stat`) VALUES ('$code', '$testname', '$testabr', '$grplabel', '$grp', '$sort', '$amll', '$amul', '$afll', '$aful', '$cll', '$cul', '$nll', '$nul', '$displaynv', '$othval', '$unit', '$type', '$header', '$respos', '1')");
      }
