...
if(isset($_GET['type'])){
  $type=mysqli_real_escape_string($mycon1,$_GET['type']);
}
else{
  $type="";
}
  ...
  <table border='0' cellpadding='0' cellspacing='0'>
    <tr>
      <td><div align='left'><table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <td><a href='?type=hematology' style='text-decoration: none;'><div style='color: #000000;'>Hematology</div></a></td>
          <td width='10'></td>
          <td><a href='?type=chemistry' style='text-decoration: none;'><div style='color: #000000;'>Chemistry</div></a></td>
          <td width='10'></td>
          <td><a href='?type=serology' style='text-decoration: none;'><div style='color: #000000;'>Serology</div></a></td>
          <td width='10'></td>
          <td><a href='?type=others' style='text-decoration: none;'><div style='color: #000000;'>Others</div></a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td>
        <table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            ...
            <td class='t2 b2 l1'><div align='center' style='padding: 0 3px 0 3px;color: #000000;font-family: arial;font-weight: bold;font-size: 10px;'>Normal Values</div></td>
...
if($type=="others"){$asql=mysqli_query($mycon1,"SELECT * FROM `receiving` WHERE `unit`='LABORATORY' AND `lotno` NOT LIKE '%hematology%' AND `lotno` NOT LIKE '%chemistry%' AND `lotno` NOT LIKE '%serology%' ORDER BY `itemname`");}
else{$asql=mysqli_query($mycon1,"SELECT * FROM `receiving` WHERE `unit`='LABORATORY' AND `lotno` LIKE '%$type%' ORDER BY `itemname`");}
...
while($afetch=mysqli_fetch_array($asql)){
  ...
  $bsql=mysqli_query($mycon1,"SELECT * FROM `labnormalvalues` WHERE `code`='$code' AND `stat`='1'");
...
echo "
          <tr>
            ...
            <td class='b1 l1'><div align='left' style='padding: 0 3px 0 3px;color: #000000;font-family: arial;font-size: 13px;'>$code</div></td>
            <td class='b1 l1'><div align='left' style='padding: 0 3px 0 3px;color: #000000;font-family: arial;font-size: 13px;'>$itemname</div></td>
            <td class='b1 l1'><div align='center' style='padding: 0 3px 0 3px;color: #000000;font-family: arial;font-size: 13px;'>$lotno</div></td>
            <td class='b1 l1'><div align='center' style='padding: 0 3px 0 3px;color: #000000;font-family: arial;font-size: 13px;'>$bcount</div></td>
            <td class='b1 l1 r2'><a href='../NV/?scode=$code' target='_blank'><div align='center' style='padding: 0 3px 0 3px;color: #000000;font-family: arial;font-size: 13px;'>Set NV</div></a></td>
          </tr>
";
}
