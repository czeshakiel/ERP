...
if(isset($_GET['eno'])){
  $label="Edit";
  $eno=mysqli_real_escape_string($mycon1,$_GET['eno']);
  $bsql=mysqli_query($mycon1,"SELECT * FROM `labnormalvalues` WHERE `no`='$eno'");
  if(mysqli_num_rows($bsql)>0){
    ...
    if($grp=="1"){$gp1="selected";$gp2="";$gp3="";$gp4="";$gp5="";$one="unhide";$two="hide";$three="hide";$four="unhide";$five="hide";$exun="";$ottype="button";$ctype="button";}
    else if($grp=="2"){$gp1="";$gp2="selected";$gp3="";$gp4="";$gp5="";$one="hide";$two="unhide";$three="hide";$four="hide";$five="hide";$exun="";$ottype="button";$ctype="submit";}
    else if($grp=="3"){$gp1="";$gp2="";$gp3="selected";$gp4="";$gp5="";$one="hide";$two="hide";$three="unhide";$four="unhide";$five="hide";$exun="unit";$ottype="submit";$ctype="button";}
    else if($grp=="4"){$gp1="";$gp2="";$gp3="";$gp4="selected";$gp5="";$one="hide";$two="hide";$three="hide";$four="unhide";$five="hide";$exun="unit";$ottype="button";$ctype="button";}
    else if($grp=="5"){$gp1="";$gp2="";$gp3="";$gp4="";$gp5="selected";$one="hide";$two="hide";$three="hide";$four="hide";$five="unhide";$exun="";$ottype="button";$ctype="button";}
    else{$gp1="";$gp2="";$gp3="";$gp4="";$gp5="";$one="hide";$two="hide";$three="hide";$four="hide";$five="hide";$exun="";$ottype="button";$ctype="button";}
  ...
  if(isset($_GET['addot'])){
    ...
    $gp1="";$gp2="";$gp3="selected";$gp4="";$gp5="";
    $exun="unit";
    $ottype="submit";
    $ctype="button";
    $one="hide";$two="hide";$three="unhide";$four="unhide";$five="hide";
    ...
    if(isset($_GET['addch'])){
      ...
      $gp1="";$gp2="selected";$gp3="";$gp4="";$gp5="";
      $exun="unit";
      $ottype="button";
      $ctype="submit";
      $one="hide";$two="unhide";$three="hide";$four="hide";$five="hide";
              ...
              <td>
                <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr>
                    ...
                    <td><div align='right'><input type='$ctype' name='addch' id='addch' type='submit' style='height: 20px;font-size: 9px;font-weight: bold;text-align: center;border-radius: 5px;' value='+' /><div></td>
                  </tr>
                  <tr>
                    <td colspan='2'>
                      <table border='0' width='100%' cellpadding='0' cellspacing='0'>
...
echo "
      <tr>
        <td colspan='3'><div class='$five' id='fiveonly' style='padding: 25px 0 5px 0;'>
          <table border='0' width='100%' cellpadding='0' cellspacing='0'>
            <tr>
              <td><div align='left' class='s11 bold blue'>Set Custom Age-based Normal Values (NV Type = 5)</div></td>
            </tr>
            <tr>
              <td>
                <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr>
                    <td colspan='3'><div align='left' class='s11 bold green'>Set Label</div></td>
                    <td width='2%'></td>
                    <td colspan='3'>
                      <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                        <tr>
...
echo "
                  <tr>
                    <td><div align='center'><input type='text' name='lbl-$zn' style='width: 50px;height: 30px;border-radius: 4px;border: 1px solid grey;font-size: 11px;' value='$lbl' /></div></td>
                    <td></td>
                    <td><div align='center'><input type='number' name='otnvll5-$zn' style='width: 65px;height: 30px;border-radius: 4px;border: 1px solid grey;font-size: 11px;' step='0.01' value='$oll5' /></td>
                    <td><div align='center' class='s11 bold black'>to</div></td>
                    <td><div align='center'><input type='number' name='otnvul5-$zn' style='width: 65px;height: 30px;border-radius: 4px;border: 1px solid grey;font-size: 11px;' step='0.01' value='$oul5' /></td>
                  </tr>
";
}
...
echo "
      ...
      <tr>
        <td colspan='3'><div class='$four' id='fouronly' style='padding: 25px 0 5px 0;'>
          <table border='0' width='100%' cellpadding='0' cellspacing='0'>
            <tr>
              <td colspan='3'><div align='left' class='s11 bold blue'>Set Unit (NV Type = 1 OR Type = 3 OR NV Type = 4)</div></td>
            </tr>
            <tr>
            ...
            <td><div align='left' style='padding: 0 5px 0 5px;'>
              <table border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  ...
                  <td><input type='number' placeholder='Size' name='sizeval' min='10' value='13' autocomplete='off' style='font-size: 9px;width: 60px;height: 20px;border-radius: 3px;border: 1px solid grey;' /></td>
                </tr>
              </table>
            </div></td>
          </tr>
