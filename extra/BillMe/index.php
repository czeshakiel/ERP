...
<head>
  ...
  <style>
    .navbarcs {overflow: hidden;background-color: #333;}
    ...
    .btnblue {background-color: #089AD1;color: #FFFFFF;border: none;cursor: pointer;opacity: 0.8;}
    .btngreen {background-color: #8EBF42;color: #FFFFFF;border: none;cursor: pointer;opacity: 0.8;}
    .btnred {background-color: #FF0000;color: #FFFFFF;border: none;cursor: pointer;opacity: 0.8;}
    .btnblue:hover, .btngreen:hover, .btnred:hover {opacity: 1;}
                ...
                <tr>
                  ...
                  <td><div align='left'><table border='0' width='0 cellpadding='0' cellspacing='0'>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td class='l1'></td>
                      <td valign='top' class='$hmoblink'><div align='left' class='arial s14 bold'>HMO&nbsp;</td>
                      <td valign='top' class='$hmoblink'><div align='center' class='arial s14 bold'>&nbsp;:&nbsp;</td>
                      <td class='$hmoblink'><div align='left' class='arial s18'>".strtoupper($hmo)."</div></td>
                      <td></td>
                      <td class='l1'></td>
                ...
                <tr>
                  ...
                  <td valign='top'><div align='left'><table border='0' width='0 cellpadding='0' cellspacing='0'>
                    <tr>
                      ...
                      <td><div align='left' class='arial s18 black'>".strtoupper($aprel)."</div></td>
                      <td width='10'></td>
                    </tr>
                    <tr>
...
//AR TRADE NOTICE----------------------------------------------------------------------------------
$arwarn="";
$zzsql=mysqli_query($conn,"SELECT * FROM `acctgenledge` WHERE `caseno`='$pacaseno' AND `acctitle` LIKE 'AR TRADE%%' AND `status`='pending'");
$zzcount=mysqli_num_rows($zzsql);
if($zzcount>0){
  $arcomment="";
  $zz=0;
  while($zzfetch=mysqli_fetch_array($zzsql)){
    $zzacctitle=$zzfetch['acctitle'];
    $zzamount=$zzfetch['amount'];
    $zzdate=$zzfetch['date'];
    $zz++;

    if($zz==$zzcount){$zzend="";}else{$zzend="; ";}
    $arcomment=$arcomment.$zzacctitle.": ".number_format($zzamount)." &rarr; ".date("M d, Y",strtotime($zzdate)).$zzend;
  }
  $arwarn=" <span style='font-family: arial;font-size: 10px;font-weight: bold;background-color: #FF0000;color: #FFFFFF;padding: 4px;border-radius: 5px;cursor: pointer;' title='$arcomment'>UTANG WARNING!!!</span>";
}
//END AR TRADE NOTICE------------------------------------------------------------------------------
...
echo "
                    <tr>
                      ...
                      <td class='b1 l1'><div align='left' class='arial s16 black'>&nbsp;".date("M d, Y",strtotime($padateadmit))."$arwarn&nbsp;</div></td>
                      <td class='b1 l1' width='70'><div align='center' class='arial s16 black'>$fcsc</div></td>
                      <td class='b1 l1' width='50'><a href='../../billing/?details&caseno=$pacaseno&user=$user&dept=BILLING' target='_blank' class='astyle'><div align='center' class='arial s16 black istyle'>&nbsp;<i class='demo-icon icon-eye-1 iall' style='font-size: 25px;'>&#xe8e5</i>&nbsp;</div></a></td>
                    </tr>
";
}
...
if($result=="FINAL"){
  ...
  if($status=="MGH"){
    ...
    $disstat="<span style='color: #FFFFFF;background-color: #000000;padding: 10px 15px;font-weight: bold;font-size: 20px;font-family: Cooper Black;border-radius: 20px;'>".mb_strtoupper($status)."</span>";
  }
}
...
echo "
    ...
    <tr>
      <td style='padding: 0 5px;'>
        <a href='../BillMe/?caseno=$caseno&dept=BILLING&user=$user'<button class='btnblue' style='padding: 5px 15px 5px 10px;font-size: 12px;border-radius: 5px;'><i class='demo-icon icon-left-1'>&#xe881</i> Back</button></a>
      </td>
    </tr>
    <tr>
      <td style='padding: 0 5px;'><div align='center' style='color: blue;font-family: arial;font-weight: bold;font-size: 16px;border-bottom: dotted 2px black;padding: 10px 0;'>ALLOCATION</div></td>
    </tr>
    <tr>
      <td style='padding: 0 5px;'><iframe src='postpayERP.php?caseno=$caseno&patientidno=$patientidno&user=$user' title='description' width='100%' height='600' style='border: none;'></iframe></td>
    </tr>
";
}
else{
  if(isset($_GET["postpf"])){
echo "
    <tr>
      <td height='10'></td>
    </tr>
    ...
    <tr>
      <td style='padding: 0 5px;'><div align='center' style='color: blue;font-family: arial;font-weight: bold;font-size: 16px;border-bottom: dotted 2px black;padding: 10px 0;'>PF POSTING</div></td>
    </tr>
    <tr>
      <td style='padding: 0 5px;'><iframe src='pfposting.php?caseno=$caseno&patientidno=$patientidno&user=$user' title='description' width='100%' height='600' style='border: none;'></iframe></td>
    </tr>
";
  }
  else{
    if(isset($_GET["adistro"])){
echo "
    <tr>
      <td height='10'></td>
    </tr>
    ...
    <tr>
      <td style='padding: 0 5px;'><div align='center' style='color: blue;font-family: arial;font-weight: bold;font-size: 16px;border-bottom: dotted 2px black;padding: 10px 0;'>AUTO DISTRIBUTE CHARGES</div></td>
    </tr>
    <tr>
      <td style='padding: 0 5px;'><iframe src='../AutoDistri/?caseno=$caseno&dept=BILLING' title='description' width='100%' height='600' style='border: none;'></iframe></td>
    </tr>
";
    }
    else{
...
echo "
    ...
    <tr>
      <td style='padding: 0 5px;'><div align='center' style='color: blue;font-family: arial;font-weight: bold;font-size: 16px;border-bottom: dotted 2px black;padding: 10px 0;'>APPLY SENIOR/PWD DISCOUNT</div></td>
    </tr>
    <tr>
      <td style='padding: 10px 5px;'>
";

        include("../AutoDistro/applysenior.php");
...
echo "
    ...
    <tr>
      <td style='padding: 0 5px;'><div align='center' style='color: blue;font-family: arial;font-weight: bold;font-size: 16px;border-bottom: dotted 2px black;padding: 10px 0;'>REMOVE SENIOR/PWD DISCOUNT</div></td>
    </tr>
    <tr>
      <td style='padding: 10px 5px;'>
";

          include("../AutoDistro/removesenior.php");
...
echo "
    ...
    <tr>
      <td style='padding: 0 5px;'><div align='center' style='color: blue;font-family: arial;font-weight: bold;font-size: 16px;border-bottom: dotted 2px black;padding: 10px 0;'>REMOVE SET FINAL</div></td>
    </tr>
    <tr>
      <td style='padding: 10px 5px;'>
";

          include("undosetfinal.php");
...
";
              ...
              include("../AutoDistro/allexcesssa.php");
...
echo "
    ...
    <tr>
      <td style='padding: 0 5px;'><div align='center' style='color: blue;font-family: arial;font-weight: bold;font-size: 16px;border-bottom: dotted 2px black;padding: 10px 0;'>MANUAL DISCOUNT</div></td>
    </tr>
    <tr>
      <td style='padding: 10px 5px;'>
";

                include("manualdiscount.php");

echo "
      </td>
    </tr>
";
              }else if(isset($_GET['applydiscountbeta'])){
echo "
    <tr>
      <td height='10'></td>
    </tr>
...
";
                ...
                include("manualdiscountbeta.php");
