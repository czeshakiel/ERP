        ...
        <table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            <td colspan='2'><div align='left'>
              <table border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td><a href='http://192.168.0.100:100/cgi-bin/nsprintps.cgi?ticketno=&caseno=$caseno' target='_blank'><button type='button' class='btn btn-xs btn-danger'><font size='2%'><i class='fa fa-file-text-o'> POS CHARGE-SLIP</i></font></button></a></td>
                  <td width='2'></td>
                  <td><a href='http://192.168.0.100:100/cgi-bin/nsprintps1.cgi?ticketno=&caseno=$caseno' target='_blank'><button type='button' name='btn_add' class='btn btn-xs btn-primary'><font size='2%'><i class='fa fa-check-circle-o'> STANDARD CHARGE-SLIP </i></font></button></a></td>
                </tr>
              </table>
            </div></td>
          </tr>
          ...
          <tr>
            ...
            <td><div align='left' style='padding: 2px 0;'>
              <select name='doctor' style='border: 1px solid black;height: 25px;border-radius: 3px;' required>
                <option value=''></option>
...
echo "
          ...
          <tr>
            ...
            <td><div align='left' style='padding: 2px 0;'>
              <select name='services' style='border: 1px solid black;height: 25px;border-radius: 3px;'>
...
echo "
          <tr>
            ...
            <td class='b1 l1 r2'><div align='left' style='padding: 3px 5px;'>
              <a href='removepf.php?refno=".$row2z['refno']."' target='_blank'"?> onclick="return confirm('Do you wish to remove this item?');return false;" ?><?php echo "><button name='btn_del' class='btn btn-danger' title='Delete PF' disabled><i class='fa fa-trash'></i></button></a>
            </div></td>
          </tr>
";
}
...
echo "
          <tr>
            ...
            <td class='b1 l1 r2'><div align='center' style='padding: 3px 5px;'>
              <form method='POST'>
                <button type='submit' name='btn_del' class='btn btn-danger' title='delete pf'"?> onclick="return confirm('Are you sure you want to remove <?php echo $pdesc ?>');" <?php echo "><i class='fa fa-trash'></i></button>
