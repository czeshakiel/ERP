...
";
  ...
  $dc=preg_split("/\_/",$doctor);
  $did=$dc[1];

  if($did==""){$did=$dc[0];}

  $sql2 = "SELECT * FROM docfile where code='$did'";
...
<table border='0' width='100%' cellpadding='0' cellspacing='0'>
  <tr>
        ...
        <table border='0' cellpadding='0' cellspacing='0'>
          ...
          <tr>
            ...
            <td><div align='left' style='padding: 2px 0;'>
              <input list='brow' class='list' name='doctor' placeholder='Select Doctor' autocomplete='off' style='border: 1px solid black;height: 30px;width: 300px;border-radius: 3px;' autofocus required>
    ...
    echo "
                <option value='".$name."_".$code."'>$code</option>
    ";
    }
