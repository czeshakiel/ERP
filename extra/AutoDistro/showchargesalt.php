...
$totexcess=0;
$flag=0;
$aeposql=mysql_query("SELECT refno, productcode, productdesc, sellingprice, quantity, adjustment, gross, phic, phic1, hmo, excess, productsubtype, administration FROM productout WHERE caseno='$caseno' AND trantype='charge' AND productsubtype NOT LIKE 'PROFESSIONAL FEE' ORDER BY productsubtype, productdesc");
