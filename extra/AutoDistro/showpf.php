...
echo "
<div align='left'>
  <span class='arial 18 blue bold'>PF DETAILS</span>
  <br /><br />
...
$flag=0;
$gross=0;
$aeposql=mysql_query("SELECT refno, productcode, productdesc, sellingprice, quantity, adjustment, gross, phic, phic1, hmo, excess, productsubtype, administration FROM productout WHERE caseno='$caseno' AND trantype='charge' AND gross > 0 AND productsubtype LIKE 'PROFESSIONAL FEE' ORDER BY productsubtype, productdesc");
...
echo "
    <tr>
      <td class='t1 b2 l2' colspan='7' height='30'><div align='left' class='arial s14 black bold'>&nbsp;TOTAL&nbsp;</div></td>
      <td class='t1 b2 l1' colspan='2'><div align='right' class='arial s14 black bold'>&nbsp;".number_format($gross,2)."&nbsp;</div></td>
