...
$totexcess=0;
$flag=0;
$aeposql=mysql_query("SELECT refno, productcode, productdesc, sellingprice, quantity, adjustment, gross, phic, phic1, hmo, excess, productsubtype, administration FROM productout WHERE caseno='$caseno' AND trantype='charge' AND quantity > 0 AND productsubtype NOT LIKE 'PROFESSIONAL FEE' ORDER BY productsubtype, productdesc");
...
if($aetname!="administered"){$bg="bgyellow";}
}
else{
$stat="";
}
...
echo "
      ...
      <td class='b1 l1 $bg'><a href='ManualDiscount.php?caseno=$caseno&refno=$aerefno' target='_blank' class='astyle'><div align='right' class='arial s14 black'>&nbsp;$aeadj&nbsp;</div></a></td>
...
echo "
    <tr>
      <td class='t1 b2 l2' colspan='9' height='30'><div align='left' class='arial s14 black bold'>&nbsp;TOTAL&nbsp;</div></td>
