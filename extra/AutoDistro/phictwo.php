<?php
  $cmd="AND productsubtype NOT LIKE 'PROFESSIONAL FEE' AND productsubtype NOT LIKE 'LABORATORY' AND productsubtype NOT LIKE 'XRAY' AND productsubtype NOT LIKE 'CT SCAN' AND productsubtype NOT LIKE 'ULTRASOUND' AND productsubtype NOT LIKE 'EEG' AND productsubtype NOT LIKE 'ECG' AND productsubtype NOT LIKE 'HEARTSTATION' ";
  echo "<br />";
        ...
        if($go=="yes"){
          ...
          if($fcnewhs!=0){
            if($fcnewhs>$dpgross){
              $fcnewhs-=$dpgross;
              echo $fcnewhs."<br />";
              mysql_query("UPDATE `productout` SET phic1='$dpgross', excess='0' WHERE refno='$dprefno'");
            }
              ...
              mysql_query("UPDATE `productout` SET phic1='$newphic', excess='$newdpgross' WHERE refno='$dprefno'");
            }
          }
          else if($fcnewhs==0){
            echo "Excess<br />";
    ...
    if($go=="yes"){
      ...
      if($fcnewhs!=0){
        if($fcnewhs>$gross){
          $fcnewhs-=$gross;
          echo $fcnewhs."<br />";
          mysql_query("UPDATE `productout` SET phic1='$gross', excess='0' WHERE refno='$refno'");
        }
          ...
          mysql_query("UPDATE `productout` SET phic1='$newphic', excess='$newgross' WHERE refno='$refno'");
        }
      }
      else if($fcnewhs==0){
        echo "Excess<br />";
