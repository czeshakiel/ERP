...
$asd=0;
$flag=0;
$aeposql=mysql_query("SELECT refno, productcode, productdesc, sellingprice, quantity, adjustment, gross, phic, phic1, hmo, excess FROM productout WHERE caseno='$caseno' AND trantype='charge' AND gross > 0 AND productsubtype NOT LIKE 'PROFESSIONAL FEE' ORDER BY datearray");
...
mysql_query("UPDATE `productout` SET gross='".(($aesp*$aeqty)-$aeadj)."', phic='0', phic1='0', hmo ='0', excess='".(($aesp*$aeqty)-$aeadj)."' WHERE refno='$aerefno'");
...
echo "
    <tr>
      <td colspan='12' class='t1'></td>
    </tr>
  </table>
</div>
";
echo "Gross: ".$asd."<br /><br />";
?>
