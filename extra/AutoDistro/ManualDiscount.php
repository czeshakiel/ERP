...
$spp=$itmfetch['sellingprice'];
$qty=$itmfetch['quantity'];
$gro=$itmfetch['gross'];
$ph1=$itmfetch['phic'];
$ph2=$itmfetch['phic1'];
$hmo=$itmfetch['hmo'];
$dis=$itmfetch['adjustment'];
  ...
  <tr>
    <td><div align='left'>
      <table border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <form name='save' method='post' action='ManualDiscountSave.php'>
          <td class='t3 b3 l3 r3'><table border='0' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              ...
              <td><div align='center' class='arial s12 black'>&nbsp;:&nbsp;</div></td>
              <td><div align='left'>&nbsp;<input type='text' name='net' class='bggreen bordergreen white arial s12 bold h25' value='$net' readonly /></div></td>
              <td></td>
            </tr>
            <tr>
              <td colspan='5' height='3'></td>
            ...
            <tr>
              <td></td>
              <td><div align='left' class='arial s12 black'>&nbsp;Discount&nbsp;</div></td>
              <td><div align='center' class='arial s12 black'>&nbsp;:&nbsp;</div></td>
              <td><div align='left'>&nbsp;<input type='text' name='adjustment' class='arial s12 bold h25' value='$dis' /></div></td>
              <td></td>
            </tr>
            <tr>
              <td colspan='5' height='3'></td>
            ...
            <tr>
              <td></td>
              <td><div align='left' class='arial s12 black'>&nbsp;Gross&nbsp;</div></td>
              <td><div align='center' class='arial s12 black'>&nbsp;:&nbsp;</div></td>
