...
xmlhttp.open("GET","ccchargesresult_test.php?caseno='.$caseno.'&station='.$station.'&toh='.$toh.'&tick='.$tick.'&at='.$totgross.'&cl='.$cl.'&searchme="+document.searchme.searchme.value,true);
xmlhttp.send();
}
