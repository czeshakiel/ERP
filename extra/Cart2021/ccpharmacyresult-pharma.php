...
$a=0;
$asql=mysqli_query($mycon1,"SELECT code, description, generic FROM stocktable WHERE (description LIKE '%$searchme%' OR generic LIKE '%$searchme%') AND dept='$stk' GROUP BY code");
...
echo "
  <form method='post' action='pospharma-pharma.php'>
  <table border='1' bordercolor='#000000' cellpadding='0' cellspacing='0'>
    <tr>
