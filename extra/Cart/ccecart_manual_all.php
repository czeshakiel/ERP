...
echo "
    <tr class='div-container'>
      ...
      <td><input name='searchme' type='text' autocomplete='off' placeholder='Type item name here and press enter...' value='$temval' autofocus /></td>
  ...
  if(isset($_GET['manual'])){
    ...
    if(stripos($caseno, "W") !== FALSE){
      ...
      echo "
              ...
              <td width='20'></td -->
              <td height='35' valign='middle'><div align='center' style='padding-right: 5px;'><button type='submit' name='trantype' class='btn cancel' value='charge'>Charge</button></td>
      ";
      $chb+=1;
      }
      else{
