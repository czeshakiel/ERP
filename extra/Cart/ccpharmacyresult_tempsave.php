...
$a=0;
$asql=mysqli_query($mycon1,"SELECT s.code, s.description, s.generic FROM receiving r, stocktable s WHERE r.code=s.code AND r.unit='PHARMACY/MEDICINE' AND (s.description LIKE '%$searchme%' OR s.generic LIKE '$searchme%') AND s.dept='$stk' GROUP BY r.code LIMIT 0,20");
...
echo "
  <form method='post' action='pospharma_tempsave.php'>
  <table border='1' bordercolor='#000000' cellpadding='0' cellspacing='0'>
    <tr $bg>
