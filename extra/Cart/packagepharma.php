...
$quantity=mysqli_real_escape_string($mycon1,$_GET['qty']);
...
$sprel=mysqli_real_escape_string($mycon1,$_GET['sprel']);
$referenceno=mysqli_real_escape_string($mycon1,$_GET['referenceno']);
$packrno=mysqli_real_escape_string($mycon1,$_GET['packrno']);
$itd=mysqli_real_escape_string($mycon1,$_GET['itd']);
$srno=mysqli_real_escape_string($mycon1,$_GET['srno']);
