...
$zsql=mysqli_query($conn,"SELECT membership, hmomembership FROM admission WHERE caseno='$caseno'");
$zfetch=mysqli_fetch_array($zsql);
$membership=$zfetch['membership'];
$hmomembership=$zfetch['hmomembership'];

$a=0;
$asql=mysqli_query($conn,"SELECT * FROM receiving WHERE code='1000582n-3' OR code='10007110p-3' OR code='110002625n-3' OR code='110003885n-5' OR code='L62p-3' OR code='L139p-3' OR code='L135p-3' OR code='L1000p-3' OR code='L32p-3' ORDER BY description");
