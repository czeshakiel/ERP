...
xmlhttp.open("GET","ccphopcartresult.php?caseno='.$caseno.'&station='.$station.'&toh='.$toh.'&tick='.$tick.'&stk='.$stk.'&searchme="+document.searchme.searchme.value,true);
xmlhttp.send();
}
...
<div align='left'>
  <table border='0' cellpadding='0' cellspacing='0'>
    ...
    <tr>
      <td height='10'><div align='left' class='arial s14 bold'>$toh CART | USER: <span class='blue'>".$_COOKIE["ccname"]." --> $totgross</span></div></td>
    </tr>
...
$a=0;
$asql=mysqli_query($mycon1,"SELECT productdesc, quantity FROM productout WHERE caseno='$caseno' AND batchno='$tick'");
