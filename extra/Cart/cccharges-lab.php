...
$rchksql=mysqli_query($mycon1,"SELECT productcode, terminalname FROM productout WHERE refno='$refno'");
...
$pco=$rchkfetch['productcode'];
  if($sta=='pending'){
    ...
    echo "<META HTTP-EQUIV='Refresh'CONTENT='1;URL=http://$setip/2021codes/ChargeCart/cccharges-lab.php?caseno=$caseno&station=$station&toh=$toh&tick=$tick'>";
  }
  else{
    $ctnnum=0;
    ...
    if($ctnnum>0){
      ...
      echo "<META HTTP-EQUIV='Refresh'CONTENT='3;URL=http://$setip/2021codes/ChargeCart/cccharges-lab.php?caseno=$caseno&station=$station&toh=$toh&tick=$tick'>";
    }
  }
}
else{
...
<div align='left'>
  <table border='0' cellpadding='0' cellspacing='0'>
    ...
    <tr>
      <td><div id='livesearch' align='left'>
";

$ccacce=$_COOKIE["ccacce"];
include("ccchargesresult-lab.php");
...
echo "
        <tr>
          ...
          <form name='delete' method='get' action='cccharges-lab.php'>
