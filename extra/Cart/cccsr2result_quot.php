...
$a=0;
$asql=mysqli_query($mycon1,"SELECT r.code, r.itemname, r.generic FROM receiving r, stocktable s WHERE (r.description LIKE '%$searchme%' OR r.generic LIKE '%$searchme%') AND r.code=s.code AND (r.unit LIKE '%PHARMACY/SUPPLIES%' OR r.unit LIKE '%MEDICAL SURGICAL SUPPLIES%') AND s.dept='$stk' GROUP BY r.code");
