...
echo "INSERT INTO `stocktable` (`date`, `rrno`, `po`, `invno`, `suppliercode`, `suppliername`, `code`, `description`, `unitcost`, `quantity`, `recdqty`, `generic`, `statquantity`, `expiration`, `lotno`, `trantype`, `terms`, `transdate`, `dept`, `prodtype1`, `paymentstatus`, `isid`, `receivinguser`, `prevqty`, `stockalert`, `duedate`, `datearray`) VALUES ('$sdate', '$rrno', '$spo', '$sinvno', '$caseno', '$patientname', '$scode', '$sdescription', '$sunitcost', '$squantity', '$srecdqty', '$sgeneric', '$sstatquantity', '$sexpiration', '$slotno', 'dispensed', '$sterms', '$stransdate', '$stk', '$sprodtype1', '$spaymentstatus', '$sisid', '$ccname', '$sprevqty', '$sstockalert', '$sduedate', '$sdatearray')";
