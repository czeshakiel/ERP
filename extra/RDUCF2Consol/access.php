...
//admission
$adsql=mysqli_query($conn,"SELECT * FROM `admission` WHERE `caseno`='$casenostr'");
...
//caserate
$cr1sql=mysqli_query($conn,"SELECT * FROM `finalcaserate` WHERE `caseno`='$casenostr' AND `level`='primary'");
$cr1fetch=mysqli_fetch_array($cr1sql);
$cr1=$cr1fetch['icdcode'];

$cr2sql=mysqli_query($conn,"SELECT * FROM `finalcaserate` WHERE `caseno`='$casenostr' AND `level`='secondary'");
...
//DISCHARGEDTABLE
$dtsql=mysqli_query($conn,"SELECT `timedischarged`, `datearray` FROM `dischargedtable` WHERE `caseno`='$casenostr'");
...
//CLAIMINFOADD
$clasql=mysqli_query($conn,"SELECT `hciyes`, `hcino`, `hci`, `hciaddress`, `disposition`, `expireddays`, `timeexpired`, `transferto`, `transferadd`, `reasons`, `private`, `nonprivate` FROM `claiminfoadd` WHERE `caseno`='$casenostr'");
