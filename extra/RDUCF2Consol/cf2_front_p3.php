            ...
            <td colspan='3' class='b2'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
              <tr>
                <td><table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr>
                    <td width='5'></td>
                    <td"; ?> onclick="<?php echo "window.open('../CaseRates/?caseno=$casenostr&user=".base64_encode($user)."', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=300,width=1000,height=650');";?>" <?php echo " $cursty><div align='left' class='tahoma s9 black'><b>7. Discharge Diagnosis/es</b> (Use additional CF2 if necessary):</div></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
...
$dontinclude="";
$fcrpsql=mysqli_query($conn,"SELECT * FROM `finalcaserate` WHERE `caseno`='$casenostr' AND `con`='' ORDER BY FIELD(`level`, 'primary', 'secondary', '', 'additional'), CAST(`autono` AS UNSIGNED)");
...
for($zx=1;$zx<=$linearray;$zx++){
  $allline++;
  if($allline>6){$lastarray=$linearray;break;$lastlinetot=$zx;}
...
echo "
                  <tr>
                    ...
                    <td class='b1'"; ?> onclick="<?php echo "window.open('../CaseRates/EditICDDesc.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$editauto', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=300');";?>" <?php echo " $cursty><div align='left' class='tahoma black' $valpsty>".$pl1.$addp1."</div></td>
                    <td></td>
";

if($typep=="rvs"){
echo "
                    <td class='b1'"; ?> onclick="<?php echo "window.open('../CaseRates/?caseno=$casenostr&user=".base64_encode($user)."&frm=con&rvauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=300,width=1000,height=650');";?>" <?php echo " $cursty><div align='center' class='tahoma s10 black bold'>$icddisprel</div></td>
";
}
else{
echo "
...
if($typep=="rvs"){
echo "
                    <td class='b1'"; ?> onclick="<?php echo "window.open('../CaseRates/EditRVRP.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=380');";?>" <?php echo " $cursty><div align='left' class='tahoma black' $valrelpsty>".$relpl1.$reladdp1."</div></td>
";
}
else{
echo "
...
if($typep=="rvs"){
echo "
                    <td class='b1'"; ?> onclick="<?php echo "window.open('../CaseRates/EditRVRP.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=380');";?>" <?php echo " $cursty><div align='center' class='tahoma s10 black'>$prdaterel</div></td>
                    <td></td>
                    <td width='19'"; ?> onclick="<?php echo "window.open('../CaseRates/EditRVRP.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=380');";?>" <?php echo " $cursty><table border='0' cellpadding='0' cellspacing='0'>
                      <tr>
                        <td height='17' width='17' class='t1 b1 l1 r1'><div align='center' class='tahoma s9 black'>$rvspl</div></td>
                      </tr>
                    </table></td>
                    <td"; ?> onclick="<?php echo "window.open('../CaseRates/EditRVRP.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=380');";?>" <?php echo " $cursty><div align='center' class='tahoma s10 black'>left</div></td>
                    <td width='19'"; ?> onclick="<?php echo "window.open('../CaseRates/EditRVRP.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=380');";?>" <?php echo " $cursty><table border='0' cellpadding='0' cellspacing='0'>
                      <tr>
                        <td height='17' width='17' class='t1 b1 l1 r1'><div align='center' class='tahoma s9 black'>$rvspr</div></td>
                      </tr>
                    </table></td>
                    <td"; ?> onclick="<?php echo "window.open('../CaseRates/EditRVRP.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=380');";?>" <?php echo " $cursty><div align='center' class='tahoma s10 black'>right</div></td>
                    <td width='19'"; ?> onclick="<?php echo "window.open('../CaseRates/EditRVRP.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=380');";?>" <?php echo " $cursty><table border='0' cellpadding='0' cellspacing='0'>
                      <tr>
                        <td height='17' width='17' class='t1 b1 l1 r1'><div align='center' class='tahoma s9 black'>$rvspb</div></td>
                      </tr>
                    </table></td>
                    <td"; ?> onclick="<?php echo "window.open('../CaseRates/EditRVRP.php?caseno=$casenostr&user=".base64_encode($user)."&editauto=$autonop', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=700,width=450,height=380');";?>" <?php echo " $cursty><div align='center' class='tahoma s10 black'>both</div></td>
                    <td></td>
";
}
else{
