...
mysqli_query($conn,"INSERT INTO `stocktable` (`date`, `rrno`, `po`, `invno`, `suppliercode`, `suppliername`, `code`, `description`, `unitcost`, `quantity`, `recdqty`, `generic`, `statquantity`, `expiration`, `lotno`, `trantype`, `terms`, `transdate`, `dept`, `prodtype1`, `paymentstatus`, `isid`, `receivinguser`, `prevqty`, `stockalert`, `duedate`, `datearray`) VALUES ('$sdate', '$rrno', '$spo', '$sinvno', '$caseno', '$patientname', '$code', '$desc', '$sunitcost', '$squantity', '$srecdqty', '$genc', '$sstatquantity', '$sexpiration', '$slotno', 'dispensed', '$sterms', '$stransdate', '$stk', '$sprodtype1', '$spaymentstatus', '$sisid', '$ccname', '$sprevqty', '$sstockalert', '$sduedate', '$sdatearray')");
?>
