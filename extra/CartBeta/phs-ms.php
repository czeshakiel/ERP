...
echo "
        ...
        <table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            <td style='padding: 5px 0;background-color: #FFFFFF;'><div align='left' style='font-family: arial;font-size: 11px;font-weight: bold;color: #0374A5;background-color: #FFFFFF;'><span onclick=document.getElementById('mySignUp').submit(); style='cursor: pointer;'>&#9664; Back</span></div></td>
        ...
        <table border='0' cellpadding='0' cellspacing='0' class='hoverTable'>
          <tr>
            ...
            <td class='t2 b2 l1' style='border-radius: 0px;'><div align='center'></div></td>
...
echo "
          <tr $pnfwarn>
            ...
            <td class='b1 l1' style='border-radius: 0px;'><div align='center'><input type='checkbox' class='case' name='itmcode$zx' value='$cod' $qtdis /></div></td>
            ...
            <td class='b1 l1' style='border-radius: 0px;'><div align='left' style='font-family: arial;font-size: 14px;color: #000000;padding: 3px 5px;'>
              <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                <tr $pnfwarn>
                  <td width='60' style='border-radius: 0px;'><div align='center' style='padding: 3px 5px;'><input type='number' step='0.01' style='height: 30px;width: 60px;border-radius: 5px;border: 2px solid #000000;' placeholder='Qty.' name='qty$zx' value='1' $qtdis $ronl /></div></td>
";
...
echo "
              ...
              <input type='hidden' name='itmtype$zx' value='$unt' />
              <input type='hidden' name='itmname$zx' value='$itn' />
              <input type='hidden' name='stk$zx' value='$stk' />
            </div></td>
...
echo "
          <tr>
            <td class='t2' colspan='4'><div align='left' style='color: #FF0000;font-family: arial;font-size: 14px;padding-top: 5px;'>N o t h i n g&nbsp;&nbsp;&nbsp;f o l l o w s . . .</div></td>
            <td class='t2' colspan='2'><div align='right' style='padding-top: 5px;'>
              <table border='0' cellpadding='0' cellspacing='0'>
                <tr>
";
...
echo "
        ...
        <input type='hidden' name='zxcount' value='$zx' />
        </form>
";
      }
    }
