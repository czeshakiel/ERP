            ...
            <td class='b1 l1' style='border-radius: 0px;'><div align='left' style='font-family: arial;font-size: 14px;color: #000000;padding: 3px 5px;'>
              <form method='post'>
                <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                  <tr $pnfwarn>
                    <td width='60' style='border-radius: 0px;'><div align='center' style='padding: 3px 5px;'><input type='number' step='0.01' style='height: 30px;width: 60px;border-radius: 5px;border: 2px solid #000000;' placeholder='Qty.' name='qty' value='1' $qtdis $ronl /></div></td>
";
...
echo "
                          ...
                          <td style='border-radius: 0px;'><div align='center' style='padding: 3px 2px;'><button type='submit' name='trantype' value='tpl' class='btn'>Charge</button></div></td>
";
                }
                //}
              }
