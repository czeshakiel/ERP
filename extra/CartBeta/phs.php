        ...
        while($zxfetch=mysqli_fetch_array($zxsql)){
          ...
          if($gte==1){
            ...
            if($soh<1){
              ...
              if($pnf!="PNDF"){
                if(strpos($caseno, 'W-')!==false){$qtdis="";}else{$qtdis="disabled";}
...
";
            ...
            if($pnf!="PNDF"){
              if(strpos($caseno, 'W-')!==false){echo"<td style='border-radius: 0px;'><div align='center' style='padding: 3px 2px;'><button type='submit' name='trantype' value='cash' class='btn cancel'>Cash</button></div></td>";}else{
echo "
