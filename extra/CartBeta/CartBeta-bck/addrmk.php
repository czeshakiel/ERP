...
echo "
  <form method='post'>
    <table border='0' cellpadding='0' cellspacing='0'>
      ...
      <tr>
        <td style='padding-bottom: 5px;'><div align='left'><textarea name='remarks' style='border: 3px solid #000000;border-radius: 10px;padding: 5px;font-size: 16px;width: 100%;height: 100px;' placeholder='REMARKS' autofocus></textarea></div></td>
      </tr>
      <tr>
