...
//USERDETAILS
$bsql=mysqli_query($conn,"SELECT * FROM `nsauth` WHERE `username`='".base64_decode($user)."' AND `station`='$dept'");
...
//SOA Details--------------------------------------------------------------------------------------
$sdfsql=mysqli_query($conn,"SELECT * FROM soadetails WHERE caseno='$caseno'");
...
if($setucount==0){
  $nsusql=mysqli_query($conn,"SELECT `name` FROM `nsauth` WHERE `username`='".base64_decode($user)."' AND `station`='$dept'");
...
$cfsql=mysqli_query($conn,"SELECT lastname, firstname, middlename FROM claiminfo WHERE patientidno='$patientidno' AND caseno='$caseno'");
...
if($dtcount==0){
  $tdssql=mysqli_query($conn,"SELECT `date`, `time` FROM `tempdatestorage` WHERE `caseno`='$caseno'");
