...
$setuser=mysqli_real_escape_string($conn,$_GET['setuser']);
...
<div align='center'><table style='height:100%;width:100%; position: absolute; top: 0; bottom: 0; left: 0; right: 0;' border='0' cellpadding='0' cellspacing='0'>
  <tr>
    <td valign='middle'><div align='center'>
      <form name='Save' method='post' action='setbillersave.php' class='form-container-Edit'>
        <table border='0' cellpadding='0' cellspacing='0'>
          <tr>
            <td><div align='center' class='arial s20 blue bold'>Set Biller</div></td>
          </tr>
          <tr>
            <td height='10'></td>
          </tr>
          <tr>
            <td>
              <select name='name' style='width: 250px;text-align: center;'>
                <option selected='selected'>$setbiller</option>
                <!--option>ROSSANA B. SUMAMPONG</option-->
                <option>CRISVEGINE LAZALITA</option>
                <option>DIMPLE M. FUENTES</option>
                <option>SAMBRA T. TAPA</option>
