...
$soaelog="";
$slsql=mysqli_query($conn,"SELECT * FROM `soalogs` WHERE `caseno`='$caseno'");
if(mysqli_num_rows($slsql)==0){
  mysqli_query($conn,"INSERT INTO `soalogs` (`caseno`, `logs`) VALUES ('$caseno', '')");
}
...
<head>
  ...
  <link rel='shortcut icon' href='../Resources/Logo/logo.png' type='image/png' />
        ...
        <tr>
          <td><table border='0' width='100%' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='70' class='t2 b2 l1' rowspan='2'><div align='center' class='times s12 black bold'>Actual<br />Charges</div></td>
              <td class='t2 b1 l1' colspan='3'><div align='center' class='times s12 black bold'>Amount of Discounts</div></td>
              <td class='t2 b1 l1' colspan='2'><div align='center' class='times s12 black bold'>PhilHealth benefits</div></td>
              <td width='70' class='t2 b2 l1 r2' rowspan='2'><div align='center' class='times s12 black bold'>Out of<br />Pocket<br />of Patient</div></td>
            </tr>
            <tr>
              <td width='70' class='b2 l1'><div align='center' class='times s12 black bold'>VAT<br />exempt</div></td>
              <td width='70' class='b2 l1'><div align='center' class='times s12 black bold'>Senior<br />Citizen/<br />PWD</div></td>
              <td width='70' class='b2 l1'><a href='../../2017codes/SOA/DiscType.php?caseno=$caseno' class='astyle' target='_blank'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td width='2'></td>
...
echo "
              ...
              <td width='70' class='b2 l1'><div align='center' class='times s12 black bold'>First<br />Case Rate<br />amount</div></td>
              <td width='70' class='b2 l1'><div align='center' class='times s12 black bold'>Second<br />Case Rate<br />amount</div></td>
            </tr>
            <!-- ------------------------------------------------------------------------------------------------------------------------------ -->
...
<!-- CHARGES START----------------------------------------------------------------------------------------------------------------------------- -->
            <tr>
              ...
              <td class='b2 l1 r2' colspan='7'><div align='center' class='times s12 black bold'>&nbsp;</div></td>
            </tr>
";
...
echo "
            <tr>
              <td class='b1 l2'><a href='subdetails.php?caseno=$caseno&label=$label' target='_blank' class='astyle'><div align='left' class='times s10 black bold'>&nbsp;$label</div></a></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($hstact,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format(0,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($hstadj,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($hsthmo,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($hstph1,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($hstph2,2)."&nbsp;</div></td>
              <td class='b1 l1 r2'><div align='right' class='times s10 black'>&nbsp;".number_format($hstfin,2)."&nbsp;</div></td>
            </tr>
";
}
...
echo "
            <tr>
              <td class='b1 l2'><a href='subdetails.php?caseno=$caseno&label=ALLOTHERS&alloth=".base64_encode($alloth)."' target='_blank' class='astyle'><div align='left' class='times s10 black bold'>&nbsp;MISCELLANEOUS</div></a></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($apotact,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format(0,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($apotadj,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($apothmo,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($apotph1,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($apotph2,2)."&nbsp;</div></td>
              <td class='b1 l1 r2'><div align='right' class='times s10 black'>&nbsp;".number_format($apotfin,2)."&nbsp;</div></td>
            </tr>
";
}
//END ALL OTHERS---------------------------------------------------------------------------------------------------------------------------
...
echo "
            <tr>
              <td class='t1 b1 l2' height='18'><div align='left' class='times s10 black bold'>&nbsp;Subtotal</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($subact,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format(0,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($subadj,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($subhmo,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($subph1,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($subph2,2)."&nbsp;</div></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s10 black bold'>&nbsp;".number_format($subfin,2)."&nbsp;</div></td>
            </tr>
";
$logall=$subact."|".$subadj."|".$subhmo."|".$subph1."|".$subph2."|".$subfin."|<>";
fwrite($resall, $logall);

$soaelog=$soaelog.$logall;
...
<!-- PF START---------------------------------------------------------------------------------------------------------------------------------- -->
            <tr>
              <td class='t1 b2 l2'><a href='../../2020codes/AutoDistro/showcharges.php?caseno=$caseno' target='_blank' class='astyle'><div align='center' class='times s12 black bold'>Professional fee/s</div></a></td>
              <td class='t1 b2 l1 r2' colspan='7'><div align='center' class='times s12 black bold'>&nbsp;</div></td>
            </tr>
";
...
echo "
            <tr>
              <!-- td class='b1 l2'><a href='../../2020codes/TestCodes/testviewdetails.php?caseno=$caseno&type=PROFESSIONAL FEE' target='_blank' class='astyle'><div align='left' class='times s10 black bold'>&nbsp;$prcount. $drtitle$pfdesc&nbsp;</div></a></td -->
              <td class='b1 l2'><a href='subdetails.php?caseno=$caseno&label=PF' target='_blank' class='astyle'><div align='left' class='times s10 black bold'>&nbsp;$prcount. $drtitle$pfdesc&nbsp;</div></a></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($pfiact,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format(0,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($pfiadj,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($pfihmo,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($pfiph1,2)."&nbsp;</div></td>
              <td class='b1 l1'><div align='right' class='times s10 black'>&nbsp;".number_format($pfiph2,2)."&nbsp;</div></td>
              <td class='b1 l1 r2'><div align='right' class='times s10 black'>&nbsp;".number_format($pfifin,2)."&nbsp;</div></td>
            </tr>
";
}
...
echo "
            <tr>
              <td class='t1 b1 l2' height='18'><a href='' target='_blank' class='astyle'><div align='left' class='times s10 black bold'>&nbsp;Subtotal</div></a></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($pfact,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format(0,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($pfadj,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($pfhmo,2)."&nbsp;</div></td>
              <td class='t1 b1 l1' bgcolor='$stpbgp1'><div align='right' class='times s10 black bold'>&nbsp;".number_format($pfph1,2)."&nbsp;</div></td>
              <td class='t1 b1 l1' bgcolor='$stpbgp2'><div align='right' class='times s10 black bold'>&nbsp;".number_format($pfph2,2)."&nbsp;</div></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s10 black bold'>&nbsp;".number_format($pffin,2)."&nbsp;</div></td>
            </tr>
<!-- PF END------------------------------------------------------------------------------------------------------------------------------------ -->
";
...
echo "
            <tr>
              <td class='t1 b1 l2' height='22'><a href='' target='_blank' class='astyle'><div align='left' class='times s11 black bold'>&nbsp;TOTAL</div></a></td>
              <td class='t1 b1 l1'><div align='right' class='times s11 black bold'>&nbsp;".number_format($allact,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s11 black bold'>&nbsp;".number_format(0,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s11 black bold'>&nbsp;".number_format($alladj,2)."&nbsp;</div></td>
              <td class='t1 b1 l1'><div align='right' class='times s11 black bold'>&nbsp;".number_format($allhmo,2)."&nbsp;</div></td>
              <td class='t1 b1 l1' bgcolor='$tbgp1'><div align='right' class='times s11 black bold'>&nbsp;".number_format($allph1,2)."&nbsp;</div></td>
              <td class='t1 b1 l1' bgcolor='$tbgp2'><div align='right' class='times s11 black bold'>&nbsp;".number_format($allph2,2)."&nbsp;</div></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black bold'>&nbsp;".number_format($allfin,2)."&nbsp;</div></td>
            </tr>
";
...
<!-- PAYMENT START----------------------------------------------------------------------------------------------------------------------------- -->
            <tr>
              ...
              <td class='t1 b1 r2' colspan='7'></td>
            </tr>
";

$removeamt=0;
$artsql=mysqli_query($conn,"SELECT SUM(`amount`) AS `amt`, `datearray`, `refno`, `ofr`,`accttitle` FROM `collection` WHERE `acctno`='$caseno' AND (`accttitle` LIKE 'AR TRADE%%' OR `accttitle` LIKE 'AR EMPLOYEE%%' OR `accttitle` LIKE 'AR DOCTOR%%')AND (`type`='cash-Visa' OR `type`='card-Visa') GROUP BY `ofr`");
$artcount=mysqli_num_rows($artsql);
while($artfetch=mysqli_fetch_array($artsql)){
  $artofr=$artfetch['ofr'];
  $artdate=$artfetch['datearray'];
  $artamt=$artfetch['amt'];
  $artaccttitle=$artfetch['accttitle'];

  if($artaccttitle!="AR EMPLOYEE"){
    $removeamt+=$artamt;
  }

echo "
            <tr>
              <td class='t1 b1 l2'><div align='left' class='times s11 black'>&nbsp;$artaccttitle - $artofr - $artdate</div></td>
              <td class='t1 b1' colspan='6'></td>
...
$lessardoc=0;
$lessacct=mysqli_query($conn,"SELECT type as status,accttitle as acctitle, amount, datearray,refno,ofr,type FROM collection where acctno='$caseno' and accttitle like '%AR %'");
while($lessacctfetch=mysqli_fetch_array($lessacct)){
  $acstatus=$lessacctfetch['status'];
  $acctitle=$lessacctfetch['acctitle'];
  $ctype=$lessacctfetch['type'];
...
/*echo "
            <tr>
              <td class='t1 b1 l2'><div align='center' class='times s11 black'>&nbsp;$acctitle - $lessacctfetch[ofr] - $date</div></td>
              <td class='t1 b1' colspan='6'></td>
...
";*/
    ...
    if((stripos($acctitle, "AR ") !== FALSE)&&(stripos($acctitle, " PF") !== FALSE)){
      ...
      //if(($acctitle=="AR EMPLOYEE")||($acctitle=="AR EMPLOYEE")||($acctitle=="AR PERSONAL")){
        $amount=$lessacctfetch['amount'];
        $date=$lessacctfetch['datearray'];
        $removeamt+=$amount;

        if(($acctitle=="AR DOCTOR" or $acctitle=="AR EMPLOYEE")&&($ctype=="cash-Visa")){
          $lessardoc+=$lessacctfetch['amount'];
        }
...
echo "
            <tr>
              <td class='t1 b1 l2'><div align='left' class='times s11 black'>&nbsp;$acctitle - $lessacctfetch[ofr] - $date</div></td>
              <td class='t1 b1' colspan='6'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black'>&nbsp;".number_format($amount,2)." &nbsp;</div></td>
            </tr>
";
...
echo "
            <tr>
              <td class='t1 b1 l2'><div align='left' class='times s11 black'>&nbsp;$acctitle - $ofr - $date</div></td>
              <td class='t1 b1' colspan='6'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black'>&nbsp;".number_format($amount,2)."&nbsp;</div></td>
            </tr>
";
...
if(stripos($caseno, "O-") !== FALSE){
  $masql=mysqli_query($conn,"SELECT `accttitle`, SUM(`amount`) AS `amount`, `ofr`, `date` FROM `collection` WHERE `acctno`='$caseno' AND ((`description`='HOSPITAL BILL' AND `accttitle`='MEDICAL SURGICAL SUPPLIES') OR (`accttitle`='PROFESSIONAL FEE')) GROUP BY `ofr`");
  while($mafetch=mysqli_fetch_array($masql)){
    $maamount=$mafetch['amount'];
    $maofr=$mafetch['ofr'];
    $madate=$mafetch['date'];

    $maamounttot+=$maamount;

    //$shwpf+=1;

echo "
            <tr>
              <td class='t1 b1 l2' colspan='2'><div align='left' class='times s11 black'>&nbsp;OPD-CASHONHAND - $maofr - $madate</div></td>
              <td class='t1 b1' colspan='5'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black'>&nbsp;".number_format($maamount,2)."&nbsp;</div></td>
            </tr>
";
  }
}
...
while($lesscollectfech=mysqli_fetch_array($lesscollect)){
  ...
  if((stripos($caseno, "O-") !== FALSE)&&($maofr==$ofr)){
    $removeamt+=$amount;
  }
  else{
...
echo "
            <tr>
              <td class='t1 b1 l2'><div align='left' class='times s11 black'>&nbsp;$acctitle - $description - $date</div></td>
              <td class='t1 b1' colspan='6'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black'>&nbsp;".number_format($amount,2)."&nbsp;</div></td>
            </tr>
";
...
$total_PD=0;
$PD_query=mysqli_query($conn,"SELECT * FROM collection where acctno='$caseno' and (accttitle='PATIENTS DEPOSIT' or accttitle='PF DEPOSIT' or accttitle='CASHONHAND' or accttitle='PROFESSIONAL FEE' or accttitle like 'AR %%') and type !='pending' ");
...
$total_less= ($total_AR + $total_PD +$lessardoc) - $removeamt;
$total_disc=0;

//$PD_query=mysqli_query($conn,"SELECT amount,accttitle FROM pfdiscount where caseno='$caseno'");
$PD_query=mysqli_query($conn,"SELECT sum(amount) as amount,acctitle FROM acctgenledge where caseno='$caseno' AND acctitle='DISCOUNT'");
while($PD_fetch=mysqli_fetch_array($PD_query)){
  $acctitle=$PD_fetch['acctitle'];
  $amount=$PD_fetch['amount'];
  $total_disc +=$amount;
}
echo "
            <tr>
              <td class='t1 b1 l2'><div align='left' class='times s11 black'>&nbsp;$acctitle</div></td>
              <td class='t1 b1' colspan='6'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black'>&nbsp;".number_format($amount,2)."&nbsp;</div></td>
            </tr>
";

$total_less= ($total_less + $total_disc + $faddamt + $maamounttot);

//if($total_less>0){
echo "
            <tr>
              <td class='t1 b1 l2' height='22'><div align='left' class='times s11 black bold'>&nbsp;Subtotal Less</div></td>
              <td class='t1 b1' colspan='6'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black bold'>&nbsp;".number_format($total_less,2)."&nbsp;</div></td>
            </tr>
";
//}
...
echo "
            <tr>
              <td class='t1 b2 l2' height='22'><div align='left' class='times s12 black bold'>&nbsp;NET</div></td>
              <td class='t1 b2' colspan='6'></td>
              <td class='t1 b2 l1 r2'><div align='right' class='times s12 black bold'>&nbsp;".number_format($net,2)."&nbsp;</div></td>
            </tr>
      ...
      <td><table border='0' width='100%' cellpadding='0' cellspacing='0'>
        <tr>
          <td width='350' valign='top'><table border='0' width='100%' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              <td class='b1' height='20' style='cursor: pointer;'";?> onclick="<?php echo "window.open('setbiller.php?caseno=$caseno&setuser=$setuser&uname=$uname', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=$hei,left=$wid,width=$setw,height=$seth');"; ?>" <?php echo "><div align='center' class='times s13 black bold' >$setuser</div></td>
            </tr>
            <tr>
...
$soaelogenc=openssl_encrypt($soaelog, "aes128", $caseno, 0, $iv);
//End Encyption

$soaelogdec=openssl_decrypt($soaelogenc, "aes128", $caseno, 0, $iv);
mysqli_query($conn,"SET NAMES 'utf8'");
mysqli_query($conn,"UPDATE `soalogs` SET `logs`='".base64_encode($soaelogenc)."', `iv`='".base64_encode($iv)."' WHERE `caseno`='$caseno'");
?>
