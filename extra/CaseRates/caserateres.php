...
if(($frm=="additional")||($frm=="con")){
  $statem="SELECT `icdcode`, `description`, `actualcaserate`, `hospital`, `pf`, `actualcaseratenew`, `hospitalnew`, `pfnew`, `actualcaserate2`, `hospital2`, `pf2`, `actualcaserate2new`, `hospital2new`, `pf2new`, `actualcaserate3`, `hospital3`, `pf3`, `groupdiag`, `category`, `idno` FROM `caserates` WHERE `icdcode` LIKE '%$searchme%' AND (`category`='medical' OR `category`='additional') ORDER BY `icdcode`";
}
else{
  $statem="SELECT `icdcode`, `description`, `actualcaserate`, `hospital`, `pf`, `actualcaseratenew`, `hospitalnew`, `pfnew`, `actualcaserate2`, `hospital2`, `pf2`, `actualcaserate2new`, `hospital2new`, `pf2new`, `actualcaserate3`, `hospital3`, `pf3`, `groupdiag`, `category`, `idno` FROM `caserates` WHERE `icdcode` LIKE '%$searchme%' AND (`category`='medical' OR `category`='surgical' OR `category`='additional') ORDER BY `icdcode`";
}

$len=strlen($searchme);
if($len>1){
$asql=mysqli_query($conn,$statem);
...
$pf=$afetch['pf'];
$actualcaseraten=$afetch['actualcaseratenew'];
$hospitaln=$afetch['hospitalnew'];
$pfn=$afetch['pfnew'];
$actualcaserate2=$afetch['actualcaserate2'];
$hospital2=$afetch['hospital2'];
$pf2=$afetch['pf2'];
$actualcaserate2n=$afetch['actualcaserate2new'];
$hospital2n=$afetch['hospital2new'];
$pf2n=$afetch['pf2new'];
...
if($da>20240213){
  $actualcaserate=$actualcaseraten;
  $actualcaserate2=$actualcaserate2n;
}
