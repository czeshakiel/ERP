...
mysqli_query($conn,"UPDATE `finalcaserate` SET `relatedprocedure`='$relatedprocedure', `dateofprocedure`='$dateofprocedure', `laterality`='$laterality' WHERE `autono`='$editauto'");
