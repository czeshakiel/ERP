...
$editauto=mysqli_real_escape_string($conn,$_GET['autono']);

$asql=mysqli_query($conn,"SELECT `icdcode`, `type`, `hospitalshare`, `pfshare` FROM `finalcaserate` WHERE `autono`='$editauto'");
