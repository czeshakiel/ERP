...
$adsql=mysqli_query($conn,"SELECT `dateadmit` FROM `admission` WHERE `caseno`='$caseno'");
$adfetch=mysqli_fetch_array($adsql);
$dateadmit=$adfetch['dateadmit'];
$dateadmit=str_replace("-","",$dateadmit);

$asql=mysqli_query($conn,"SELECT `icdcode`, `description`, `actualcaserate`, `hospital`, `pf`, `actualcaseratenew`, `hospitalnew`, `pfnew`,`actualcaserate2`, `hospital2`, `pf2`, `actualcaserate2new`, `hospital2new`, `pf2new`, `actualcaserate3`, `hospital3`, `pf3`, `category`, `annex` FROM `caserates` WHERE `idno`='$idno'");
