...
<div align='center'>
  <table style='height:100%;width:100%; position: absolute; top: 0; bottom: 0; center: 0; right: 0;' border='0' cellpadding='0' cellspacing='0'>
    <tr>
      <td><div align='center'>
        <form name='Save' method='post' action='AddICDToListGo.php' class='form-container-Edit' id='document'>
...
echo '
                    <textarea name="description" onkeypress="return handleEnter(this, event)" style="width: 250px;height: 100px;"></textarea>
';
                ...
                <tr>
                  <td colspan='3'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      ...
                      <td width='2%'></td>
                      <td width='49%'><div align='left'><button type='submit' class='btn'>Add</button></div></td>
                    </tr>
                  </table></td>
                </tr>
";
