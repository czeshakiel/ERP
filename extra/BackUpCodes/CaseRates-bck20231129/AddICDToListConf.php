...
<html lang="en">
  <head>
  <title>Add ICD Code to List</title>
...
$icdcode=strtoupper(mysqli_real_escape_string($mycon1,$_GET['icdcode']));
...
<div align='center'>
  <table style='height:100%;width:100%; position: absolute; top: 0; bottom: 0; center: 0; right: 0;' border='0' cellpadding='0' cellspacing='0'>
    <tr>
      <td><div align='center'>
        <form name='Save' method='post' action='AddICDToList.php' class='form-container-Edit'>
          <table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td><div align='center' class='arial s20 blue bold'>Add ICD Code to List</div></td>
            </tr>
            <tr>
              <td height='20'></td>
            </tr>
            <tr>
              <td><div align='center'><span class='arial s14 bold' style='color: #1D9FF4;'>You are about to add &quot;$icdcode&quot; to the list?</span></div></td>
            </tr>
            <tr>
              <td height='3'></td>
            </tr>
            ...
            <tr>
              <td colspan='3'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  ...
                  <td width='2%'></td>
                  <td width='49%'><div align='left'><button type='submit' class='btn'>Go?</button></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
