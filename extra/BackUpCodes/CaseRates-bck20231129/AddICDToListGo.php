...
$description=strtoupper(mysqli_real_escape_string($mycon1,$_POST['description']));
...
mysqli_query($mycon1,"INSERT INTO `caserates` (`icdcode`, `description`, `category`) VALUES ('$icdcode', '$description', 'additional')");

mysqli_query($mycon1,"SELECT * FROM caserates WHERE icdcode='$icdcode' INTO OUTFILE '/opt/lampp/htdocs/2021codes/CaseRates/Logs/Add/$icdcode/$user-$pdate.txt' FIELDS TERMINATED BY '|'");
