...
//NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW NEW
//START LABELED ITEMS--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
while($stfetch=mysqli_fetch_array($stsql)){
  ...
  $hstph2=0;
  $hsthmo=0;
  $sdsql=mysqli_query($mycon1,"SELECT `productsubtype` FROM `soasetupdetails` WHERE `no`='$no' GROUP BY `productsubtype`");
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    $aeposql=mysqli_query($mycon1,"SELECT refno, invno, productcode, productdesc, sellingprice, CAST(sellingprice AS DECIMAL(10,2)) AS sp, quantity, adjustment, CAST(adjustment AS DECIMAL(10,2)) AS adj, gross, CAST(gross AS DECIMAL(10,2)) AS gr, phic, CAST(phic AS DECIMAL(10,2)) AS ph, phic1, CAST(phic1 AS DECIMAL(10,2)) AS ph1, hmo, CAST(hmo AS DECIMAL(10,2)) AS hm, excess, CAST(excess AS DECIMAL(10,2)) AS ex, productsubtype, administration, terminalname, status, approvalno FROM productout WHERE caseno='$caseno' AND trantype='charge' AND quantity > 0 AND productsubtype='$productsubtype' ORDER BY productdesc, datearray");
    while($aepofetch=mysqli_fetch_array($aeposql)){
      ...
      if(($aeptype=="PHARMACY/MEDICINE")||($aeptype=="PHARMACY/SUPPLIES")||($aeptype=="MEDICAL SURGICAL SUPPLIES")){
        $crtnsql=mysqli_query($mycon1,"SELECT *  FROM `productreturn` WHERE `refno1`='$aerefno' AND `trantype`='pending'");
        $crtncount=mysqli_num_rows($crtnsql);

        $kpnfsql=mysqli_query($mycon1,"SELECT `pnf` FROM `receiving` WHERE `code`='$aecode'");
...
//REMARKS FOR RT HAZZARD---------------------------------------------------------------------------
      ...
      $rmsql=mysqli_query($mycon1,"SELECT `remarks` FROM `labtest` WHERE `refno`='$aerefno'");
...
echo "
      ...
      <td class='b1 l1 $bg'><div align='left' class='arial s16 black' title='$aeinvno'>&nbsp;".$aedesc.$rmdisp.$pnflabel."&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='left' class='arial s16 black'>&nbsp;$aeptype&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='center' class='arial s16 black'>&nbsp;$aestat&nbsp;</div></td>
      ...
      <td class='b1 l1 $bg $errdis'><div align='right' class='arial s16 black $errdis'>&nbsp;$aeadj&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$aegross&nbsp;</div></td>
      <td class='b1 l1 $bg $errphic'><div align='right' class='arial s16 black $errphic'>&nbsp;$aephic&nbsp;</div></td>
      <td class='b1 l1 $bg $errphic1'><div align='right' class='arial s16 black $errphic1'>&nbsp;$aephic1&nbsp;</div></td>
...
//ALL OTHERS-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
$rmaeposql=mysqli_query($mycon1,"SELECT refno, invno, productcode, productdesc, sellingprice, CAST(sellingprice AS DECIMAL(10,2)) AS sp, quantity, adjustment, CAST(adjustment AS DECIMAL(10,2)) AS adj, gross, CAST(gross AS DECIMAL(10,2)) AS gr, phic, CAST(phic AS DECIMAL(10,2)) AS ph, phic1, CAST(phic1 AS DECIMAL(10,2)) AS ph1, hmo, CAST(hmo AS DECIMAL(10,2)) AS hm, excess, CAST(excess AS DECIMAL(10,2)) AS ex, productsubtype, administration, terminalname, status FROM productout WHERE caseno='$caseno' AND trantype='charge' AND quantity > 0 $alloth AND productsubtype NOT LIKE 'PROFESSIONAL FEE' ORDER BY productsubtype, productdesc, datearray");
...
echo "
    <tr>
      ...
      <td class='b1 l1 $bg'><div align='left' class='arial s16 black' title='$rmaeinvno'>&nbsp;$rmaedesc&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='left' class='arial s16 black'>&nbsp;$rmaeptype&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='center' class='arial s16 black'>&nbsp;$rmaestat&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='left' class='arial s16 black'>&nbsp;&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$rmaesp&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$rmaeqty&nbsp;</div></td>
      <td class='b1 l1 $bg $errdisrm'><div align='right' class='arial s16 black $errdisrm'>&nbsp;$rmaeadj&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$rmaegross&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$rmaephic&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$rmaephic1&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$rmaehmo&nbsp;</div></td>
      <td class='b1 l1 r2 $bg'><div align='right' class='arial s16 black'>&nbsp;$rmaeexcess&nbsp;</div></td>
    </tr>
...
//PF-------------------------------------------------------------------------------------------------------------------------------------------------
$pfaeposql=mysqli_query($mycon1,"SELECT refno, productcode, productdesc, sellingprice, CAST(sellingprice AS DECIMAL(10,2)) AS sp, quantity, adjustment, CAST(adjustment AS DECIMAL(10,2)) AS adj, gross, CAST(gross AS DECIMAL(10,2)) AS gr, phic, CAST(phic AS DECIMAL(10,2)) AS ph, phic1, CAST(phic1 AS DECIMAL(10,2)) AS ph1, hmo, CAST(hmo AS DECIMAL(10,2)) AS hm, excess, CAST(excess AS DECIMAL(10,2)) AS ex, producttype, productsubtype, administration, terminalname, status FROM productout WHERE caseno='$caseno' AND trantype='charge' AND quantity > 0 AND productsubtype='PROFESSIONAL FEE' ORDER BY productsubtype, productdesc, datearray");
...
echo "
    <tr>
      ...
      <td class='b1 l1 $bg'><div align='left' class='arial'>&nbsp;<span class='s16 black'>$pfaedesc</span> <span class='s13 blue'>($pfaeprotype)</span>&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='left' class='arial s16 black'>&nbsp;$pfaeptype&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='center' class='arial s16 black'>&nbsp;$pfaestat&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='left' class='arial s16 black'>&nbsp;&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$pfaesp&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$pfaeqty&nbsp;</div></td>
      <td class='b1 l1 $bg $errdispf'><div align='right' class='arial s16 black $errdispf'>&nbsp;$pfaeadj&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$pfaegross&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$pfaephic&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$pfaephic1&nbsp;</div></td>
      <td class='b1 l1 $bg'><div align='right' class='arial s16 black'>&nbsp;$pfaehmo&nbsp;</div></td>
      <td class='b1 l1 r2 $bg'><div align='right' class='arial s16 black'>&nbsp;$pfaeexcess&nbsp;</div></td>
    </tr>
