...
echo "
            ...
            <td><table border='0' cellpadding='0' cellspacing='0'>
              ...
              <tr>
                <td></td>
                <td class='tahoma s10 black bold b1' align='center'><div $cursty onclick='openconsent()'>".strtoupper($rep[0])."</div></td>
              </tr>
              <tr>
                <td></td>
                ...
                <td width='55%'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                  <tr>
                    <td><table border='0'cellpadding='0' cellspacing='0'>
                      <tr>
                        <td width='27'></td>
                        <td class='Tahoma09black' align='center' ><div $cursty onclick='openconsent()'>Date Signed:</div></td>
                          ...
                          <tr>
                            ...
                            <td><table border='0' cellpadding='0' cellspacing='0'>
                              <tr>
                                ...
                                <td class='Tahoma09black'>&nbsp;Others, Spcify</td>
                              </tr>
                            </table></td>
                            <td><table border='0' cellpadding='0' cellspacing='0'>
                              <tr>
                                <td class='Tahoma09black b1'></td>
                              </tr>
                            </table></td>
                          </tr>
