...
echo "
      <tr>
        ...
        <td><input type='text' placeholder='Generic Name' name='description' value='$description' autocomplete='off' required /></td>
      </tr>
      <tr>
        <td><div align='left' class='s14'>Brand Name</div></td>
        <td width='10'><div align='center' class='s14'>:</div></td>
        <td><input type='text' placeholder='Brand Name' name='generic' value='$generic' autocomplete='off' $genreq /></td>
      </tr>
";
    }
    else{
...
echo "
      ...
      <tr>
        ...
        <td width='10'><div align='center' class='s14'>:</div></td>
        <td><input type='number' step='0.01' placeholder='Cash Price' name='cash' value='$cash' autocomplete='off' /></td>
      </tr>
      <tr>
        <td><div align='left' class='s14'>Charge</div></td>
        <td width='10'><div align='center' class='s14'>:</div></td>
        <td><input type='number' step='0.01' placeholder='Charge Price' name='charge' value='$charge' autocomplete='off' /></td>
      </tr>
      <tr>
