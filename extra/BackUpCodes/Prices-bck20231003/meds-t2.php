...
if($dept=="PHARMACY"){$dps1="selected";$dps2="";$dps3="";}
else if($dept=="PHARMACY_OPD"){$dps1="";$dps2="selected";$dps3="";}
else if($dept=="CPU"){$dps1="";$dps2="";$dps3="selected";}
else{$dps1="";$dps2="";$dps3="";}

if(isset($_POST['testcode'])){$testcode=mysqli_real_escape_string($conn,$_POST['testcode']);}
else{$testcode="3";}

if($testcode=="0"){$gtcs1="selected";$gtcs2="";$gtcs3="";$qtes="AND r.`testcode`='0'";}
else if($testcode=="1"){$gtcs1="";$gtcs2="selected";$gtcs3="";$qtes="AND r.`testcode`='1'";}
else if($testcode=="All"){$gtcs1="";$gtcs2="";$gtcs3="selected";$qtes="AND (r.`testcode`='0' OR r.`testcode`='1')";}
else{$gtcs1="";$gtcs2="";$gtcs3="selected";$qtes="AND r.`testcode`='3'";}
                                ...
                                <form method='post'>
                                  <table border='0' cellpadding='0' cellspacing='0'>
                                    <tr>
                                      ...
                                      <td width='5'></td>
                                      <td>
                                        <select name='testcode' class='searchme' style='padding: 5px;height: 30px;border: 2px solid #000000;border-radius: 5px;font-size: 15px;font-weight: bold;'>
                                          <option $gtcs3>All</option>
                                          <option value='0' $gtcs1>NON-MDRP</option>
                                          <option value='1' $gtcs2>MDRP</option>
                                        </select>
                                      </td>
                                      <td width='5'></td>
                                ...
                                <table border='0' cellpadding='0' cellspacing='0'>
                                  ...
                                  <tr>
                                    <td><div align='center' style='padding: 10px 0;font-family: arial;color: #000000;'>
                                      <span style='font-size: 15px;font-weight: bold;'>$dept MEDICINE PRICE LIST</span><br />
                                    ...
                                    <td>
                                      <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                                        <tr>
                                          ...
                                          <td bgcolor='3380ff' width='100' class='t2 b2 l1' rowspan='2'><div align='center' class='arial s12 white bold' style='padding: 2px 3px;'>MDRP</div></td>
...
";
    ...
    while($zxfetch=mysqli_fetch_array($zxsql)){
      ...
      $tesdis="";
      if($tes=="0"){$tesdis="NON-MDRP";}
      else if($tes=="1"){$tesdis="MDRP";}
...
echo "
                                        <tr>
                                          ...
                                          <td class='b1 l1'><div align='left' style='font-family: arial;font-size; 13px;color: #000000;padding: 2px 4px;'>$itd$itgdis</div></td>
