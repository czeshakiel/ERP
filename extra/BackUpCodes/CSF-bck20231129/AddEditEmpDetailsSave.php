...
if($show=="on"){
  $emppen=mysql_real_escape_string($_POST['emppen']);
  $empbusinessname=strtoupper(trim(mysql_real_escape_string($_POST['empbusinessname'])));
  $empcontactno=strtoupper(trim(mysql_real_escape_string($_POST['empcontactno'])));
  $empname=strtoupper(trim(mysql_real_escape_string($_POST['empname'])));
  $empsigdesignation=strtoupper(trim(mysql_real_escape_string($_POST['empsigdesignation'])));
  ...
  if($acount==0){
    mysql_query("INSERT INTO `claiminfomoreinfo` (`caseno`, `emppen`, `empbusinessname`, `empname`, `empcontactno`, `empsigdesignation`, `empdatesigned`) VALUES ('$caseno', '$emppen', '$empbusinessname', '$empname', '$empcontactno', '$empsigdesignation', '$da')");
    ...
    mysql_query("UPDATE `claiminfomoreinfo` SET `emppen`='$emppen', `empbusinessname`='$empbusinessname', `empname`='$empname', `empcontactno`='$empcontactno', `empsigdesignation`='$empsigdesignation', `empdatesigned`='$da' WHERE `caseno`='$caseno'");
  ...
  mysql_query("UPDATE `admission` SET `type`='$type' WHERE `caseno`='$caseno'");
  ...
  if($acount!=0){
    mysql_query("UPDATE `claiminfomoreinfo` SET `emppen`='', `empbusinessname`='', `empname`='', `empcontactno`='', `empsigdesignation`='', `empdatesigned`='' WHERE `caseno`='$caseno'");
  }
