...
if($acount==0){
  mysql_query("INSERT INTO `claiminfoadd2` (`caseno`, `doctor7`, `datesigned7`, `copay7`, `doctor8`, `datesigned8`, `copay8`, `doctor9`, `datesigned9`, `copay9`) VALUES ('$caseno', '$doc4', '$da4', '$ex4', '$doc5', '$da5', '$ex5', '$doc6', '$da6', '$ex6')");

  $inlog="$loguser |  ('$caseno', '$doc4', '$da4', '$ex4', '$doc5', '$da5', '$ex5', '$doc6', '$da6', '$ex6')";
}
else{
    mysql_query("UPDATE `claiminfoadd2` SET `doctor7`='$doc4', `datesigned7`='$da4', `copay7`='$ex4', `doctor8`='$doc5', `datesigned8`='$da5', `copay8`='$ex5', `doctor9`='$doc6', `datesigned9`='$da6', `copay9`='$ex6' WHERE `caseno`='$caseno'");
