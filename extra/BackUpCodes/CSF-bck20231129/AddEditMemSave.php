...
$identificationno=mysql_real_escape_string($_POST['identificationno']);
...
if($acount==0){
mysql_query("INSERT INTO `claiminfo` (`patientidno`, `caseno`, `lastname`, `firstname`, `middlename`, `identificationno`) VALUES ('$patientidno', '$caseno', '$lastname', '$firstname', '$middlename', '$identificationno')");
}
else{
mysql_query("UPDATE `claiminfo` SET `lastname`='$lastname', `firstname`='$firstname', `middlename`='$middlename', `identificationno`='$identificationno' WHERE patientidno='$patientidno' AND caseno='$caseno'");
}
...
mysql_query("UPDATE `admission` SET paymentmode='$paymentmode' WHERE caseno='$caseno'");
