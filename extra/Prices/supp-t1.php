<?php
    ...
    if($deptval=="CSR2"){$dps1="selected";$dps2="";$dps3="";$dps4="";$dps5="";}
    else if($deptval=="PHARMACY"){$dps1="";$dps2="selected";$dps3="";$dps4="";$dps5="";}
    else if($deptval=="PHARMACY_OPD"){$dps1="";$dps2="";$dps3="selected";$dps4="";$dps5="";}
    else if($deptval=="CSR"){$dps1="";$dps2="";$dps3="";$dps4="selected";$dps5="";}
else if($deptval=="CPU"){$dps1="";$dps2="";$dps3="";$dps4="";$dps5="selected";}
    else{$dps1="";$dps2="";$dps3="";$dps4="";$dps5="";}
                      ...
                      <tr>
                        <td><div align='left'>
                          <form method='post'>
                            <table border='0' cellpadding='0' cellspacing='0'>
                              <tr>
                                <td><input type='text' name='searchme' class='searchme' style='padding: 5px;height: 25px;width: 400px;border: 2px solid #000000;border-radius: 5px;font-size: 15px;font-weight: bold;' value='$searchmeval' placeholder='SEARCH ITEM NAME' autofocus/></td>
                                <td width='5'></td>
                                <td>
                                  <select name='dept' class='searchme' style='padding: 5px;height: 38px;border: 2px solid #000000;border-radius: 5px;font-size: 15px;font-weight: bold;'>
                                    ...
                                    <option value='CPU' $dps5>CPU</option>
