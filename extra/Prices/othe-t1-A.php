...
echo "
                                  <button type='button' name='edt' class='btn' title='Edit'"; ?> onclick="<?php echo "window.open('ms/?code=$cod".$usr."', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=30,left=700,width=480,height=$ht');";?>" <?php echo ">&#x270E;</button>
";
          }
...
echo "
                              <tr>
                                <td class='t2' colspan='8'><div align='center' style='padding: 3px 5px;'>
