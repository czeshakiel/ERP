...
if($acount==0){
  mysqli_query($conn,"INSERT INTO `claiminfoadd2` (`caseno`, `doctor4`, `datesigned4`, `copay4`, `doctor5`, `datesigned5`, `copay5`, `doctor6`, `datesigned6`, `copay6`) VALUES ('$caseno', '$doc4', '$da4', '$ex4', '$doc5', '$da5', '$ex5', '$doc6', '$da6', '$ex6')");

  $inlog="$loguser |  ('$caseno', '$doc4', '$da4', '$ex4', '$doc5', '$da5', '$ex5', '$doc6', '$da6', '$ex6')";
}
else{
    mysqli_query($conn,"UPDATE `claiminfoadd2` SET `doctor4`='$doc4', `datesigned4`='$da4', `copay4`='$ex4', `doctor5`='$doc5', `datesigned5`='$da5', `copay5`='$ex5', `doctor6`='$doc6', `datesigned6`='$da6', `copay6`='$ex6' WHERE `caseno`='$caseno'");
