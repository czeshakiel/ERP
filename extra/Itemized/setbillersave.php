...
$name=mysqli_real_escape_string($mycon1,$_POST['name']);
...
if($setucount==0){
  ...
  mysqli_query($mycon1,"INSERT INTO `setuser` (`caseno`, `name`) VALUES ('$caseno', '$name')");
}
else{
  ...
  mysqli_query($mycon1,"UPDATE `setuser` SET `name` = '$name' WHERE `caseno` = '$caseno'");
}
