      ...
      <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
        <tr>
          <td><table border='0' width='100%' cellpadding='0' cellspacing='0'>
            <tr>
              <td width='110' rowspan='5'><div align='center'><a href='LabelManagement.php' style='text-decoration: none;' target='_blank'><img src='../../image/logo/logo.png' height='100' width='auto' /></a></div></td>
...
echo "
            <tr>
              <td class='t1 b1 l2'><div align='center' class='times s11 black'>&nbsp;$acctitle - $ofr - $date</div></td>
              <td class='t1 b1' colspan='6'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black'>&nbsp;".number_format($amount,2)."&nbsp;</div></td>
            </tr>
";
...
echo "
            <tr>
              <td class='t1 b1 l2'><div align='center' class='times s11 black'>&nbsp;CASHONHAND - $ofr - $date</div></td>
              <td class='t1 b1' colspan='6'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black'>&nbsp;".number_format($amount,2)."&nbsp;</div></td>
            </tr>
";
...
echo "
            <tr>
              <td class='t1 b1 l2'><div align='center' class='times s11 black'>&nbsp;$acctitle - $description - $date</div></td>
              <td class='t1 b1' colspan='6'></td>
              <td class='t1 b1 l1 r2'><div align='right' class='times s11 black'>&nbsp;".number_format($amount,2)."&nbsp;</div></td>
            </tr>
";
