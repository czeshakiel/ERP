...
$hthmo=0;
$alloth="";
$stsql=mysqli_query($mycon1,"SELECT `autono`, `label` FROM `soasetup` WHERE `label`='$label'");
...
//END ALL OTHERS---------------------------------------------------------------------------------------------------------------------------
    ...
    $allothpf="";
    $allotpfsql=mysqli_query($mycon1,"SELECT `producttype` FROM `soasetupdetails` WHERE `productsubtype`='PROFESSIONAL FEE' GROUP BY `producttype`");
...
echo "
  ...
  <table border='0' cellpadding='0' cellspacing='0' class='hoverTable'>
    <tr>
      ...
      <td class='t2 b2 l1'><div align='center' class='courier s11 black bold'>&nbsp;P.A.N.&nbsp;</div></a></td>
...
";
    ...
    while($apofetch=mysqli_fetch_array($aposql)){
      ...
      $pfpacsql=mysqli_query($mycon1,"SELECT `phicacc` FROM `docfile` WHERE `code`='$apcode'");
...
echo "
    <tr>
      ...
      <td class='b1 l1' height='20'><div align='center' class='courier s12 black'>&nbsp;$phicacc&nbsp;</div></td>
...
echo "
    <tr>
      <td class='t2 b2 l2' height='30' colspan='5'><div align='left' class='courier s12 black bold'>&nbsp;Sub Total</div></td>
