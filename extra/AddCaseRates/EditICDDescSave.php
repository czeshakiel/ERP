...
$desccf2=strtoupper(mysqli_real_escape_string($mycon1,$_POST['desccf2']));
...
mysqli_query($mycon1,"UPDATE `finalcaserate` SET `description`='$desccf2' WHERE `autono`='$editauto'");
