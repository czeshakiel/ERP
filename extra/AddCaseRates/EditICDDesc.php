...
$editauto=mysqli_real_escape_string($mycon1,$_GET['editauto']);

$asql=mysqli_query($mycon1,"SELECT `icdcode`, `type`, `description`, `desccf2` FROM `finalcaserate` WHERE `autono`='$editauto'");
$afetch=mysqli_fetch_array($asql);
$icdcode=$afetch['icdcode'];
$type=$afetch['type'];
$desccf2=$afetch['description'];
...
<div align='center'>
  <table style='height:100%;width:100%; position: absolute; top: 0; bottom: 0; center: 0; right: 0;' border='0' cellpadding='0' cellspacing='0'>
    <tr>
      <td><div align='center'>
        <form name='Save' method='post' action='EditICDDescSave.php' class='form-container-Edit' id='document'>
          <table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td><div align='center' class='arial s20 blue bold'>Edit Description</div></td>
            </tr>
            <tr>
              <td height='10'></td>
            </tr>
...
echo '
                    <textarea name="desccf2" onkeypress="return handleEnter(this, event)" style="width: 250px;height: 100px;">'.$desccf2.'</textarea>
';
