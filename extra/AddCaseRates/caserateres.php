...
$statem="SELECT * FROM `caserates` WHERE `icdcode` LIKE '%$searchme%' AND (`category`='medical' OR `category`='surgical' OR `category`='additional') ORDER BY `icdcode`";
...
<div align='left'>
  <table border='0' cellpadding='0' cellspacing='0'>
    ...
    <tr>
      <td><div align='center' class='btnstyle'><button type='button' class='btnadd' title='Add'"; ?> onclick="<?php echo "window.open('AddICDToList.php?user=$user&icdcode=$searchme', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=700,width=450,height=800');";?>" <?php echo ">Add Now?</button></div></td>
    </tr>
  </table>
</div>
";
...
echo "
    <tr>
      ...
      <td width='3' class='b1'></td>
      <td class='b1 l1 r2'><div align='center' class='btnstyle'><button type='button' class='btn import' title='Edit'"; ?> onclick="<?php echo "window.open('AddICDRVS.php?user=$user&idno=$idno', '_blank', 'toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=700,width=450,height=800');";?>" <?php echo ">E</button></div></td>
    </tr>
";
}
