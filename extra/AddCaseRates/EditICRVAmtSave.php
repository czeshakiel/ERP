...
$hospitalshare=mysqli_real_escape_string($mycon1,$_POST['hospitalshare']);
$pfshare=mysqli_real_escape_string($mycon1,$_POST['pfshare']);
...
mysqli_query($mycon1,"UPDATE `finalcaserate` SET `hospitalshare`='$hospitalshare', `pfshare`='$pfshare' WHERE `autono`='$editauto'");
