...
<title><?php include("../Settings.php"); $cuz = new database(); mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass()); mysql_select_db($cuz->getDB()); $snamesql=mysql_query("SELECT * FROM heading"); while($snamefetch=mysql_fetch_array($snamesql)){$sname=$snamefetch['heading'];$address=$snamefetch['address'];} echo ""; ?>Claim Signature Form</title>
<link href="CSS/style-white.css" rel="stylesheet" type="text/css" />
<link rel="shortcut icon" href="Favicon/favicon.png" type="image/png" />
<style>
<!--
.arial09blackrel {font-family: Arial;font-size: 9px;color: #000000;}
.arial09blackboldrel {font-family: Arial;font-size: 9px;font-weight: bold;color: #000000;}
.arial10blackrel {font-family: Arial;font-size: 10px;color: #000000;}
.arial10blackboldrel {font-family: Arial;font-size: 10px;font-weight: bold;color: #000000;}
.arial11blackrel {font-family: Arial;font-size: 11px;color: #000000;}
.arial11blackboldrel {font-family: Arial;font-size: 11px;font-weight: bold;color: #000000;}
.arial12blackrel {font-family: Arial;font-size: 12px;color: #000000;}
.arial12blackboldrel {font-family: Arial;font-size: 12px;font-weight: bold;color: #000000;}
-->
</style>
</head>
...
$showad=$cimifetch['showad'];
$showdd=$cimifetch['showdd'];
$showpin=$cimifetch['showpin'];
$showcomn=$cimifetch['showcomn'];
$showcomds=$cimifetch['showcomds'];
$showcomrel=$cimifetch['showcomrel'];
$showcomres=$cimifetch['showcomres'];
$showcomuw=$cimifetch['showcomuw'];
$showempp=$cimifetch['showempp'];
$showempbn=$cimifetch['showempbn'];
$showempn=$cimifetch['showempn'];
$showempc=$cimifetch['showempc'];
$showempd=$cimifetch['showempd'];
$showempds=$cimifetch['showempds'];
$showcarn=$cimifetch['showcarn'];
$showcards=$cimifetch['showcards'];
$showcarrel=$cimifetch['showcarrel'];
$showcarres=$cimifetch['showcarres'];
$showcaruw=$cimifetch['showcaruw'];
$showdsd1=$cimifetch['showdsd1'];
$showdsd2=$cimifetch['showdsd2'];
$showdsd3=$cimifetch['showdsd3'];
}
}
...
if(($showcomrel=="y")||($showcomrel=="")){
if($comchoose=="M"){
if($comrelation=="Spouse"){$comrtm1="";$comrtm2="";$comrtm3="";$comrtm4="";$comrtm5="";$comrtmos="";}
else if($comrelation=="Child"){$comrtm1="";$comrtm2="";$comrtm3="";$comrtm4="";$comrtm5="";$comrtmos="";}
else if($comrelation=="Parent"){$comrtm1="";$comrtm2="";$comrtm3="";$comrtm4="";$comrtm5="";$comrtmos="";}
else if($comrelation=="Sibling"){$comrtm1="";$comrtm2="";$comrtm3="";$comrtm4="";$comrtm5="";$comrtmos="";}
...
else{$comrtm1="";$comrtm2="";$comrtm3="";$comrtm4="";$comrtm5="&#10004;";$comrtmos="<u>".$comrelationos."</u>";}
}
else{
if($comrelation=="Spouse"){$comrtm1="";$comrtm2="";$comrtm3="";$comrtm4="";$comrtm5="";$comrtmos="";}
else if($comrelation=="Child"){$comrtm1="";$comrtm2="";$comrtm3="";$comrtm4="";$comrtm5="";$comrtmos="";}
...
if($comreason=="1"){$comres1="&#10004;";$comres2="";$comreso="";}
else if($comreason=="2"){$comres1="";$comres2="&#10004;";$comreso="<u>".$comreasonos."</u>";}
else{$comres1="";$comres2="";$comreso="";}
}
else{
if($comreason=="1"){$comres1="";$comres2="";$comreso="";}
...
if(($showcomuw=="y")||($showcomuw=="")){
if($comuw=="1"){$comuw1="&#10004;";$comuw2="";}
else if($comuw=="2"){$comuw1="";$comuw2="&#10004;";}
else{$comuw1="";$comuw2="";}
}
else{
$comuw1="";$comuw2="";
...
if(($showcarrel=="y")||($showcarrel=="")){
if($carchoose=="M"){
if($carrelation=="Spouse"){$carrtm1="";$carrtm2="";$carrtm3="";$carrtm4="";$carrtm5="";$carrtmos="";}
else if($carrelation=="Child"){$carrtm1="";$carrtm2="";$carrtm3="";$carrtm4="";$carrtm5="";$carrtmos="";}
else if($carrelation=="Parent"){$carrtm1="";$carrtm2="";$carrtm3="";$carrtm4="";$carrtm5="";$carrtmos="";}
else if($carrelation=="Sibling"){$carrtm1="";$carrtm2="";$carrtm3="";$carrtm4="";$carrtm5="";$carrtmos="";}
...
else{$carrtm1="";$carrtm2="";$carrtm3="";$carrtm4="";$carrtm5="&#10004;";$carrtmos="<u>".$carrelationos."</u>";}
}
else{
if($carrelation=="Spouse"){$carrtm1="";$carrtm2="";$carrtm3="";$carrtm4="";$carrtm5="";$carrtmos="";}
else if($carrelation=="Child"){$carrtm1="";$carrtm2="";$carrtm3="";$carrtm4="";$carrtm5="";$carrtmos="";}
...
if(($showcarres=="y")||($showcarres=="")){
if($carchoose=="M"){
if($carreason=="1"){$carres1="";$carres2="";$carresos="";}
else if($carreason=="2"){$carres1="";$carres2="";$carresos="";}
else{$carres1="";$carres2="";$carresos="";}
}
else if($carchoose=="R"){
if($carreason=="1"){$carres1="&#10004;";$carres2="";$carresos="";}
else if($carreason=="2"){$carres1="";$carres2="&#10004;";$carresos="<u>".$carreasonos."</u>";}
else{$carres1="";$carres2="&#10004;";$carresos="<u>".$carreasonos."</u>";}
}
else{
if($carreason=="1"){$carres1="";$carres2="";$carresos="";}
else if($carreason=="2"){$carres1="";$carres2="";$carresos="";}
...
if(($showcaruw=="y")||($showcaruw=="")){
if($caruw=="1"){$caruw1="&#10004;";$caruw2="";}
else if($caruw=="2"){$caruw1="";$caruw2="&#10004;";}
else{$caruw1="";$caruw2="";}
}
else{
$caruw1="";$caruw2="";
  ...
  <table width='700' border='0' cellpadding='0' cellspacing='0' bordercolor='#000000'>
    ...
    <tr>
      <td><table width='100%' boreder='0' cellpadding='0' cellspacing='0'>
        <tr>
          <td width='50%' height='78' valign='top' ><div align='left'><img src='Image/LogoWhite.jpg' height='76' width='auto' /></div></td>
          ...
          <td width='auto'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='auto'><table cellpadding='0' cellspacing='0'>
                <tr>
                  <td width='11' height='11' class='table1Bottom1Left1Right'><div align='center' class='arial12blackrel'>".$phicmember0."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember1."</div></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                  <td width='11' height='11' class='table1Bottom1Left1Right'><div align='center' class='arial12blackrel'>".$phicmember3."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember4."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember5."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember6."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember7."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember8."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember9."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember10."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$phicmember11."</div></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                  <td width='11' height='11' class='table1Bottom1Left1Right'><div align='center' class='arial12blackrel'>".$phicmember13."</div></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
...
echo "
        <tr>
          ...
          <td width='auto'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              <td height='22' class='table1Bottom' valign='bottom'><div align='left' class='arial11blackbold'>".strtoupper($LN).", ".strtoupper($FN)." ".strtoupper($MN)." ".strtoupper($MS)."</div></td>
              <td></td>
            </tr>
            <tr>
...
echo "
        <tr>
          ...
          <td width='auto'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              <td height='22' class='table1Bottom' valign='bottom'><div align='left' class='arial11blackbold'>".strtoupper($LNPat).", ".strtoupper($FNPat)." ".strtoupper($MNPat)." ".strtoupper($MNSuf)."</div></td>
              <td></td>
          ...
          <td width='auto'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              ...
              <td width='20%' valign='bottom'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$dateadmittedarr0."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$dateadmittedarr1."</div></td>
                    </tr>
                  </table></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$dateadmittedarr3."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$dateadmittedarr4."</div></td>
                    </tr>
                  </table></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$dateadmittedarr6."</div></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$dateadmittedarr7."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$dateadmittedarr8."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$dateadmittedarr9."</div></td>
                    </tr>
                  </table></td>
                </tr>
              </table></div></td>
              ...
              <td width='20%' valign='bottom'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$datedischargedarr0."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$datedischargedarr1."</div></td>
                    </tr>
                  </table></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$datedischargedarr3."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$datedischargedarr4."</div></td>
                    </tr>
                  </table></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$datedischargedarr6."</div></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$datedischargedarr7."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$datedischargedarr8."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>".$datedischargedarr9."</div></td>
                    </tr>
                  </table></td>
                </tr>
              </table></div></td>
            ...
            <tr>
              <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  ...
                  <td width='32%' height='15' class='table1Bottom'><div align='center' class='arial11blackrel'>$comnamem</div></td>
                  <td width='5%' height='15'></td>
                  <td width='39%' height='15' class='table1Bottom'><div align='center' class='arial11blackrel'>$comnamer</div></td>
                ...
                <tr>
                  ...
                  <td><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr01"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr11"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr31"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr41"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr61"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr71"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr81"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr91"."</div></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table></div></td>
                  ...
                  <td><div align='center'><table cellpadding='0' cellspacing='0'>
                    <tr>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr02"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr12"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr32"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr42"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr62"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr72"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr82"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$comdatearr92"."</div></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table></div></td>
                ...
                <tr>
                    ...
                    <tr>
                      <td height='25' valign='bottom'><div align='left'><table border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          ...
                          <td width='12' height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackbold'>$comuw1</div></td>
                          <td width='80' height='12' valign='bottom'><div align='left' class='arial09black'>&nbsp;Member</div></td>
                          <td width='12' height='12' class='table1Top1Bottom1Left1Right' valign='bottom'><div align='center' class='arial10blackbold'>$comuw2</div></td>
                  ...
                  <td width='30%'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      ...
                      <td width='12' height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$comrtm1</div></td>
                      <td width='40' height='12' valign='bottom'><div align='left' class='arial09black'>&nbsp;Spouse</div></td>
                      <td width='12' height='12' class='table1Top1Bottom1Left1Right' valign='bottom'><div align='center' class='arial10blackboldrel'>$comrtm2</div></td>
                      <td width='40' height='12' valign='bottom'><div align='left' class='arial09black'>&nbsp;Child</div></td>
                      <td width='12' height='12' class='table1Top1Bottom1Left1Right' valign='bottom'><div align='center' class='arial10blackboldrel'>$comrtm3</div></td>
                    ...
                    <tr>
                      <td height='12'></td>
                      <td height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$comrtm4</div></td>
                      <td height='12' valign='bottom'><div align='left' class='arial09black'>&nbsp;Sibling</div></td>
                      <td height='12' class='table1Top1Bottom1Left1Right' valign='bottom'><div align='center' class='arial10blackboldrel'>$comrtm5</div></td>
                      <td height='12' valign='bottom' colspan='3'><div align='left'><span class='arial09black'>&nbsp;Others, specify </span><span class='arial09blackrel'>$comrtmos</span></div></td>
                    </tr>
                    <tr>
                      <td height='2' colspan='7'></td>
                    </tr>
                    <tr>
                      <td height='12'></td>
                      <td height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$comres1</div></td>
                    ...
                    <tr>
                      <td height='12'></td>
                      <td height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$comres2</div></td>
                      <td height='12' valign='bottom' colspan='5'><div align='left'><span class='arial09black'>&nbsp;Other reasons </span><span class='arial09blackrel'>$comreso</span></div></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td>
        ...
        <tr>
          ...
          <td width='auto'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='auto'><table cellpadding='0' cellspacing='0'>
                <tr>
                  <td width='11' height='11' class='table1Bottom1Left1Right'><div align='center' class='arial12blackrel'>".$pen0."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen1."</div></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                  <td width='11' height='11' class='table1Bottom1Left1Right'><div align='center' class='arial12blackrel'>".$pen3."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen4."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen5."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen6."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen7."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen8."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen9."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen10."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right'><div align='center' class='arial12blackrel'>".$pen11."</div></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                  <td width='11' height='11' class='table1Bottom1Left1Right'><div align='center' class='arial12blackrel'>".$pen13."</div></td>
                </tr>
              </table></td>
              <td width='2%'></td>
              <td width='auto'><div align='left' class='arial09black'>2. Contact No.:</div></td>
              <td width='20%' class='table1Bottom'><div align='left' class='arial10blackrel'>$employercontactno</div></td>
              <td width='10%'></td>
            </tr>
          </table></td>
          <td width='2'></td>
        ...
        <tr>
          ...
          <td width='auto'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='auto' class='table1Bottom'><div align='center' class='arial10blackboldrel'>$employerbusname</div></td>
              <td width='10%'></td>
            </tr>
            <tr>
              <td></td>
...
echo "
        <tr>
          ...
          <td width='auto'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td width='45%' height='22' class='table1Bottom'><div align='center' class='arial10blackrel'>$employername</div></td>
              <td width='2%' height='20'></td>
              <td width='25%' height='20' class='table1Bottom'><div align='center' class='arial10blackrel'>$employerdesignation</div></td>
              <td width='2%' height='20'></td>
              <td width='auto' height='20' valign='bottom'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$empdatesiarr0"."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$empdatesiarr1"."</div></td>
                    </tr>
                  </table></td>
                  <td width='15' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$empdatesiarr3"."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$empdatesiarr4"."</div></td>
                    </tr>
                  </table></td>
                  <td width='15' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$empdatesiarr6"."</div></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$empdatesiarr7"."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$empdatesiarr8"."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$empdatesiarr9"."</div></td>
                    </tr>
                  </table></td>
                </tr>
              </table></div></td>
        ...
        <tr>
          ...
          <td width='auto'><div align='left'><table border='0' cellpadding='0' cellspacing='0'>
            <tr>
              ...
              <td width='auto' height='20' class='table1Bottom'><div align='center' class='arial10blackrel'>$consentaccname</div></td>
            </tr>
            <tr>
              <td></td>
            ...
            <tr>
              ...
              <td><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$consentaccsiarr0"."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$consentaccsiarr1"."</div></td>
                    </tr>
                  </table></td>

                  <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$consentaccsiarr3"."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$consentaccsiarr4"."</div></td>
                    </tr>
                  </table></td>
                  <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$consentaccsiarr6"."</div></td>

                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$consentaccsiarr7"."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$consentaccsiarr8"."</div></td>
                    </tr>

                  </table></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$consentaccsiarr9"."</div></td>
                    </tr>
                  </table></td>
                </tr>
              </table></div></td>
            ...
            <tr>
              ...
              <td width='30%'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  ...
                  <td width='12' height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$carrtm1</div></td>
                  <td width='40' height='12' valign='bottom'><div align='left' class='arial09black'>&nbsp;Spouse</div></td>
                  <td width='12' height='12' class='table1Top1Bottom1Left1Right' valign='bottom'><div align='center' class='arial10blackboldrel'>$carrtm2</div></td>
                  <td width='40' height='12' valign='bottom'><div align='left' class='arial09black'>&nbsp;Child</div></td>
                  <td width='12' height='12' class='table1Top1Bottom1Left1Right' valign='bottom'><div align='center' class='arial10blackboldrel'>$carrtm3</div></td>
                  <td width='auto' height='12' valign='bottom'><div align='left' class='arial09black'>&nbsp;Parent</div></td>
                </tr>
                <tr>
                  <td height='2' colspan='7'></td>
                ...
                <tr>
                  <td height='10'></td>
                  <td height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$carrtm4</div></td>
                  <td height='12' valign='bottom'><div align='left' class='arial09black'>&nbsp;Sibling</div></td>
                  <td height='12' class='table1Top1Bottom1Left1Right' valign='bottom'><div align='center' class='arial10blackboldrel'>$carrtm5</div></td>
                  <td height='12' valign='bottom' colspan='3'><div align='left'><span class='arial09black'>&nbsp;Others, specify </span><span class='arial09blackrel'>$carrtmos</span></div></td>
                </tr>
                <tr>
                  <td height='2' colspan='7'></td>
                </tr>
                <tr>
                  <td height='10'></td>
                  <td height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$carres1</div></td>
                ...
                <tr>
                  <td height='10'></td>
                  <td height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$carres2</div></td>
                  <td height='12' valign='bottom' colspan='5'><div align='left'><span class='arial09black'>&nbsp;Other reasons </span><span class='arial09blackrel'>$carresos</span></div></td>
                </tr>
              </table></td>
              <td width='2%'></td>
                ...
                <tr>
                  <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      ...
                      <td width='12' height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$caruw1</div></td>
                      <td width='auto' height='12'><div align='left' class='arial09black'>&nbsp;Patient</div></td>
                      <td width='12' height='12' class='table1Top1Bottom1Left1Right'><div align='center' class='arial10blackboldrel'>$caruw2</div></td>
...
mysql_connect($cuz->myHost(),$cuz->getUser(),$cuz->getPass());
mysql_select_db($cuz->getDB());
$dfsql=mysql_query("SELECT phicacc FROM docfile WHERE name='$dcname'");
...
if(($showdsd3=="y")||($showdsd3=="")){
if(($datesigned3!="")&&($datesigned2!="0000-00-00")){
            ...
            <tr>
              <td width='50%' valign='top'><div align='center'><table border'0' cellpadding='0' cellspacing='0'>
                <tr>
                  ...
                  <td><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa10"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa11"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa12"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa13"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa15"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa16"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa17"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa18"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa19"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa110"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa111"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                      <td width='11' height='11' class='table1Bottom1Left1Right' valign='bottom'><div align='center' class='arial12black'>"."$pa113"."</div></td>
                    </tr>
                  </table></div></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan='2' height='15' class='table1Bottom'><div align='center' class='arial10black'>".strtoupper($pfname1)."</div></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan='2'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr0"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr1"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr3"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr4"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr6"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr7"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr8"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr9"."</div></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table></div></td>
              ...
              <td width='50%' valign='top'><div align='center'><table border'0' cellpadding='0' cellspacing='0'>
                <tr>
                  ...
                  <td><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa20"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>

                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa21"."</div></td>
                        </tr>
                      </table></td>

                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa22"."</div></td>
                        </tr>

                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa23"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>

                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa25"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>

                        <tr>

                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa26"."</div></td>
                        </tr>
                      ...
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        ...
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa27"."</div></td>
                        </tr>
                      </table></td>

                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa28"."</div></td>
                        </tr>
                      ...
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          ...
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa29"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>

                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa210"."</div></td>
                        </tr>
                      ...
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          ...
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa211"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                      <td width='11' height='11' class='table1Bottom1Left1Right' valign='bottom'><div align='center' class='arial12black'>"."$pa213"."</div></td>
                    </tr>
                  </table></div></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan='2' height='15' class='table1Bottom'><div align='center' class='arial10black'>".strtoupper($pfname2)."</div></td>
                </tr>
                <tr>
                  <td colspan='2'><div align='center' class='arial09black'>Signature Over Printed Name</div></td>
                </tr>
                ...
                <tr>
                  <td colspan='2'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr20"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr21"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr23"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr24"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr26"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr27"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr28"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr29"."</div></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table></div></td>
            ...
            <tr>
              <td width='50%' valign='top'><div align='center'><table border'0' cellpadding='0' cellspacing='0'>
                <tr>
                  ...
                  <td><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa30"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa31"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa32"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa33"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa35"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa36"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa37"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa38"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa39"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa310"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$pa311"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                      <td width='11' height='11' class='table1Bottom1Left1Right' valign='bottom'><div align='center' class='arial12black'>"."$pa313"."</div></td>
                    </tr>
                  </table></div></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan='2' height='15' class='table1Bottom'><div align='center' class='arial10black'>".strtoupper($pfname3)."</div></td>
                </tr>
                <tr>
                  <td colspan='2'><div align='center' class='arial09black'>Signature Over Printed Name</div></td>
                </tr>
                ...
                <tr>
                  <td colspan='2'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr30"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr31"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>-</div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr33"."</div></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr34"."</div></td>
                        </tr>
                      </table></td>
                      <td width='13' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>-</span></div></td>
                      <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr36"."</div></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr37"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr38"."</div></td>
                        </tr>
                      </table></td>
                      <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                        <tr>
                          <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12blackrel'>"."$pfdatesiarr39"."</div></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table></div></td>
    ...
    <tr>
      <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
        ...
        <tr>
          ...
          <td><table width='100%' border='0' cellpadding='0' cellspacing='0'>
            <tr>
              <td width='40%' class='table1Bottom'><div align='center' class='arial10black'>".strtoupper($hcirep)."</div></td>
              <td width='2%'></td>
              <td width='30%' class='table1Bottom'><div align='center' class='arial10black'>".strtoupper($hcidesignation)."</div></td>
              <td width='2%'></td>
              <td width='auto'><div align='center'><table border='0' cellpadding='0' cellspacing='0'>
                <tr>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$hcidtarr0"."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$hcidtarr1"."</div></td>
                    </tr>
                  </table></td>
                  <td width='25' height='11' class='table1Left1Left'><div align='center' class='arial12blackbold'>&nbsp;</div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$hcidtarr3"."</div></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$hcidtarr4"."</div></td>
                    </tr>
                  </table></td>
                  <td width='25' height='11' class='table1Left1Left'><div align='center'><span class='arial12blackbold'>&nbsp;</span></div></td>
                  <td width='11' height='11' class='table1Bottom1Left' valign='bottom'><div align='center' class='arial12black'>"."$hcidtarr6"."</div></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$hcidtarr7"."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$hcidtarr8"."</div></td>
                    </tr>
                  </table></td>
                  <td width='11' height='11' class='table1Bottom1Right' valign='bottom'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td height='9' class='table1Left' valign='bottom'><div align='center' class='arial12black'>"."$hcidtarr9"."</div></td>
                    </tr>
                  </table></td>
                </tr>
              </table></div></td>
