...
$cfasql=mysqli_query($conn,"SELECT `doctor7`, `datesigned7`, `copay7`, `doctor8`, `datesigned8`, `copay8`, `doctor9`, `datesigned9`, `copay9` FROM `claiminfoadd2` WHERE `caseno`='$caseno'");
