...
<div class="container-fluid px-0">
    <nav class="navbar navbar-expand-sm navbar-dark bg-black py-0 px-0">
        <a class="navbar-brand" href="#"><img id="logo" src="../main/img/ad.png"> &nbsp;&nbsp;&nbsp;MY CART</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="http://<?php echo $ip ?>/cgi-bin/wah/docmanual.cgi?caseno=<?php echo $caseno ?>&username=<?php echo $user ?>&userType=<?php echo $userType ?>&ticket=<?php echo $ticketno ?>&identity=Approved&dept=<?php echo $dept ?>" target="tabiframecart"><i class="icofont-doctor-alt"></i> Doctors</a></li>
                ...
                <?php if(stripos($caseno, "I-") === FALSE){ ?><a class="nav-link" href="../extra/Cart/?caseno=<?php echo $caseno ?>&toh=PACKAGE2023&station=<?php echo $dept ?>" target="tabiframecart"><i class="icofont-injection-package"></i> PACKAGES</a></li><?php } ?>
            </ul>
        </div>
    </nav>
</div>
    ...
    <iframe id='tabiframecart' name='tabiframecart' src='../extra/CartBeta/?caseno=<?php echo $caseno ?>&ct=sot&dept=<?php echo $dept ?>&user=<?php echo $userunique ?>&xix' width='100%' height='600px' style='border:0'></iframe>
