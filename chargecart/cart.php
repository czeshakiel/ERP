  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-black py-0 px-0" style="border-radius: 10px;">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <?php if((stripos($caseno, "I-") !== FALSE)&&($dept=="OR")){ ?><li class="nav-item"><a class="nav-link" href="../extra/Cart/?caseno=<?php echo $caseno ?>&toh=PACKAGE2022&station=<?php echo $dept ?>" target="tabiframecart"><i class="icofont-surgeon"></i> ENDO/COLO</a></li><?php } ?>
        <li class="nav-item"><a class="nav-link" href="../chargecart/pfposting.php?caseno=<?php echo $caseno ?>" target="tabiframecart"><i class="icofont-doctor-alt"></i> Doctors</a></li>
        <!-- li class="nav-item"><a class="nav-link" href="../extra/Cart/?caseno=<?php echo $caseno ?>&toh=PACKAGE2022&station=<?php echo $dept ?>" target="tabiframecart"><i class="icofont-surgeon"></i> ENDO/COLO</a></li -->
      </ul>
    </div>
  </nav>
</div>
