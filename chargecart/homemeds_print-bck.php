...
$sql2xxxz = "SELECT productcode, productdesc, sum(quantity) as quantity, refno, trantype  FROM productouthm WHERE caseno='$caseno' and administration='pending' $qr group by productcode";
