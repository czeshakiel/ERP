...
$radiologist = explode("_", $_POST['radiologist']);
...
$sql2g = "SELECT * FROM nsauthdoctors where empid='$radiologist[0]' order by name";
...
//==============
if ($trantype == "cash"){
$sql778 = $conn->query("insert into productout values('$coder','$todaytimex','$caseno','$empid','$radiologist[1]','$amtSum1','1','0','$amtSum1','NONE','0','0','$amtSum1','$localdate','PAID','$productcode','','$refno','READERS FEE','PROFESSIONAL FEE','','$refno','','$branch','','$todayx','')");
}

if ($trantype == "charge") {
$sql779 = $conn->query("insert into productout values('$coder','$todaytimex','$caseno','$empid','$radiologist[1]','$amtSum1','1','0','$amtSum1','NONE','0','$amtSum1','0','$localdate','Approved','$productcode','','$refno','READERS FEE','PROFESSIONAL FEE','','$refno','','$branch','','$todayx','')");
}
//==============

$sql777 = $conn->query("insert into readersfee values('$maxid','$caseno','$coder','$productcode','$radiologist[1]','$empid','$todayx','$refno','$amtSum1','$opdprice','$senior','PROFESSIONAL FEE')");

$conn->query("INSERT INTO `readersfee_report`(`caseno`, `doc_id`, `doc_name`, `code`, `desc`, `accttitle`, `refno`, `sc_pwd`, `srp`, `discount`, `net`, 
`datearray`, `timearray`, `user`) VALUES ('$caseno', '$radiologist[0]', '$radiologist[1]', '$productcode', '$productdesc', '$productsubtype', '$refno', '$senior',
...
<tr>
<th style='font-size: 10px;'><b>Height:<br><input type="text" name="height" value="<?php echo $height ?>" style="height:30px; font-size:12pt; padding: 0px; text-align: center; width: 95%;"></th>
<th style='font-size: 10px;'><b>Weight:<br><input type="text" name="weight" value="<?php echo $weight ?>" style="height:30px; font-size:12pt; padding: 0px; text-align: center; width: 95%;"></th>
<th style='font-size: 10px;'><b>BSA:<br><input type="text" name="bsa" value="<?php echo $bsa ?>" style="height:30px; font-size:12pt; padding: 0px; text-align: center; width: 95%;"></th>
<th style='font-size: 10px;'><b>HR:<br><input type="text" name="hr" value="<?php echo $hr ?>" style="height:30px; font-size:12pt; padding: 0px; text-align: center; width: 95%;"></th>
</tr>
</table><hr>
