...
<tr>
<td style="font-size: 11px;">TECHNICIAN:
...
<p align="right"><button type="submit" name="btn_save" class="btn btn-danger btn-sm"><font size="2%"><i class="icofont-check-circled"></i> SUBMIT</font></button> <br><br></td>
</tr>
</table>
</div>
</div>
