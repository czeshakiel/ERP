   ...
   <!-- sidebar -->
	...
	<td style="color: white;">MedMatrix<br><small style="font-size:11px;">eHealth Solutions, Inc.</small></td>
        ...
        <ul class="menu-list flex-grow-1 mt-3">
          ...
          <li><a class="ms-link" href="?pfreport"><span><i class="icofont-doctor"></i> Readers Fee Report</span></a></li>
          <li><a class="ms-link" href="?archives"><span><i class="icofont-search-user"></i> Search Archive</span></a></li>
          <li><a class="ms-link" href="?pricelist"><span><i class="icofont-peso-true"></i> Pricelist</span></a></li>
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="NursingServices">
              ...
              <li><a class="ms-link" href="../login/?dept=NS3"><span><i class="icofont-caret-right"></i> Requisition History</span></a></li>
            </ul>
          </li>
