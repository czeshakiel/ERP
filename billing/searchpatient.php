<?php
$lb="Search All Registered Patients";
                    ...
                    <td><div align='left'>
                      <form method='post'>
                        <table border='0' cellpadding='0' cellspacing='0'>
                          <tr>
                            <td><div align='left'><input type='text' name='searchme' placeholder='Search All Registered Patient/s...' style='padding: 5px 10px 5px 10px;height: 40px;width: 300px;border: 2px solid #000000;border-radius: 6px;' value='$searchme' required autofocus /></div></td>
                            <td width='3'></td>
