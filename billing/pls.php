...
$ax=0;
$axsql=mysqli_query($conn,"SELECT `code`, `description`, `lotno`, `unit`, `testcode`, `gtestcode` FROM `receiving` WHERE (`unit` LIKE '2D ECHO' OR `unit` LIKE 'CT SCAN' OR `unit` LIKE 'ECG' OR `unit` LIKE 'LABORATORY' OR `unit` LIKE 'ULTRASOUND' OR unit LIKE 'XRAY') ORDER BY `itemname`");
